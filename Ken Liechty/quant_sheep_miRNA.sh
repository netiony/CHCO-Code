...
grep "^>" <(gunzip -c data_clean/Ovis_aries_rambouillet.Oar_rambouillet_v1.0.dna.toplevel.fa.gz) | cut -d " " -f 1 >data_clean/decoys.txt
sed -i.bak -e 's/>//g' data_clean/decoys.txt
cat data_clean/Ovis_aries_rambouillet.Oar_rambouillet_v1.0.cdna.all.fa.gz data_clean/Ovis_aries_rambouillet.Oar_rambouillet_v1.0.dna.toplevel.fa.gz >data_clean/gentrome.fa.gz
