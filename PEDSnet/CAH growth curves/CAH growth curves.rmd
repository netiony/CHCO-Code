...
ds <- ds %>% subset(age>=2)
ds <- ds %>% subset(age<=18)
# need to clean up height too - range is 0 to 304.8 cm

clean_stats_weight <- cleangrowth(subjid = ds$person_id, param = "WEIGHTKG", 
                           agedays = ds$age_days, sex = ds$sex_num, 
                           measurement = ds$wgt)
clean_stats_height <- cleangrowth(subjid = ds$person_id, param = "HEIGHTCM", 
                           agedays = ds$age_days, sex = ds$sex_num, 
                           measurement = ds$hgt)
