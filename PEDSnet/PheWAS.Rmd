...
write.csv(results_d2,"E:/PEDSNet/PheWAS/Output/results_trisomyx.csv")
```
...
kable(results_d[!is.na(results_d$p)&results_d$p<0.05,c("phenotype","description","group","snp","beta","SE","OR","p","n_total","n_cases",
                                              "n_controls","allele_freq")]) %>%
  kable_styling("striped") %>% scroll_box(width="100%",height = "600px")
write.csv(results_d2,"E:/PEDSNet/PheWAS/Output/results_klinefelters.csv")
```
...
kable(results_d[!is.na(results_d$p)&results_d$p<0.05,c("phenotype","description","group","snp","beta","SE","OR","p","n_total","n_cases",
                                              "n_controls","allele_freq")]) %>%
  kable_styling("striped") %>% scroll_box(width="100%",height = "600px")
write.csv(results_d2,"E:/PEDSNet/PheWAS/Output/results_turner.csv")
```
...
kable(results_d[!is.na(results_d$p)&results_d$p<0.05,c("phenotype","description","group","snp","beta","SE","OR","p","n_total","n_cases",
                                              "n_controls","allele_freq")]) %>%
  kable_styling("striped") %>% scroll_box(width="100%",height = "600px")
write.csv(results_d2,"E:/PEDSNet/PheWAS/Output/results_xyy.csv")
```
...
kable(results_d[!is.na(results_d$p)&results_d$p<0.05,c("phenotype","description","group","snp","beta","SE","OR","p","n_total","n_cases",
                                              "n_controls","allele_freq")]) %>%
  kable_styling("striped") %>% scroll_box(width="100%",height = "600px")
write.csv(results_d2,"E:/PEDSNet/PheWAS/Output/results_fragilex.csv")
```
