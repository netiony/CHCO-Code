...
The output from each model can be interpreted as follows: refer to the table labeled "Coefficients."  In the row labeled "delta_LABNAME," the p-value is under the column labeled "Pr(>|t|)."
