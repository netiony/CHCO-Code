...
#setwd(home_dir)
alldata <- read.csv('/Users/pylell/Library/CloudStorage/OneDrive-SharedLibraries-UW/Bjornstad/Biostatistics Core Shared Drive/IMPROVE T2D/Data_Raw/Primary analyses/IMPROVET2D-MMTTVariables_DATA_2025-01-20_1648.csv')
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_omm(data = omm, outcome = "ISR_AUC_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj_omm(data = omm, outcome = "ISR_AUC_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_omm(data = omm, outcome = "beta_cell_resp_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj_omm(data = omm, outcome = "beta_cell_resp_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_omm(data = omm, outcome = "beta_cell_resp_4h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj_omm(data = omm, outcome = "beta_cell_resp_4h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_omm(data = omm, outcome = "disposition_ind_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj_omm(data = omm, outcome = "disposition_ind_2h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_omm(data = omm, outcome = "disposition_ind_4h")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj_omm(data = omm, outcome = "disposition_ind_4h")
```
