---
title: "IMPROVE-T2D 1 year analysis"
author: "Laura Pyle"
...
### NEED TO UPDATE FUNCTIONS FOR 1 YEAR
### ADD MISSING KIDNEY OUTCOMES (SEE "OUTCOMES" INSTRUMENT IN REDCAP)
### FOR SOME OUTCOMES NOT MEASURED AT 3 MONTHS, MAY WANT A DIFFERENT FUNCTION WITHOUT INCLUDING MON 3
...
### UACR (mean of clamp_acr_baseline and clamp_acr_250)

```{r echo=FALSE, include=TRUE}
mod <- mixed(data = visit, outcome = "clamp_acr_mean")
```
...
```{r echo=FALSE, include=TRUE}
mod <- mixed_adj(data = visit, outcome = "clamp_acr_mean")
```
