...
source("/Users/pylell/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Kristen Nadeau/IMPROVE-T2D/Data raw/IMPROVET2D-ScreeningData_R_2024-02-27_1322.r")
screen <- data
data <- NULL
...
source("/Users/pylell/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Kristen Nadeau/IMPROVE-T2D/Data raw/IMPROVET2D-VisitData_R_2024-02-27_1323.r")
visit <- data
data <- NULL
# select the participants
# IT2D-2,3,5,6,8,11-16, 18-20
...
1) Adjust for weight loss or % weight loss?
2) How to combine race and ethnicity variables? Once this is decided, I'll add a table of baseline descriptive statistics
3) Need to add readmissions data
