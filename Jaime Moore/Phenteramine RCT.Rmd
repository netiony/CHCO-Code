...
# diet diary
dd <- read.csv("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Moore/Phenteramine RCT/Data raw/PilotRCTPhentermineT-LPDietDiary_DATA_2024-09-09_1229.csv")
...
```{r, include=FALSE}
t1 <- print(t1, nonnormal = c("labs_a1c", "labs_trig", "labs_alt"), 
            showAllLevels = T)
```
