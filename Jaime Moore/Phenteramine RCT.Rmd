...
cesd_long <- cesd_long %>% arrange(Record.ID, desc(cesd_dateofvisit))
cesd_long <- cesd_long %>% group_by(Record.ID, redcap_event_name) %>% filter(row_number()==1)
cesd_long <- ungroup(cesd_long)
