...
ht_wt_vitals_keep <- ht_wt_vitals_bmiz %>% select(Record.ID, height_m, wt, bmi, bmiz, bmip95)
# calculate mean BP
...
t1 <- CreateTableOne(data = t1_data, vars = c("AgeAtVisit1", "Biological.Sex", "race_eth", "Primary.Bariatric.Surgical.Procedure",
                                              ...
                                              "Household.income.numeric", "food_insecurity", "height_m", "weight_kg"), 
                     strata = "Randomization.Assignment")
t1 <- print(t1, nonnormal = c("Age..completed.years..at.Enrollment"), showAllLevels = T)
```
