...
data$Basal.glucose.Ra <- ifelse(data$Basal.glucose.Ra>1000,NA,data$Basal.glucose.Ra)
data$Glycerol.Ra.10 <- ifelse(data$Glycerol.Ra.10>1000,NA,data$Glycerol.Ra.10)
data$Glycerol.Ra.16 <- ifelse(data$Glycerol.Ra.16>1000,NA,data$Glycerol.Ra.16)
data$Glycerol.Ra.80 <- ifelse(data$Glycerol.Ra.80>1000,NA,data$Glycerol.Ra.80)
