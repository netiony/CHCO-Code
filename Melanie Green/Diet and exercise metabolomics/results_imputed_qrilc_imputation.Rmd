...
modFit<-LinearModelFit(featuredata=final_nomissqrilc.log$featuredata,
                       ruv2=FALSE,
                       moderated=TRUE,
                       factormat=final_nomissqrilc.log$sampledata[1],
                       outputname = "H:\\Endocrinology\\Green\\Metabolomics papers\\Diet and exercise\\Data\\modFit_qrilc",
                       saveoutput = TRUE)

#trying non-moderated statistics
ordFit<-LinearModelFit(featuredata=final_nomissqrilc.log$featuredata,
                       ruv2=FALSE,
                       moderated=FALSE,
                       factormat=final_nomissqrilc.log$sampledata[1],
                       outputname = "H:\\Endocrinology\\Green\\Metabolomics papers\\Diet and exercise\\Data\\ordFit_qrilc",
                       saveoutput = TRUE)
