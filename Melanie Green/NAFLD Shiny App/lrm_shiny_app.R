...
ui <- fluidPage(
  helpText("ROC analysis was used to identify the cutoff of the probability that maximized the Youden Index. A threshold of 43% provides 82% sensitivity and 69% specificity. This model has so far only been validated in adolescent girls with PCOS."),
