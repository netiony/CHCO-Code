...
# For those who go off lifestyle, if the visit is within 6 months of last
# lifestyle, include that value in the post-lifestyle analysis.
df$lifestyle[df$lifestyle == "No" & df$months_since_last_lifestyle < 6] <- "Yes"
