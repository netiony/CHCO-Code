...
m %>%
  ...
  add_n(location = "level")
p <- ggcoef_model(m,
  plot_title = "Pre-diabetes",
  add_reference_rows = T, exponentiate = T, signif_stars = F, colour = F
)
ggsave("./Dissemination/Figures/pre_diabetes_forest.png", p,
...
m %>%
  ...
  add_n(location = "level")
p <- ggcoef_model(m,
  plot_title = "Type 2 Diabetes",
  add_reference_rows = T, exponentiate = T, signif_stars = F, colour = F
)
ggsave("./Dissemination/Figures/t2d_forest.png", p,
  width = 8, height = 5, units = "in"
)
```
...
m %>%
  ...
  add_n(location = "level")
p <- ggcoef_model(m,
  plot_title = "Free Testosterone Percentage of ULN",
  add_reference_rows = T, signif_stars = F, colour = F
)
ggsave("./Dissemination/Figures/ft_forest.png", p,
  width = 8, height = 5, units = "in"
)
```
