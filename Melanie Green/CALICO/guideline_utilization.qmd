...
diagnostic_check <- c(
  ...
  paste0("cv_referrals___", 1:12), paste0("cv_newmeds___", 1:31)
)
...
one_year <- df %>%
  ...
  summarise(
    ...
    cv_fitnesstesting_yn = any(cv_fitnesstesting_yn == "Yes")
  )
```
...
- Add ever vs. never once vriables are correct for first year analysis
