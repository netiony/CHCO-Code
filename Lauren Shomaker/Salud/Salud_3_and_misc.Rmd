...
# # check to make sure the scores match
 test = Parent_CESD_CombinedFixed %>% select(q0001, q0002,timeperiod, cesdtot)
 test2 = HLP_MASTER_DATA %>% select(parentidno,subjectidno, familyidno ,interval, cesdparentot, pss_totalscoreP)

length(unique(Parent_CESD_CombinedFixed$q0001)) # 16 total
```
