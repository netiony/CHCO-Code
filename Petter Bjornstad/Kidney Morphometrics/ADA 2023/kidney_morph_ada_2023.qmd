...
```{r}
# Import
df <- read.csv("/Volumes/Peds Endo/Petter Bjornstad/Data Harmonization/Data Clean/harmonized_dataset.csv", 
               na.strings = "")
df_dict <- read.csv("/Volumes/Peds Endo/Petter Bjornstad/Data Harmonization/data_dictionary_master.csv", 
                    na.strings = "")
...
load("/Volumes/Peds Endo/Petter Bjornstad/CROCODILE/Somalogic data/croc_soma.Rdata")
