...
fit = lmFit(out,des)
fit <- eBayes(fit)
res = topTable(fit, coef=ncol(des),adjust.method = "BH")
...
There were `r nrow(res)` proteins significantly different between the two groups after FDR p-value adjustment.
