...
# rank genes by logFC
rankings_immune_nebula_reml_offset <- immune_nebula_res_combined_reml_offset$`logFC_treatmentDapagliflozin:visitPOST`
...
###### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_nebula_reml_offset, title = "Immune nebula Top 30 KEGG (REML & Library size offset)", xmin = 1.1, xmax = 2.5)
...
###### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_nebula_reml_offset, title = "Immune nebula Top 30 REACTOME (REML & Library size offset)", xmin = 1.2, xmax = 2.8)
...
###### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_nebula_reml_offset, title = "Immune nebula Top 30 GO (REML & Library size offset)", xmin = 1.5, xmax = 2.3)
...
plot_volcano(fibvsmc_nebula_res_combined_reml_pooled, "logFC_treatmentDapagliflozin:visitPOST", 
             "p_treatmentDapagliflozin:visitPOST",
             "nebula FIB/VSMC/P (REML & pooled Offset)", 
             "logFC Treatment(Dapagliflozin):Visit(POST)", 
             "-log10(p-value)",
