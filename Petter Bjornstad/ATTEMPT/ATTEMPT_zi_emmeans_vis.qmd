...
pt_model_df_mod1 <- readRDS("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/ATTEMPT/Results/emmeans/kopah/1 Nested visit and zero inflation/pt_attempt_hvg_nebula_res.rds")
  ...
  function(gene_name) {
    ...
    df <- df %>% filter(gene_name %in% pt_nebula_converged$Gene) %>%
      mutate(Gene = gene_name,
             fdr_interaction = p.adjust(`p_treatmentDapagliflozin:visitPOST`, method = "fdr"))
    return(df)
  }
)
...
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(pt_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(pt_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(pt_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_pt_nebula <- pt_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_pt_nebula) <- pt_nebula_res_combined$Gene
rankings_pt_nebula <- sort(rankings_pt_nebula, decreasing = TRUE)
plot(rankings_pt_nebula)
min(rankings_pt_nebula)
max(rankings_pt_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_pt_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_pt_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_pt_nebula <- fgsea(pathways = reactome,
                              stats = rankings_pt_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_pt_nebula <- fgsea(pathways = go,
                        stats = rankings_pt_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_pt_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_pt_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_pt_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_pt_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_pt_nebula[, padj < 0.05], na.rm = T), sum(go_res_pt_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pt_nebula, title = "PT nebula Top 30 KEGG", xlimit = 4)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pt_nebula, title = "PT nebula Top 30 REACTOME", xlimit = 5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pt_nebula, title = "PT nebula Top 30 GO", xlimit = 5)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(tal_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(tal_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(tal_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_tal_nebula <- tal_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_tal_nebula) <- tal_nebula_res_combined$Gene
rankings_tal_nebula <- sort(rankings_tal_nebula, decreasing = TRUE)
plot(rankings_tal_nebula)
min(rankings_tal_nebula)
max(rankings_tal_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_tal_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_tal_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_tal_nebula <- fgsea(pathways = reactome,
                              stats = rankings_tal_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_tal_nebula <- fgsea(pathways = go,
                        stats = rankings_tal_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_tal_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_tal_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_tal_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_tal_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_tal_nebula[, padj < 0.05], na.rm = T), sum(go_res_tal_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_tal_nebula, title = "TAL nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_tal_nebula, title = "TAL nebula Top 30 REACTOME", xlimit = 4)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_tal_nebula, title = "TAL nebula Top 30 GO", xlimit = 4)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(pc_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(pc_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(pc_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_pc_nebula <- pc_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_pc_nebula) <- pc_nebula_res_combined$Gene
rankings_pc_nebula <- sort(rankings_pc_nebula, decreasing = TRUE)
plot(rankings_pc_nebula)
min(rankings_pc_nebula)
max(rankings_pc_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_pc_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_pc_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_pc_nebula <- fgsea(pathways = reactome,
                              stats = rankings_pc_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_pc_nebula <- fgsea(pathways = go,
                        stats = rankings_pc_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_pc_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_pc_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_pc_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_pc_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_pc_nebula[, padj < 0.05], na.rm = T), sum(go_res_pc_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_pc_nebula, title = "PC nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_pc_nebula, title = "PC nebula Top 30 REACTOME", xlimit = 3)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_pc_nebula, title = "PC nebula Top 30 GO", xlimit = 4)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(immune_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(immune_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(immune_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_immune_nebula <- immune_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_immune_nebula) <- immune_nebula_res_combined$Gene
rankings_immune_nebula <- sort(rankings_immune_nebula, decreasing = TRUE)
plot(rankings_immune_nebula)
min(rankings_immune_nebula)
max(rankings_immune_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_immune_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_immune_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_immune_nebula <- fgsea(pathways = reactome,
                              stats = rankings_immune_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_immune_nebula <- fgsea(pathways = go,
                        stats = rankings_immune_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_immune_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_immune_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_immune_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_immune_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_immune_nebula[, padj < 0.05], na.rm = T), sum(go_res_immune_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_immune_nebula, title = "Immune nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_immune_nebula, title = "Immune nebula Top 30 REACTOME", xlimit = 4)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_immune_nebula, title = "Immune nebula Top 30 GO", xlimit = 3)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(ic_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(ic_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(ic_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_ic_nebula <- ic_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_ic_nebula) <- ic_nebula_res_combined$Gene
rankings_ic_nebula <- sort(rankings_ic_nebula, decreasing = TRUE)
plot(rankings_ic_nebula)
min(rankings_ic_nebula)
max(rankings_ic_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_ic_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_ic_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_ic_nebula <- fgsea(pathways = reactome,
                              stats = rankings_ic_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_ic_nebula <- fgsea(pathways = go,
                        stats = rankings_ic_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_ic_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_ic_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_ic_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_ic_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_ic_nebula[, padj < 0.05], na.rm = T), sum(go_res_ic_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ic_nebula, title = "IC nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ic_nebula, title = "IC nebula Top 30 REACTOME", xlimit = 3)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ic_nebula, title = "IC nebula Top 30 GO", xlimit = 5)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(ec_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(ec_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(ec_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_ec_nebula <- ec_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_ec_nebula) <- ec_nebula_res_combined$Gene
rankings_ec_nebula <- sort(rankings_ec_nebula, decreasing = TRUE)
plot(rankings_ec_nebula)
min(rankings_ec_nebula)
max(rankings_ec_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_ec_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_ec_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_ec_nebula <- fgsea(pathways = reactome,
                              stats = rankings_ec_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_ec_nebula <- fgsea(pathways = go,
                        stats = rankings_ec_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_ec_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_ec_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_ec_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_ec_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_ec_nebula[, padj < 0.05], na.rm = T), sum(go_res_ec_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_ec_nebula, title = "EC nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_ec_nebula, title = "EC nebula Top 30 REACTOME", xlimit = 3.5)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_ec_nebula, title = "EC nebula Top 30 GO", xlimit = 3)
...
gmt_files <- list.files(path = bg_path, pattern = '.gmt', full.names = TRUE)
gmt_files
kegg_legacy <- prepare_gmt(gmt_files[1], unique(fibvsmc_nebula_res_combined$Gene), savefile = FALSE)
reactome <- prepare_gmt(gmt_files[3], unique(fibvsmc_nebula_res_combined$Gene), savefile = FALSE)
go <- prepare_gmt(gmt_files[4], unique(fibvsmc_nebula_res_combined$Gene), savefile = FALSE)

# rank genes by logFC
rankings_fibvsmc_nebula <- fibvsmc_nebula_res_combined$`logFC_treatmentDapagliflozin:visitPOST`
names(rankings_fibvsmc_nebula) <- fibvsmc_nebula_res_combined$Gene
rankings_fibvsmc_nebula <- sort(rankings_fibvsmc_nebula, decreasing = TRUE)
plot(rankings_fibvsmc_nebula)
min(rankings_fibvsmc_nebula)
max(rankings_fibvsmc_nebula)
```

```{r echo = F}
set.seed(1234)

kegg_legacy_res_fibvsmc_nebula <- fgsea(pathways = kegg_legacy,
                                 stats = rankings_fibvsmc_nebula,
                                 scoreType = 'std', 
                                 minSize = 3,
                                 maxSize = 500,
                                 nproc = 1)

reactome_res_fibvsmc_nebula <- fgsea(pathways = reactome,
                              stats = rankings_fibvsmc_nebula,
                              scoreType = 'std', 
                              minSize = 3,
                              maxSize = 500,
                              nproc = 1)
go_res_fibvsmc_nebula <- fgsea(pathways = go,
                        stats = rankings_fibvsmc_nebula,
                        scoreType = 'std', 
                        minSize = 5,
                        maxSize = 500,
...
fgsea <- data.frame("KEGG Legacy"=c(sum(kegg_legacy_res_fibvsmc_nebula[, padj < 0.05], na.rm = T), sum(kegg_legacy_res_fibvsmc_nebula[, pval < 0.05], na.rm = T)),
                         "REACTOME"=c(sum(reactome_res_fibvsmc_nebula[, padj < 0.05], na.rm = T), sum(reactome_res_fibvsmc_nebula[, pval < 0.05], na.rm = T)),
                         "GO"=c(sum(go_res_fibvsmc_nebula[, padj < 0.05], na.rm = T), sum(go_res_fibvsmc_nebula[, pval < 0.05], na.rm = T)))
rownames(fgsea) <- c("adj.pval", "p.val")

```
##### KEGG Legacy
```{r echo = F}
plot_fgsea_transpose(kegg_legacy_res_fibvsmc_nebula, title = "FIB/VSMC/P nebula Top 30 KEGG", xlimit = 3)
...
##### REACTOME
```{r echo = F}
plot_fgsea_transpose(reactome_res_fibvsmc_nebula, title = "FIB/VSMC/P nebula Top 30 REACTOME", xlimit = 4)
...
##### GO
```{r echo = F}
plot_fgsea_transpose(go_res_fibvsmc_nebula, title = "FIB/VSMC/P nebula Top 30 GO", xlimit = 4)
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_pt_mod1_overlap, title = "Model 1 PT Top 30 REACTOME", xlimit = 5)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_pt_mod1_overlap, title = "Model 1 PT Top 30 GO", xlimit = 8)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_tal_mod1_overlap, title = "Model 1 TAL Top 30 REACTOME", xlimit = 5)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_tal_mod1_overlap, title = "Model 1 TAL Top 30 GO", xlimit = 6)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_pc_mod1_overlap, title = "Model 1 PC Top 30 REACTOME", xlimit = 5)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_pc_mod1_overlap, title = "Model 1 PC Top 30 GO", xlimit = 8)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_immune_mod1_overlap, title = "Model 1 Immune Top 30 REACTOME", xlimit = 5)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_immune_mod1_overlap, title = "Model 1 Immune Top 30 GO", xlimit = 7)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_ic_mod1_overlap, title = "Model 1 IC Top 30 REACTOME", xlimit = 8)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_ic_mod1_overlap, title = "Model 1 IC Top 30 GO", xlimit = 8)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_ec_mod1_overlap, title = "Model 1 EC Top 30 REACTOME", xlimit = 4)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_ec_mod1_overlap, title = "Model 1 EC Top 30 GO", xlimit = 7)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_fibvsmcp_mod1_overlap, title = "Model 1 FIB/VSMC/P Top 30 REACTOME", xlimit = 5)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_fibvsmcp_mod1_overlap, title = "Model 1 FIB/VSMC/P Top 30 GO", xlimit = 6)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(reactome_res_pt_mod2_overlap, title = "model 2 PT Top 30 REACTOME", xlimit = 6)
# 
...
#                              T~ pathway))
# 
# plot_fgsea(go_res_pt_mod2_overlap, title = "model 2 PT Top 30 GO", xlimit = 5)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_tal_mod2_overlap, title = "model 2 TAL Top 30 REACTOME", xlimit = 5)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_tal_mod2_overlap, title = "model 2 TAL Top 30 GO", xlimit = 7)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_pc_mod2_overlap, title = "model 2 PC Top 30 REACTOME", xlimit = 4)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_pc_mod2_overlap, title = "model 2 PC Top 30 GO", xlimit = 8)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_immune_mod2_overlap, title = "model 2 Immune Top 30 REACTOME", xlimit = 5)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_immune_mod2_overlap, title = "model 2 Immune Top 30 GO", xlimit = 8)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_ic_mod2_overlap, title = "model 2 IC Top 30 REACTOME", xlimit = 8)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_ic_mod2_overlap, title = "model 2 IC Top 30 GO", xlimit = 8)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_ec_mod2_overlap, title = "model 2 EC Top 30 REACTOME", xlimit = 5)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_ec_mod2_overlap, title = "model 2 EC Top 30 GO", xlimit = 7)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(reactome_res_fibvsmcp_mod2_overlap, title = "model 2 FIB/VSMC/P Top 30 REACTOME", xlimit = 5)
# 
...
#          pathway = case_when(!is.na(n_prefixes) ~ paste0(pathway, " ", shared_prefixes),
#                              T~ pathway))
# plot_fgsea(go_res_fibvsmcp_mod2_overlap, title = "model 2 FIB/VSMC/P Top 30 GO", xlimit = 8)
# 
