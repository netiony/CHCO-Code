...
n_placebo_post <- grp_count(subset(so_attempt_pt@meta.data, treatment == "Placebo"), group_var = "visit", group = "POST", 
                            cellsubtype_var = "celltype")
n_dapag_pre <- grp_count(subset(so_attempt_pt@meta.data, treatment == "Dapagliflozin 5mg"), group_var = "visit", group = "PRE", 
                         cellsubtype_var = "celltype")
n_dapag_post <- grp_count(subset(so_attempt_pt@meta.data, treatment == "Dapagliflozin 5mg"), group_var = "visit", group = "POST", 
                          cellsubtype_var = "celltype")
...
so_attempt_pt_meta$treatment_visit <- factor(so_attempt_pt_meta$treatment_visit, 
                                          levels = c("PRE - Placebo", "POST - Placebo", 
                                                     "PRE - Dapagliflozin 5mg", "POST - Dapagliflozin 5mg"))
```
...
so_attempt_pt_meta %>% 
  ...
  dplyr::mutate(n = case_when(treatment == "Placebo" & visit == "PRE" ~ n_placebo_pre, 
                              ...
                              treatment == "Dapagliflozin 5mg" & visit == "PRE" ~ n_dapag_pre, 
                              treatment == "Dapagliflozin 5mg" & visit == "POST" ~ n_dapag_post),
