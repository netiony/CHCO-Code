...
corr_delta_mgfr_si_adjusted <- corr.test(x = x, y = y, method = "spearman", adjust = "BH")
...
colnames(corr_delta_mgfr_si_adjusted_mat) <- c("spearman_delta_mgfr_si_adjusted", "q.value")
...
corr_delta_hba1c_percent <- corr.test(x = x, y = y, method = "spearman", adjust = "BH")
...
colnames(corr_delta_hba1c_percent_mat) <- c("spearman_delta_hba1c_percent", "q.value")
...
corr_delta_PWV <- corr.test(x = x, y = y, method = "spearman", adjust = "BH")
...
colnames(corr_delta_PWV_mat) <- c("spearman_delta_PWV", "q.value")
...
# sort
corr_delta_mgfr_si_mat <- corr_delta_mgfr_si_mat %>% arrange(q.value)
corr_delta_mgfr_si_adjusted_mat <- corr_delta_mgfr_si_adjusted_mat %>% arrange(q.value)
corr_delta_hba1c_percent_mat <- corr_delta_hba1c_percent_mat %>% arrange(q.value)
corr_delta_PWV_mat <- corr_delta_PWV_mat %>% arrange(q.value)
