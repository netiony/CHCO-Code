...
de.markers <- function(seurat_object, genes, group.by, id1, id2, celltype, extension){
  m = FindMarkers(seurat_object, features = NULL, group.by = group.by,ident.1 = id1, 
                  ident.2 = id2, subset.ident = celltype,verbose = F, logfc.threshold=.25,
                  min.pct = 0.1)
...
```{r}
de.markers(so, genes = NULL, "Group", id2 = "HC", id1 = "T1D", "PT", "")
de.markers(so, genes = NULL, "Group", id2 = "HC", id1 = "T1D", "EC", "")
de.markers(so, genes = NULL, "Group", id2 = "HC", id1 = "T1D", "MAC", "")
de.markers(so, genes = NULL, "Group", id2 = "HC", id1 = "T1D", "MON", "")
```
