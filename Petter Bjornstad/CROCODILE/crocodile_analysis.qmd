...
table_biopsy <- tableby(group ~ kidney_side, data = dat, total=F)
```

```{r results='asis'}
summary(table_one, pfootnote = T, digits = 2, digits.p = 3, digits.pct = 0)
...
summary(table_biopsy, pfootnote = T, digits = 1, digits.p = 2, digits.pct = 0)
```
