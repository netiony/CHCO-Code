...
table_dxa <- tableby(group ~ dexa_body_fat + dexa_fat_kg + dexa_lean_kg + dexa_trunk_kg + p2_raw_m + p2_raw_leanm + baseline_ffa, data = dat, total=F)
...
summary(table_kidney, pfootnote = T, digits = 1, digits.p = 3, digits.pct = 0)
...
summary(table_biopsy, pfootnote = T, digits = 1, digits.p = 3, digits.pct = 0)
```
