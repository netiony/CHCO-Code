...
# GBM width
correlation_table_minimal(data = subset(so_PT@meta.data, !is.na(gbm_thick_harmmean) & !is.na(pseudotime)),
                   relevant_vars = c(pseudotime, "gbm_thick_harmmean"),
                   n_cols = 1,
                   cor_method = "pearson",
                   dict = dict)
