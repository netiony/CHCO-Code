...
#### Spearman
```{r}
png(height = 2000, width = 1200, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_tissue_scRNA_spearman.png", res = 170)
corr_plot_modified(pt_md,
                   X = genes_subset,
                   Y = spatial_metab_tca,
                   adj_var = NA,
...
#### Spearman
```{r}
png(height = 2000, width = 1200, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_blood_scRNA_spearman.png", res = 170)
corr_plot_modified(pt_md,
                   X = genes_subset,
                   Y = blood_metab_tca,
                   adj_var = NA,
...
#### Spearman
```{r}
png(height = 1200, width = 1200, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_blood_tissue_spearman.png", res = 170)
corr_plot_modified(pt_md,
                   X = spatial_metab_tca, 
                   Y = blood_metab_tca,
                   adj_var = NA,
...
##### Spearman
```{r}
png(height = 2000, width = 1200, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_scRNA_clin_t1dlc_spearman.png", res = 170)
corr_plot_modified(pt_md,
                   X = genes_subset, 
                   Y = c("gbm_thick_artmean",
                         "avg_c_k2"),
...
##### Spearman
```{r}
png(height = 2000, width = 1200, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_scRNA_clin_t1d_spearman.png", res = 170)
corr_plot_modified(data = subset(pt_md, group == "Type 1 Diabetes"),
                   X = genes_subset, 
                   Y = c("gbm_thick_artmean",
                         "avg_c_k2"),
...
##### Spearman
```{r}
png(height = 1200, width = 1500, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_tissue_clin_t1dlc_spearman.png", res = 170)
corr_plot_modified(data = pt_md,
                   X = spatial_metab_tca, 
                   Y = c("gbm_thick_artmean",
                         "avg_c_k2"),
...
dev.off()
# Reduced version for EDNSG abstract
# png(height = 1200, width = 1500, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_tissue_clin_t1dlc_reduced_spearman.png", res = 170)
# corr_plot_modified(data = pt_md,
#                    X = spatial_metab_tca[-c(7)], 
#                    Y = c("gbm_thick_artmean",
#                          "avg_c_k2"),
...
##### Spearman
```{r}
png(height = 1200, width = 1500, file = "/home/yejichoi/Documents/lin_temp_folder/Correlation_tissue_clin_t1d_spearman.png", res = 170)
corr_plot_modified(data = subset(pt_md, group == "Type 1 Diabetes"),
                   X = spatial_metab_tca, 
                   Y = c("gbm_thick_artmean",
                         "avg_c_k2"),
