...
de.markers <- function(seurat_object, genes, group.by, id1, id2, celltype, extension){
  m = FindMarkers(seurat_object, features = genes,group.by = group.by,ident.1 = id1, 
                  ident.2 = id2,subset.ident = celltype,verbose = F,logfc.threshold=0.1,
                  min.pct = .1)
...
```{r}
load("/home/yejichoi/UCD/Petter Bjornstad/CROCODILE/Data_Cleaned/croc_data.RData")
```
...
## Insulin sensitivity with sc PT transcripts
```{r}
