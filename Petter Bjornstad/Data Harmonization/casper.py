...
casper = pd.merge(casper, labs, how="outer")
casper = pd.merge(casper, mri, how="outer")
casper = pd.merge(casper, dxa, how="outer")
casper = pd.merge(casper, clamp, how="outer")
casper = pd.merge(casper, rct, how="outer")
casper = pd.merge(casper, biopsy, how="outer")
casper = pd.merge(casper, pet, how="outer")
