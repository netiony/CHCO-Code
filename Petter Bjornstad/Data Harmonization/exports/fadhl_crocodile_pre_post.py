...
vars = ["record_id", "co_enroll_id", "study", "kit_id", "group", "dob",
        ...
        "glom_nuc_count", "mes_nuc_count", "art_intima", "art_media", "pod_nuc_density", "pod_cell_volume",
        "steady_state_insulin",
        "p1_raw_m","p1_raw_leanm","p1_gc_m","p1_gc_leanm","p2_raw_m","p2_raw_leanm","p2_gc_m","p2_gc_leanm"] + ffa
fadhl = df.loc[df["study"].isin(['CROCODILE', "IMPROVE", 'RENAL-HEIR']), vars]
