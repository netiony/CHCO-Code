...
identical(og_left_combined_clean, check_left_combined[, -c(1013:1024)])
...
identical(og_right_combined_clean, check_right_combined[, -c(1013:1024)])
...
## workspace cleanup
rm(additional_height_dat, PAN_tan_dat, PAN_igf1_dat)
```
...
table1::table1(~ sex + age + group + diabetes_duration + height_meters + merged_left_kv + ht_adj_merged_left_kv + 
                 merged_lkv_metric_type + lkv_add_height_date_diff, 
...
table1::table1(~ sex + age + group + diabetes_duration + height_meters + merged_right_kv + 
                 ht_adj_merged_right_kv + merged_rkv_metric_type + rkv_add_height_date_diff, 
