...
STAR  --runMode genomeGenerate --runThreadN 4 --genomeDir Miscellaneous --genomeFastaFiles Miscellaneous/refdata-gex-GRCh38-2020-A/fasta/genome.fa  --sjdbGTFfile Miscellaneous/refdata-gex-GRCh38-2020-A/genes/genes.gtf
