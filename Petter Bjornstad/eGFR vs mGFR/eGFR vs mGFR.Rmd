...
## NEED TO CHECK ALL THE DXA VARS - SOMETHING DOESN'T SEEM RIGHT
...
alldata$eGFR.Schwartz <- ifelse(alldata$sex_MF=="M",(55*(alldata$clamp_height/100))/alldata$serum_creatinine,
                        ifelse(alldata$age>=13,(70*(alldata$clamp_height/100))/alldata$serum_creatinine,
                               (55*(alldata$clamp_height/100))/alldata$serum_creatinine))

# eGFR CKiD U25 (both versions?)
