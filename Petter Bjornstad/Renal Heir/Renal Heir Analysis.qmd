...
correlation_table_with_formatting(dat, c("gfr_raw_plasma", 
                                         ...
                                         "di",
                                         "airg",
                                         "acprg"), n_cols = 6, dict = dict, 
                                  save_path = "/Users/choiyej/GitHub/YC_CHCO/RH/co_all_1_pearson.csv")
...
correlation_table_with_formatting(dat, c("avg_bl_cortex", 
                                         ...
                                         "airg",
                                         "acprg",
                                         "acr_u"), n_cols = 3, dict = dict, 
                                  save_path = "/Users/choiyej/GitHub/YC_CHCO/RH/co_all_1_mri_pearson.csv")
```
...
correlation_table_with_formatting(dat_obese_t2d, c("gfr_raw_plasma", 
                                         ...
                                         "airg",
                                         "acprg"), n_cols = 6, dict = dict, 
                                  save_path = "/Users/choiyej/GitHub/YC_CHCO/RH/co_obeset2d_1_pearson.csv")
...
correlation_table_with_formatting(dat_obese_t2d, c("avg_bl_cortex", 
                                         ...
                                         "acprg",
                                         "acr_u"), n_cols = 3, dict = dict, 
                                  save_path = "/Users/choiyej/GitHub/YC_CHCO/RH/co_obeset2d_1_mri_pearson.csv")
```
...
# E[Y | E[X] ] at baseline
  # E[X] = mean of X
    mean.loginsSens <- dat %>% summarize(mean(eval(xvar), na.rm=T)) %>% as.numeric
  # E[Y | E[X]] = predicted value of Y at x=E[X] for linear model of Y ~ X
    lm.model.base <- lm(eval(yvar) ~ eval(xvar), data=dat)
...
for(i in 1:length(dat$group_mod)){
  ...
  assign(paste0('confellipse.base.',dat$group_mod[i]), eval(as.symbol(paste0('Cmat.',dat$group_mod[i]))))
