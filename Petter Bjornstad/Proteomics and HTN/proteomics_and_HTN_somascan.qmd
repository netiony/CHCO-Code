...
prot_include <- c("WFKN2","SEZ6L","NCAM-120","Coagulation Factor IXab","NCAM1","STA10","SCG3","Aminoacylase-1",
"WFKN2","ESPN","PURA1","SERB","CHL1","TMEDA","PEDF","UGDH","LSAMP","H6ST3","carboxylesterase, liver",
...
# arrange
grpbox <- ggarrange(p_seq.3343.1,p_seq.15487.164,p_seq.8958.51,p_seq.5307.12,p_seq.24957.6,
                    p_seq.2948.58,p_seq.18896.23,p_seq.2999.6,p_seq.4498.62,p_seq.20161.41,
                    p_seq.5634.39,p_seq.7735.17,p_seq.13998.26,p_seq.7957.2,p_seq.24681.2,
                    p_seq.19563.3,p_seq.23569.53,p_seq.6506.54,p_seq.17755.5,p_seq.18896.23,
                    p_seq.3235.50,
                    nrow = 5, ncol = 5,
                    common.legend = T)
