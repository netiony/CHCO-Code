...
deltas <- deltas %>% select(ID, sbp, dbp, seq.19563.3, seq.4498.62, seq.20161.41, seq.7957.2, seq.3343.1, 
                            seq.24957.6, seq.13998.26, seq.24681.2, seq.8958.51, seq.2999.6, seq.2948.58 )
```
...
png('/Users/pylell/Dropbox/TODAY HTN and DKD output/Teen-LABS_BP.png', res = 300, width = 12, height = 8, units = "in")
panel_p
dev.off()
