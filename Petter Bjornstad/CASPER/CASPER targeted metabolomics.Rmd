...
alldata <- read.sas7bdat("E:\\Petter Bjornstad\\Metabolomics\\Raw data\\casperheir_for_laura.sas7bdat")

# read in NG data - those variables are included in the original dataset, but we want to analyze
# them separately
ng_serum <- read.csv("E:\\Petter Bjornstad\\Metabolomics\\Raw data\\NG serum.csv")
names_ng_serum <- colnames(ng_serum)
ng_urine <- read.csv("E:\\Petter Bjornstad\\Metabolomics\\Raw data\\NG urine.csv")
