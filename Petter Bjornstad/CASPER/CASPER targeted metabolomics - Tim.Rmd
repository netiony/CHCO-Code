...
#	metabolomics - body composition data 
#	metabolomics - renal measures (GFR, RPF, ACR, renal O2)
corrvars = c("GIR","GIR_per_kg","M_I_kg_GC","M_I_leankg_GC","body_fat","screen_bmi_percentile","rpf","acr_mean","kidney_oxygenation","gfr","kidney_GFR","medullary_GFR","cortex_GFR","FOSC_Cortex","FOSC_Medullary","FOSC_Kidney")
...
```{r, echo=FALSE}
plotIndiv(plsda.res,comp = c(1,2),ellipse = T,legend = T,ind.names = F)
```
