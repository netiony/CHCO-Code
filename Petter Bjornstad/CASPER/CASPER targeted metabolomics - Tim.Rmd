...
# format results
results <- topTable(fit_group,coef = 2,number = nrow(ymat))
write.csv(results,"E:\\Petter Bjornstad\\CASPER Metabolomics\\Reports\\targeted_adjusted_GFR.csv")
...
tubular = read.csv("E:\\Petter Bjornstad\\CASPER Metabolomics\\Clean data\\tubularinjury.csv",stringsAsFactors = F)
