...
untargeted_heat = pheatmap(c$r[!duplicated(rownames(c$r)) & rownames(c$r) != "920863",],legend = F)
```
...
```{r include=FALSE}
# Targeted
source("/Users/timvigers/GitHub/CHCO-Code/Petter Bjornstad/CASPER/targeted_heatmap.R")
