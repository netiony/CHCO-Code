...
```{r plsda results}
plotIndiv(plsda_true,comp = c(1,2),ellipse = T,legend = F,ind.names = F,title = "")
```
...
```{r}
vars = c("GIR","GIR_per_kg","M_I_kg_GC","M_I_leankg_GC","body_fat","screen_bmi_percentile","rpf","acr_mean","kidney_oxygenation","gfr","kidney_GFR","medullary_GFR","cortex_GFR","FOSC_Cortex","FOSC_Medullary","FOSC_Kidney")
varnames = c("GIR","GIR per kg","M/I per kg","M/I per lean kg","Body fat","BMI %ile","RPF","Mean ACR","Kidney Oxy.","GFR","Whole-kidney RO2:GFR","Medullary RO2:GFR","Cortical RO2:GFR","Cortex FSOC","Medullary FSOC","Kidney FSOC")
