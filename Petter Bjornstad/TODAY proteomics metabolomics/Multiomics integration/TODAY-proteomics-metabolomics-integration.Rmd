...
# turn factors_df into wide df
# add survival outcomes to the df and perform Cox model and get C-statistic
# do we need actual patient IDs in factors df or is it sufficient they are in the same order?
