...
t1 <- CreateTableOne(data=t1data, vars=c("MIC.OR.MAC","MAC","MIC","HYP","RAPID","NEURO","RETINO","GLYC",
                                         ...
                                         "bmi","txdesc","houseincdesc","racedesc"), strata="group")
t1 <- print(t1)

t1a <- CreateTableOne(data=t1data, vars=c("MIC.OR.MAC","MAC","MIC","HYP","RAPID","NEURO","RETINO","GLYC",
                                         "HbA1c","trig","sbp","si_1_ins0","AGEBASE","sex","tg","dxtime",
                                         "bmi","txdesc","houseincdesc","racedesc"))
t1a <- print(t1a, nonnormal="HbA1c")
```
