...
load("/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Somalogic data raw/soma.Rdata")

# load analyte info
load("/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Somalogic data raw/analytes.Rdata")

# load comorbidity data
load("/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Clinical data/comorb.Rdata")

# load baseline risk factors
load("/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Clinical data/TODAY/baserisk.Rdata")
...
# moderated t-tests with and without FDR adjustment
y <- base_log %>% filter(!is.na(RETINO))
ymat <- t(y[,seq])
...
t1 <- CreateTableOne(data=t1data, vars=c("MIC0","MAC0","HYP0","RAPID0","MIC.OR.MAC","MAC","MIC","HYP","RAPID","HTN","NEURO","RETINO","GLYC",
                                          "HbA1c","trig","sbp","dbp","map","si_1_ins0","AGEBASE","sex","tg","dxtime",
                                          "bmi","txdesc","houseincdesc","racedesc","UAlbCreat","ge25yrs", "ge26yrs"), strata="group")
t1 <- print(t1)

# full Table 1 above, below is for DKD paper
t1a <- CreateTableOne(data=t1data, vars=c("AGEBASE","sex","racedesc","dxtime","bmi","HbA1c","UAlbCreat",
                                          "MIC0","MAC0","HYP0","RAPID0", "MIC.OR.MAC","MAC","MIC","HYP","RAPID",
                                          "sbp","dbp","map","EstCreatClear","HTN","tx","si_1_ins0", "HTN0","tg"))
t1a <- print(t1a, nonnormal=c("UAlbCreat","dxtime","tg"))
```
...
```{r}
file.copy("/Users/pylell/Documents/GitHub/CHCO-Code/Petter Bjornstad/TODAY proteomics metabolomics/Proteomics analyses/TODAY-somalogic-limma-baseline-adjusted.html",
          "/Users/pylell/Dropbox/TODAY HTN and DKD output/TODAY-somalogic-limma-baseline-adjusted.html",overwrite = TRUE)
```