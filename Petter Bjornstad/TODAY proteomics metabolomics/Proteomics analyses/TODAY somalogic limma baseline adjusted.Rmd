...
if(Sys.info()["sysname"] == "Windows"){
  ...
  home_dir = "~/Documents/Work/Petter Bjornstad/TODAY subaward"
}
...
t1a <- print(t1a, nonnormal="UAlbCreat")
=======
t1a <- CreateTableOne(data=t1data, vars=c("AGEBASE","sex","racedesc","dxtime","bmi","HbA1c","UAlbCreat","MAC","MIC","HTN"))
t1a <- print(t1a, nonnormal=c("AGEBASE","dxtime","bmi","HbA1c","UAlbCreat"))
>>>>>>> Stashed changes
```
