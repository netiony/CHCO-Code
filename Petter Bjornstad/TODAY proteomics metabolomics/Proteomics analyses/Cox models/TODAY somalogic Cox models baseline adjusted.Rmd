...
# write file to data sharing folder
save(base_log, file = "/Users/pylell/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Data sharing/TODAY/base_log.Rdata")
save(base_log_scale, file = "/Users/pylell/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Data sharing/TODAY/base_log_scale.Rdata")
load("/Users/pylell/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/Data sharing/TODAY/soma_clinical_log_scaled.Rdata")
```
...
saveWorkbook(wb,"/Users/pylell/Dropbox/TODAY glycemic manuscript [shared]/Analysis output/TODAY somalogic Cox models scaled baseline adjusted.xlsx",overwrite = TRUE)
...
write.csv(result_intersect, "/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted intersection.csv",
          row.names = F)
