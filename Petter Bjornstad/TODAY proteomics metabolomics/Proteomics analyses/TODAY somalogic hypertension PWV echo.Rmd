...
# not sure if pwv needs to be renamed
#. probably need to rename v1, v2, and delta dataset
pwv <- pwv %>% dplyr::rename("Standard deviation of R-R interval" = SDNN,
...
pwv_v1_corr <- pwv_v1_corr %>% dplyr::rename("2D ascending aorta dimensions" = ascend2d,
                                                     "2D aortic root end diastolic dimension" = diasto2d,
                                                     "2D aortic root end systolic dimension" = systol2d,
                                                     "2D four chamber LA area" = laarea2d,
                                                     "2D four chamber LV end diastolic volume" = diavol2d,
