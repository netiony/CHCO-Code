...
corr_plot_modified_nodict(data=today_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                 X=c("Left ventricular ejection fraction" ,
                                                      "Percent shortening" ,
...
corr_plot_modified_nodict(data=today_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                 X=c("Peak velocity of blood flow" ,"Right ventricular systolic pressure" ),cor_method="spearman", adj_var = NA)
dev.off()
...
corr_plot_modified_nodict(data=today_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                 X=c("Tricuspid annular plane systolic excursion"),
                 cor_method="spearman", adj_var = NA)
dev.off()
```
...
today2_echo_corr <- today2_echo_corr %>% select("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF",
                                              ...
                                              "walthick","lvmassht")
today2_echo_corr <- today2_echo_corr %>% dplyr::rename("Ascending aorta dimensions" = ascend2d,
                                                      "Left ventricular (LV) diastolic dimensions" = diasto2d,
                                                      "Left ventricular systolic dimensions" = systol2d,
                                                      "Left atrial area" = laarea2d,
                                                      "Diastolic volume" = diavol2d,
                                                      "Two chamber LV end diastolic volume" = lvedv2d2ch,
                                                      "Two chamber LV ejection fraction" = lvef2d2ch,
                                                      "Four chamber LV ejection fraction" = lvef2d4ch,
                                                      "Two chamber LV end systolic volume"  = lvesv2d2ch,
                                                      "Four chamber LV end systolic volume" = lvesv2d4ch,
                                                      "E/Em ratio – LV mitral valve lateral peak E" = lve,
                                                      "E/Em ratio – LV lateral Em" = lvem,
                                                      "E/Em tatio – LV lateral E/Em" = lvratio,
                                                      "LV mitral valve septal Peak E" = lvsepe,
                                                      "LV septal Em" = lvsepem,
                                                      "LV mitral valve tricuspid peak E/Em" = lvsepratio,
                                                      "Doppler diastology LV mitral valve tricuspid peak E" = lvtrie,
                                                      "Doppler diastology LV tricuspid Em" = lvtriem,
                                                      "Doppler diastology LV tricuspid E/Em" = lvtriratio,
                                                      "Peak velocity of blood flow" = peakvelo,
                                                      "Right ventricular systolic pressure" = rvsystol,
                                                      "Aortic root dimensions" = aortroot,
                                                      "Left atrial dimensions" = ladimen,
...
corr_plot_modified_nodict(data=today2_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                   X=c("Ascending aorta dimensions","Left ventricular (LV) diastolic dimensions",
                                                      "Left ventricular systolic dimensions",
                                                      "Left atrial area",
                                                      "Diastolic volume" ,
                                                      "Two chamber LV end diastolic volume",
                                                      "Two chamber LV end systolic volume",
                                                      "Four chamber LV end systolic volume",
                                                      "Systolic volume in millimeters",
                                                      "Diastolic volume in millimeters" ,
                                                      "Left ventricular diastolic dimension",
                                                      "Left ventricular systolic dimension" ,
...
corr_plot_modified_nodict(data=today2_echo_corr, 
                 ...
                 X=c(                        
                   ...
                   "Interventricular septal thickness in diastole" ,
                                                      ...
                                                      "Four chamber LV ejection fraction",
                                                      "Left ventricular wall motion during diastole" ,
                                                      "Left ventricular wall motion during systole" ,
                                                      ),
                 cor_method="spearman", adj_var = NA)
...
# Valvular and flow measurements
...
# Right ventricular and pulmonary artery measurements
...
corr_plot_modified_nodict(data=today2_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                 X=c(  "E/Em ratio – LV mitral valve lateral peak E",
                                                      "E/Em ratio – LV lateral Em",
                                                      "E/Em tatio – LV lateral E/Em",
                                                      "LV mitral valve septal Peak E",
                                                      "LV septal Em" ,
                                                      "LV mitral valve tricuspid peak E/Em",
                                                      "Doppler diastology LV mitral valve tricuspid peak E",
                                                      "Doppler diastology LV tricuspid Em",
                                                      "Doppler diastology LV tricuspid E/Em"),
                 cor_method="spearman", adj_var = NA)
dev.off()

# Heart rate measurement
png(height = 3000, width = 2500, file = "/Users/pylell/Documents/GitHub/CHCO-Code/Petter Bjornstad/TODAY proteomics metabolomics/Proteomics analyses/today2_echo_corr8.png", res = 170)
corr_plot_modified_nodict(data=today2_echo_corr, 
                   Y=c("WFKN2","PSB3","Myosin light chain 1","H6ST3","TLR5","SEZ6L","PSPC1","LSAMP","PSA","Nr-CAM","SCG3","PEDF"), 
                 X=c("M-mode heart rate"),
                 cor_method="spearman", adj_var = NA)
