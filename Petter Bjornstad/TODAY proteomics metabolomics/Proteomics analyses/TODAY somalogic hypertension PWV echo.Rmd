...
echo_wide$delta_dopplerqc  <- echo_wide$dopplerqc.2 -  echo_wide$dopplerqc.1
echo_wide$delta_mmodeqc  <-    echo_wide$mmodeqc.2 -  echo_wide$mmodeqc.1
echo_wide$delta_overallqc  <- echo_wide$overallqc.2 -  echo_wide$overallqc.1 
echo_wide$delta_plaxqc   <- echo_wide$plaxqc.2 -  echo_wide$plaxqc.1   
echo_wide$delta_saxqc   <- echo_wide$saxqc.2 -  echo_wide$saxqc.1    
echo_wide$delta_apicalqc  <- echo_wide$apicalqc.2 -  echo_wide$apicalqc.1  
...
M <-cor(today_echo_corr, use="pairwise.complete.obs")    
corrplot(M, type="upper", order="hclust",
         col=brewer.pal(n=8, name="RdYlBu"))
#heat <- as.matrix(today_echo_corr)
#heatmap(heat)
```
