...
drop_cols <- c("DOPPLERQC","MMODEQC","OVERALLQC","PLAXQC","SAXQC","APICALQC")
...
png(height = 3000, width = 2500, file = "/Users/pylell/Documents/GitHub/CHCO-Code/Petter Bjornstad/TODAY proteomics metabolomics/Proteomics analyses/today_echo_corr.png", res = 170)
corr_plot_modified_nodict(data=today_echo_corr, 
                   ...
                   X=c("ascend2d","diasto2d","systol2d","laarea2d","diavol2d","lve","lvem","lvratio","peakvelo","rvsystol","aortroot","ladimen","mmodehr",
                       "ivsdias","ivssyst","lvindex","lvoutput","lveject","diavolmm","sysvolmm","pctshort","lvdiast","lvsystol","lvmass","walldias",
                       "wallsyst","lvstroke","tapse","mmodeqc","walthick","ladiamht","lvdiasht","lvbsa","lvmassht"), cor_method="spearman", adj_var = NA)
dev.off()
```
