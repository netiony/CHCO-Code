...
addWorksheet(wb,"HTN with SBP CPH")
writeData(wb,"HTN with SBP CPH",results_htn_bp,rowNames = F)
saveWorkbook(wb,"./Results/Linear and Cox models/IPA/TODAY somalogic Cox models scaled baseline adjusted HTN with SBP.xlsx",overwrite = TRUE)

wb <- createWorkbook()
addWorksheet(wb,"HTN CPH")
writeData(wb,"HTN CPH",result_HTN,rowNames = F)
saveWorkbook(wb,"./Results/Linear and Cox models/IPA/TODAY somalogic Cox models scaled baseline adjusted HTN.xlsx",overwrite = TRUE)

wb <- createWorkbook()
addWorksheet(wb,"HTN with UACR CPH")
writeData(wb,"HTN with UACR CPH",results_htn_uacr,rowNames = F)
saveWorkbook(wb,"./Results/Linear and Cox models/IPA/TODAY somalogic Cox models scaled baseline adjusted HTN with UACR.xlsx",overwrite = TRUE)

wb <- createWorkbook()
addWorksheet(wb,"HTN with eGFR CPH")
writeData(wb,"HTN with eGFR CPH",results_htn_egfr,rowNames = F)
saveWorkbook(wb,"./Results/Linear and Cox models/IPA/TODAY somalogic Cox models scaled baseline adjusted HTN with eGFR.xlsx",overwrite = TRUE)
