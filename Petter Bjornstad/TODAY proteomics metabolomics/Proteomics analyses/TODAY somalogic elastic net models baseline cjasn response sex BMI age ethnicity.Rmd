...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMAC, MAC)~",paste0(mac_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = mac_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMAC, MAC)~HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = mac_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMIC, MIC)~",paste0(mic_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = mic_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMIC, MIC)~+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = mic_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~",paste0(mic.or.mac_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = mic.or.mac_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOMIC.OR.MAC, MIC.OR.MAC)~+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = mic.or.mac_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHYP, HYP)~",paste0(hyp_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = hyp_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHYP, HYP)~HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = hyp_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTORAPID, RAPID)~",paste0(rapid_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = rapid_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTORAPID, RAPID)~HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = rapid_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn.with.sbp_select,collapse = "+"),paste0("+HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = htn.with.sbp_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates (A1c, TG, eIS, SBP, sex, BMI, age, ethnicity)",mod$concordance[[6]], mod$concordance[[7]]))
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+sbp+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = htn.with.sbp_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates (A1c, TG, eIS, SBP, sex, BMI, age, ethnicity)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn_select,collapse = "+"),paste0("+HbA1c+log_trig+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)

# make a summary table
moddf <- as.data.frame(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
moddf[1:(nrow(moddf)-9),]$term <- analytes[analytes$AptName %in% moddf$term, ]$Target
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = htn_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn.with.uacr_select,collapse = "+"),paste0("+HbA1c+log_trig+UAlbCreat+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = htn.with.uacr_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates + UACR",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+UAlbCreat+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = htn.with.uacr_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates + UACR",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~",paste0(htn.with.egfr_select,collapse = "+"),paste0("+HbA1c+log_trig+EstCreatClear+si_1_ins0+sex_char+bmi+AGEBASE+racedesc")))
mod = coxph(formula = form,data = htn.with.egfr_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates (A1c, TG, eIS, eGFR, sex, BMI, age, ethnicity)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
```{r, include=FALSE, comment=""}
form = as.formula(paste0("Surv(DAYSTOHTN, HTN)~HbA1c+log_trig+EstCreatClear+si_1_ins0+sex_char+bmi+AGEBASE+racedesc"))
mod = coxph(formula = form,data = htn.with.egfr_nozero)
kable(tidy(mod, exponentiate = TRUE, conf.int = TRUE),digits = 3)
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates (A1c, TG, eIS, eGFR, sex, BMI, age, ethnicity)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
png('/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/forest_plot_elastic_net_DKD_sex_BMI_age_ethnicity.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
png('/Users/pylell/Dropbox/TODAY HTN and DKD output/forest_plot_elastic_net_DKD_sex_BMI_age_ethnicity.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
...
p$widths <- unit(c(1,100,50,50), "mm")
png('/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/forest_plot_elastic_net_htn_sex_BMI_age_ethnicity.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
png('/Users/pylell/Dropbox/TODAY HTN and DKD output/forest_plot_elastic_net_htn_sex_BMI_age_ethnicity.png', res = 300, width = 9, height = 3, units = "in")
p
dev.off()
```
