...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates (A1c, TG, SBP, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates (A1c, TG, SBP, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates (A1c, TG, UACR, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates (A1c, TG, UACR, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Proteins + covariates (A1c, TG, eGFR, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
moddf <- cbind(moddf$term,round(moddf$estimate, digits=3),round(moddf$std.error, digits=3),round(moddf$p.value, digits=3))
colnames(moddf) <- c("Variable","Hazard Ratio","SE","P-value")
concordance_df_temp <- as.data.frame(cbind("Hypertension","Covariates (A1c, TG, eGFR, eIS)",mod$concordance[[6]], mod$concordance[[7]]))
concordance_df_htn <- rbind(concordance_df_htn, concordance_df_temp)
```
...
concordance_df_htn <- rbind(concordance_df_htn[5,],concordance_df_htn[3,],concordance_df_htn[7,],concordance_df_htn[9,],
                            concordance_df_htn[1,],
                            concordance_df_htn[4,],concordance_df_htn[2,],concordance_df_htn[6,],concordance_df_htn[8,])
```
