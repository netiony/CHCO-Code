...
### Model validation for model with NELL only (10-fold crossvalidation)
...
```{r, include=TRUE, comment=""}
mod <- coxph(data = mic_nozero, formula = Surv(DAYSTOmic, mic)~seq.6544.33)
tidymod <- tidy(mod, exponentiate=TRUE, conf.int = TRUE)
```
...
```{r, include=TRUE, comment=""}
val1 <- validate(cph(formula = Surv(DAYSTOmic, mic)~seq.6544.33,data = mic_nozero, x=TRUE, y=TRUE, surv = TRUE), 
                 method="crossvalidation", B = 10, dxy=TRUE)
...
```{r, include=TRUE, comment=""}
mod <- coxph(data = hyp_nozero, formula = Surv(DAYSTOhyp, hyp)~seq.6544.33)
tidymod <- tidy(mod, exponentiate=TRUE, conf.int = TRUE)
```
...
```{r, include=TRUE, comment=""}
val1 <- validate(cph(formula = Surv(DAYSTOhyp, hyp)~seq.6544.33,data = hyp_nozero, x=TRUE, y=TRUE, surv = TRUE), 
                 method="crossvalidation", B = 10, dxy=TRUE)
...
```{r, include=TRUE, comment=""}
mod <- coxph(data = rapid_nozero, formula = Surv(DAYSTOrapid, rapid)~seq.6544.33)
tidymod <- tidy(mod, exponentiate=TRUE, conf.int = TRUE)
```
...
```{r, include=TRUE, comment=""}
val1 <- validate(cph(formula = Surv(DAYSTOrapid, rapid)~seq.6544.33,data = rapid_nozero, x=TRUE, y=TRUE, surv = TRUE), 
                 method="crossvalidation", B = 10, dxy=TRUE)
...
```{r, include=TRUE, comment=""}
mod <- coxph(data = htn_nozero, formula = Surv(DAYSTOhtn, htn)~seq.6544.33)
tidymod <- tidy(mod, exponentiate=TRUE, conf.int = TRUE)
```
...
```{r, include=TRUE, comment=""}
val1 <- validate(cph(formula = Surv(DAYSTOhtn, htn)~seq.6544.33,data = htn_nozero, x=TRUE, y=TRUE, surv = TRUE), 
                 method="crossvalidation", B = 10, dxy=TRUE)
