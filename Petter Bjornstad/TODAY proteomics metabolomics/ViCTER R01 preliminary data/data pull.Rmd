...
comorb <- comorb %>% select(releaseid,GLYC,DAYSTOGLYC)
...
victerlist <- read.csv("~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/ViCTER matching/matched_pairs.csv")
...
write.csv(victerdata,"~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/ViCTER matching/TODAY data for ViCTER.csv",row.names = F)
write.csv(analytes,"~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/ViCTER matching/analytes.csv",row.names = F)
