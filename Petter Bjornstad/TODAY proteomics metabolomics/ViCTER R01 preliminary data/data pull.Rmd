...
write.csv(victerdata,"~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/ViCTER matching/TODAY data for ViCTER.csv")
```
