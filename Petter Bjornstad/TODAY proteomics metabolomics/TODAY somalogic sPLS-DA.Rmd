...
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by microalbuminuria status",
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by macroalbuminuria status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by hyperfiltration status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by rapid eGFR decline status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by hypertension status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by neuropathy status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
...
## sPLS-DA function
splsda.utm <- splsda(X, Y, ncomp = 2, keepX = choice.keepX)
plotIndiv(splsda.utm,title = "sPLS-DA of untargeted metabolites by retinopathy status",
          pch = 20,ind.names = F,ellipse = T,legend = T)
