...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/plsCox_plasma_metabolomics_MAC.jpg", pointsize = 14, quality = 100, res=600,
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/plsCox_plasma_metabolomics_MIC.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
