...
```{r}
ora = function(limma_fit,p_thresh = 0.05){
  # Get gene names
  interest = analytes$UniProt[match(rownames(limma_results),analytes$AptName)]
...
gsea = function(limma_fit,name = "MAC",cores = 8){
  ...
  WebGestaltR(enrichMethod="GSEA", organism="hsapiens",
              ...
              interestGeneType="uniprotswissprot", sigMethod="fdr",
