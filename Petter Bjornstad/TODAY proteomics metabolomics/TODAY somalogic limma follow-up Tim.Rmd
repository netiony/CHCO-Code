...
mod_fit = function(outcomes = rownames(Y),predictor,df = soma){
  ...
  # Plot
  p = EnhancedVolcano(results,lab = rownames(results),pCutoff = 0.05,FCcutoff = 0.5,
...
The volcano plots below show a p value cutoff of 0.05 and a difference in FC cutoff of 0.5.
