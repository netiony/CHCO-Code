...
```{r}
f = "/Users/timvigers/Library/CloudStorage/OneDrive-TheUniversityofColoradoDenver/CHCO/Petter Bjornstad/TODAY subaward/Results/TODAY proteomics moderated t-tests 10 year cross-sectional adjusted.xlsx"
```
