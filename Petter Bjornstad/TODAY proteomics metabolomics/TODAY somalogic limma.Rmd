...
writeData(wb,"htn_moderated_FDR",results_rapid,rowNames = F)
addWorksheet(wb,"htn_moderated_maxT")
writeData(wb,"htn_moderated_maxT",resT_rapid,rowNames = F)
addWorksheet(wb,"htn_moderated_minP")
writeData(wb,"htn_moderated_minP",resP_rapid,rowNames = F)
