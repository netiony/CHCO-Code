...
writeData(wb,"MIC.OR.MAC_moderated_FDR",results_MIC.OR.MAC,rowNames = T)
addWorksheet(wb,"MIC.OR.MAC_moderated_maxT")
writeData(wb,"MIC.OR.MAC_moderated_maxT",resT_MIC.OR.MAC,rowNames = T)
addWorksheet(wb,"MIC.OR.MAC_moderated_minP")
writeData(wb,"MIC.OR.MAC_moderated_minP",resP_MIC.OR.MAC,rowNames = T)
...
writeData(wb,"hyperfilt_moderated_maxT",resT_hyperfilt,rowNames = T)
addWorksheet(wb,"hyperfilt_moderated_minP")
writeData(wb,"hyperfilt_moderated_minP",resP_hyperfilt,rowNames = T)
...
writeData(wb,"rapid_moderated_maxT",resT_rapid,rowNames = T)
addWorksheet(wb,"rapid_moderated_minP")
writeData(wb,"rapid_moderated_minP",resP_rapid,rowNames = T)
...
writeData(wb,"neuro_moderated_maxT",resT_neuro,rowNames = T)
addWorksheet(wb,"neuro_moderated_minP")
writeData(wb,"neuro_moderated_minP",resP_neuro,rowNames = T)
...
writeData(wb,"retino_moderated_maxT",resT_retino,rowNames = T)
addWorksheet(wb,"retino_moderated_minP")
writeData(wb,"retino_moderated_minP",resP_retino,rowNames = T)

saveWorkbook(wb,"E:/Petter Bjornstad/TODAY subaward/TODAY proteomics moderated t-tests.xlsx",overwrite = TRUE)
...
# need to convert to factor for the purposes of this table - what about other analyses?
t1 <- CreateTableOne(data=base, vars=c("MIC.OR.MAC","HYP","RAPID","NEURO","RETINO"))
```
