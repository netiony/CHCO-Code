...
t1 <- CreateTableOne(data=t1data, vars=c("MIC.OR.MAC","HYP","RAPID","NEURO","RETINO"))
t1 <- print(t1)
```
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_MIC.OR.MAC[,c("TargetFullName","logFC","adj.P.Val")]
...
p <- EnhancedVolcano(res, 
                ...
                xlim = c(-0.6,0.6),
                ylim = c(0,2.5),
                legendLabels=c('NS','Log(2) FC','q-value','q-value & log(2) FC'),
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_hyperfilt[,c("TargetFullName","logFC","adj.P.Val")]
res$adj.P.Val <- as.numeric(res$adj.P.Val)
p <- EnhancedVolcano(res, 
                lab="",
                x="logFC",
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_rapid[,c("TargetFullName","logFC","adj.P.Val")]
res$adj.P.Val <- as.numeric(res$adj.P.Val)
p <- EnhancedVolcano(res, 
                lab="",
                x="logFC",
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_htn[,c("TargetFullName","logFC","adj.P.Val")]
res$adj.P.Val <- as.numeric(res$adj.P.Val)
p <- EnhancedVolcano(res, 
                lab="",
                x="logFC",
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_neuro[,c("TargetFullName","logFC","adj.P.Val")]
res$adj.P.Val <- as.numeric(res$adj.P.Val)
p <- EnhancedVolcano(res, 
                lab="",
                x="logFC",
...
```{r echo=FALSE, include=TRUE}
# Volcano plot
res <- results_retino[,c("TargetFullName","logFC","adj.P.Val")]
res$adj.P.Val <- as.numeric(res$adj.P.Val)
p <- EnhancedVolcano(res, 
                lab="",
                x="logFC",
