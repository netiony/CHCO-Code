...
writeData(wb,"glyc_moderated_FDR",results_retino,rowNames = F)

saveWorkbook(wb,"./Results/TODAY proteomics moderated adjusted linear models.xlsx",overwrite = TRUE)
...
t1 <- CreateTableOne(data=t1data, vars=c("MIC.OR.MAC","MAC","MIC","HYP","RAPID","NEURO","RETINO","GLYC",
                                         "HbA1c","trig","sbp","si_1_ins0","AGEBASE","sex"))
t1 <- print(t1)
```
