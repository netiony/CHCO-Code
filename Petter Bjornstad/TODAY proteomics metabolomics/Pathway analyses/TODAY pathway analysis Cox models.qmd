---
title: "TODAY Somalogic Pathway Analyses: Scaled and Adjusted Cox Models"
author: "Tim Vigers"
...
```{r}
#f = "Z:/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx"
#f = "E:/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx"
...
# f <- "~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx"
```
...
mac_bar = mac_bar+guides(fill=guide_legend(title='Adjusted P Value'))+
  scale_y_discrete(labels=function(x) str_to_title(x))+ggtitle("")
ggsave("/Users/timvigers/Library/CloudStorage/Dropbox/Work/Shared/TODAY/TODAY DKD manuscript [shared]/Figures/TODAY Pathway Barplots (Cox Scaled Adjusted)/MAC_TODAY_cox_scaled_baseline_adjusted_1512x916.png",units = "px",
       width = 1512,height = 916,scale = 2,
       plot = mac_bar,device = "png")
...
mic_bar = mic_p$bar
# Edit for publication
mic_bar = mic_bar+guides(fill=guide_legend(title='Adjusted P Value'))+
  scale_y_discrete(labels=function(x) str_to_title(x))+ggtitle("")
ggsave("/Users/timvigers/Library/CloudStorage/Dropbox/Work/Shared/TODAY/TODAY DKD manuscript [shared]/Figures/TODAY Pathway Barplots (Cox Scaled Adjusted)/MIC_TODAY_cox_scaled_baseline_adjusted_1512x916.png",units = "px",
       width = 1512,height = 916,scale = 3,
       plot = mic_bar,device = "png")
...
```{r echo=FALSE,warning=FALSE,message=FALSE}
rapid_bar=rapid_p$bar
# Edit for publication
rapid_bar = rapid_bar+guides(fill=guide_legend(title='Adjusted P Value'))+
  scale_y_discrete(labels=function(x) str_to_title(x))+ggtitle("")
ggsave("/Users/timvigers/Library/CloudStorage/Dropbox/Work/Shared/TODAY/TODAY DKD manuscript [shared]/Figures/TODAY Pathway Barplots (Cox Scaled Adjusted)/RAPID_cox_scaled_baseline_adjusted_1512x916.png",units = "px",
       width = 1512,height = 916,scale = 3,
       plot = rapid_bar,device = "png")
...
saveRDS(glyc_p$bar$data,"/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Pathway analysis/glycemic_failure_GO_enrichment_barplot.rds")
```
