...
f = "/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/TODAY urine metabolomics Cox models scaled baseline adjusted.xlsx"
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_MAC.jpg", pointsize = 14, quality = 100, res=600,
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_MIC.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_HYP.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_RAPID.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_HTN.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
...
jpeg("/Volumes/Peds Endo/Petter Bjornstad/TODAY subaward/Results/Metabolomics linear and Cox models/Plots/Cox_urine_metabolomics_volcano_GLYC.jpg", pointsize = 14, quality = 100, res=600,
     units="in", width=10, height=10)
