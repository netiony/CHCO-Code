...
library(Hmisc)
#Read Data
indir = "/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Pima/Master data/Raw data/"
# indir = "C:/Path/On/Windows"
data=read.csv('Group4UofMRemodel112_DATA_2021-02-04_1617.csv')
#Setting Labels
...
label(data$f4_pillbotldt)="Date of last visit at which pills were dispensed"
label(data$f4_pillbotldt_mv)="Missing value verified for: Date of last visit at which pills were dispensed"
...
label(data$f9neutrophil)="Neutrophil"
label(data$f9neutrophil_mv)="Missing value verified for: Neutrophil"
label(data$f9lymphocyte)="Lymphocyte"
label(data$f9lymphocyte_mv)="Missing value verified for: Lymphocyte"
label(data$f9monocytes)="monocytes"
label(data$f9monocytes_mv)="Missing value verified for: monocytes"
label(data$f9eosinophil)="Eosinophil"
label(data$f9eosinophil_mv)="Missing value verified for: Eosinophil"
label(data$f9basophils)="Baso, Inst%"
label(data$f9basophils_mv)="Missing value verified for: Baso, Inst%"
label(data$f9other)="Other"
label(data$f9other_mv)="Missing value verified for: Other"
...
label(data$plvisitdate)="Visit Date"
label(data$plvisitdate_mv)="Missing value verified for: Visit Date"
...
label(data$slvisitdate)="Visit Date"
label(data$slvisitdate_mv)="Missing value verified for: Visit Date"
...
data$f9neutrophil_mv.factor = factor(data$f9neutrophil_mv,levels=c("1","0"))
data$f9lymphocyte_mv.factor = factor(data$f9lymphocyte_mv,levels=c("1","0"))
data$f9monocytes_mv.factor = factor(data$f9monocytes_mv,levels=c("1","0"))
data$f9eosinophil_mv.factor = factor(data$f9eosinophil_mv,levels=c("1","0"))
data$f9basophils_mv.factor = factor(data$f9basophils_mv,levels=c("1","0"))
data$f9other_mv.factor = factor(data$f9other_mv,levels=c("1","0"))
...
data$plvisitdate_mv.factor = factor(data$plvisitdate_mv,levels=c("1","0"))
...
data$slvisitdate_mv.factor = factor(data$slvisitdate_mv,levels=c("1","0"))
...
levels(data$redcap_event_name.factor)=c("SS Interval -3","SS Interval -2","SS Interval -1","RC Interval 0","RV Interval 0.7","RC/RV Interval 1","RV Interval 2","RV Interval 4","RC Interval 6","RV Interval 8","RV Interval 10","RC Interval 12","RV Interval 14","RV Interval 16","RC Interval 18","RV Interval 20","RV Interval 22","RC Interval 24","RV Interval 26","RV Interval 28","RC Interval 30","RV Interval 32","RV Interval 34","RC Interval 36","RV Interval 38","RV Interval 40","RC Interval 42","RV Interval 44","RV Interval 46","RC Interval 48","RV Interval 50","RV Interval 52","RC Interval 54","RV Interval 56","RV Interval 58","RC Interval 60","RV Interval 62","RV Interval 64","RC Interval 66","RV Interval 68","RV Interval 70","RC Interval 72","RV Interval 74","RV Interval 76","RC Interval 78","RV Interval 80","RV Interval 82","RC Interval 84","RV Interval 86","RV Interval 88","RC Interval 90","RV Interval 92","RV Interval 94","RC Interval 96","RV Interval 98","RV Interval 100","RC Interval 102","RV Interval 104","RV Interval 106","RC Interval 108","RV Interval 110","RV Interval 112","RC Interval 114","RV Interval 116","RV Interval 118","RC Interval 120","RV Interval 122","RV Interval 124","RC Interval 126","RV Interval 128","RV Interval 130","RC Interval 132","RV Interval 134","RV Interval 136","RC Interval 138","RV Interval 140","RV Interval 142","RC Interval 144","RV Interval 146","RV Interval 148","RC Interval 150","RV Interval 152","RV Interval 154","RC Interval 156","RV Interval 158","RV Interval 160","RC Interval 162","RV Interval 164","RV Interval 166","RC Interval 168")
...
levels(data$f9neutrophil_mv.factor)=c("Yes","No")
levels(data$f9lymphocyte_mv.factor)=c("Yes","No")
levels(data$f9monocytes_mv.factor)=c("Yes","No")
levels(data$f9eosinophil_mv.factor)=c("Yes","No")
levels(data$f9basophils_mv.factor)=c("Yes","No")
levels(data$f9other_mv.factor)=c("Yes","No")
...
levels(data$plvisitdate_mv.factor)=c("Yes","No")
...
levels(data$slvisitdate_mv.factor)=c("Yes","No")
