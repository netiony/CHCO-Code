...
```{r include=FALSE}
# Import data
source("~/GitHub/CHCO-Code/Petter Bjornstad/Pima/master_data/tim_merge/vital_status.R")
source("~/GitHub/CHCO-Code/Petter Bjornstad/Pima/master_data/tim_merge/losartan.R")
source("~/GitHub/CHCO-Code/Petter Bjornstad/Pima/master_data/tim_merge/group4.R")
source("~/GitHub/CHCO-Code/Petter Bjornstad/Pima/master_data/tim_merge/ficoll.R")
source("~/GitHub/CHCO-Code/Petter Bjornstad/Pima/master_data/tim_merge/ddn.R")
