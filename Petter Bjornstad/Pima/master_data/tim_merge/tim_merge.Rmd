...
important_vars = 
  c("nih","sacaton","pimc","date","protocol","testint","stratum","missed","dob",
    "date_dx  ","dod","underly","age","dmdur","sex ","ht_cm","wt_kg ",
    "bsa","sbp","dbp","pulse","sbp_6","dbp_6","pulse_6","medsnow","med_htn",
    "med_arb","med_orl","med_lipid","med_ras","med_nonras","med_ace","med_ins",
    "med_metformin","med_ald","med_statin","med_nsai","recent_illness","op",
    ...
    "smac_tbil","smac_alk","smac_ast","scr","fpg","hba1a","hba1b","hba1c","hba1o",
    "hbf","p0albumin","p0igg","p3albumin","p3igg","ucr","ualb","acr","u0igg",
    "u3albumin","u3igg","u3use_gfr","u3flow_gfr","u3gfr ","fc_alb","fc_igg",
    "gfr","gfrb","pah","pahb","rpf","rpfb","ff","extract","p0pia","p3pia","pie",
    "pigc","wbc","rbc","hgb","hct","mcv","mch","mchc","plts","neut","lymph",
    "mono","eos","baso","ua_glu","ua_bil","ua_ket","ua_sg","ua_ob","ua_ph",
    "ua_prot","ua_casts","ua_rbccasts","ua_wbccasts","ua_hyalinecasts",
    "ua_granularcasts","ua_othercasts","ua_otherexp","ua_wbc","ua_rbc","ua_epi",
    "ua_bact","stop_dt","stop_point","stop_esrd","stop_ndkd","stop_impdbladr",
...
# Rename and select
g4 = g4 %>% rename(date_dx = dtdiabonset,sex = gender,height_cm = height,
                  ...
                  heart = f5heart,heart_spec = f5heartexp,skin = f5skin,skin_spec = f5skinexp,
                  edema = f5edema,edema_spec = f5edemaexp,smac_glu = f4srmglu,
                  smac_na = f4srmpotasm,smac_k = f8potassium,smac_cl = f8chloride,
                  smac_ca = f8calcium,smac_tp = f8totlprotn,smac_alb = f8albumin,
                  smac_chol = f8cholestero,smac_tri = f8triglyceri,smac_hdl = f8hdl,
                  smac_ldl = f8ldl,smac_tbil = f8totlbilrbn,smac_alk = f8alkp04,
                  acr = f3_acratio,bsa = f6bsa,pah = pahclrnc,rpf = s_rpf,
                  p0pia = p0oncoticprsr,p3pia = p3oncoticprsr,pie = s_pie,
