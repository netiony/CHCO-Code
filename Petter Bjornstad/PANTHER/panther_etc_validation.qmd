...
en_tkv_others <- easy_elasticnet(data = others_combined_tkv, 
                        outcome = "combined_tkv", out = "1se.error",
...
result_ht_adj_tkv_100 <- head(result_ht_adj_tkv_others, 100)$AptName
...
en_ht_adj_tkv_others <- easy_elasticnet(data = ht_adj_tkv_others, 
                        outcome = "combined_ht_tkv", out = "1se.error",
...
result_gfr_others_100 <- head(result_gfr_others, 80)$AptName
...
result_rpf_others_100 <- head(result_rpf_others, 100)$AptName
...
result_gfr_comb_100 <- head(result_gfr_comb, 80)$AptName
...
tkv_upset_list <- unique(c(en_tkv_others, retained_vars_tkv$term))
