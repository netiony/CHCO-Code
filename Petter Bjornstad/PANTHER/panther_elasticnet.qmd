...
create_lm_summary_table_plot <- function(model_df, title = NULL, digits = 3, ...) {
  
  # Generate a sorted table using kable
  sorted_table <- kable(arrange(model_df, p.value), digits = digits, ...)
  model_df <- model_df %>%
    mutate(p_color = case_when(p.value < 0.05 ~ "#0077b6", 
                             T ~ "#6c757d"))
  ...
  plot <- ggplot(model_df[-1,], 
    ...
    geom_errorbarh(aes(color = p_color)) +
    scale_color_manual(values = c("#0077b6", "#6c757d")) +
    labs(y = NULL, 
         x = "Estimate",
         title = title) +
    theme_minimal() +
...
create_lm_summary_table_plot(mod_df_tkv$model_df, format = "html", title = "Total Kidney Volume")
p <- create_lm_summary_table_plot(mod_df_tkv$model_df, format = "html", title = "Total Kidney Volume")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/tkv_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_tkv_adj$model_df, format = "html", title = "Total Kidney Volume (Adjusted)")
p <- create_lm_summary_table_plot(mod_df_tkv_adj$model_df, format = "html", title = "Total Kidney Volume (Adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/tkv_adj_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_ht_adj_tkv$model_df, format = "html", title = "Height Adjusted Total Kidney Volume")
p <- create_lm_summary_table_plot(mod_df_ht_adj_tkv$model_df, format = "html", title = "Height Adjusted Total Kidney Volume")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/htadj_tkv_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_ht_adj_tkv_adj$model_df, format = "html", title = "Height Adjusted Total Kidney Volume (Adjusted)")
p <- create_lm_summary_table_plot(mod_df_ht_adj_tkv_adj$model_df, format = "html", title = "Height Adjusted Total Kidney Volume (Adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/htadj_tkv_adj_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_gfr$model_df, format = "html", title = "GFR (Raw)")
p <- create_lm_summary_table_plot(mod_df_gfr$model_df, format = "html", title = "GFR (Raw)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/raw_gfr_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_gfr_adj$model_df, format = "html", title = "GFR (Raw, adjusted)")
p <- create_lm_summary_table_plot(mod_df_gfr_adj$model_df, format = "html", title = "GFR (Raw, adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/raw_gfr_adjusted_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_gfr_bsa$model_df, format = "html", title = "GFR (BSA)")
p <- create_lm_summary_table_plot(mod_df_gfr_bsa$model_df, format = "html", title = "GFR (BSA)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/bsa_gfr_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_gfr_bsa_adj$model_df, format = "html", title = "GFR (BSA, adjusted)")
p <- create_lm_summary_table_plot(mod_df_gfr_bsa_adj$model_df, format = "html", title = "GFR (BSA, adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/bsa_gfr_adj_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_rpf$model_df, format = "html", title = "ERPF (Raw)")
p <- create_lm_summary_table_plot(mod_df_rpf$model_df, format = "html", title = "ERPF (Raw)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/raw_erpf_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_rpf_adj$model_df, format = "html", title = "ERPF (Raw, adjusted)")
p <- create_lm_summary_table_plot(mod_df_rpf_adj$model_df, format = "html", title = "ERPF (Raw, adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/raw_erpf_adj_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_erpf_bsa$model_df, format = "html", title = "ERPF (BSA)")
p <- create_lm_summary_table_plot(mod_df_erpf_bsa$model_df, format = "html", title = "ERPF (BSA)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/bsa_erpf_figure.jpeg", p,
       height = 8)
```
...
create_lm_summary_table_plot(mod_df_erpf_bsa_adj$model_df, format = "html", title = "ERPF (BSA, adjusted)")
p <- create_lm_summary_table_plot(mod_df_erpf_bsa_adj$model_df, format = "html", title = "ERPF (BSA, adjusted)")$plot
ggsave("/Users/choiyej/Library/CloudStorage/OneDrive-SharedLibraries-UW/Laura Pyle - Bjornstad/Biostatistics Core Shared Drive/PANTHER/Results/Figures/IPNA/bsa_erpf_adj_figure.jpeg", p,
       height = 8)
```
...
elasticnet_combined_ivgtt <- data.frame(r2 = c(mod_airg_specs$rsq_adj, mod_bcell_specs$rsq_adj, mod_di_specs$rsq_adj, mod_si_specs$rsq_adj),
                                  lower = c(mod_airg_specs$conf.low, mod_bcell_specs$conf.low, mod_di_specs$conf.low, mod_si_specs$conf.low),
                                  upper = c(mod_airg_specs$conf.high, mod_bcell_specs$conf.high, mod_di_specs$conf.high, mod_si_specs$conf.high),
...
```{r elastic-net-combined-disi, echo=F}
elasticnet_combined_disi <- data.frame(r2 = c(mod_di_specs$rsq_adj, mod_si_specs$rsq_adj),
                                  lower = c(mod_di_specs$conf.low, mod_si_specs$conf.low),
                                  upper = c(mod_di_specs$conf.high, mod_si_specs$conf.high),
                                  Model = c("DI", "SI"),
                                  No.proteins = c(length(en_di), length(en_si)))
elasticnet_combined_disi$` ` <- paste(rep(" ", 20), collapse = " ")

# Create confidence interval column to display
elasticnet_combined_disi$`Adjusted R-squared (95% CI)` <- ifelse(is.na(elasticnet_combined_disi$r2), "",
                             sprintf("%.2f (%.2f to %.2f)",
                                     elasticnet_combined_disi$r2, elasticnet_combined_disi$lower, elasticnet_combined_disi$upper))

forest(data = elasticnet_combined_disi[,c(4:7)], 
       est = elasticnet_combined_disi$r2,
       lower = elasticnet_combined_disi$lower,
       upper = elasticnet_combined_disi$upper, ci_column = 3)
```
...
```{r elastic-net-combined-disi-adj, echo=F}
elasticnet_combined_adj_disi <- data.frame(r2 = c(mod_di_adj_specs$rsq_adj, mod_si_adj_specs$rsq_adj),
                                  lower = c(mod_di_adj_specs$conf.low, mod_si_adj_specs$conf.low),
                                  upper = c(mod_di_adj_specs$conf.high, mod_si_adj_specs$conf.high),
                                  Model = c("DI", "SI"),
                                  No.proteins = c(length(en_di_adj)-2, 
                                                  length(en_si_adj)-2))
elasticnet_combined_adj_disi$` ` <- paste(rep(" ", 20), collapse = " ")

# Create confidence interval column to display
elasticnet_combined_adj_disi$`Adjusted R-squared (95% CI)` <- ifelse(is.na(elasticnet_combined_adj_disi$r2), "",
                             sprintf("%.2f (%.2f to %.2f)",
                                     elasticnet_combined_adj_disi$r2, elasticnet_combined_adj_disi$lower, elasticnet_combined_adj_disi$upper))

forest(data = elasticnet_combined_adj_disi[,c(4:7)], 
       est = elasticnet_combined_adj_disi$r2,
       lower = elasticnet_combined_adj_disi$lower,
       upper = elasticnet_combined_adj_disi$upper, ci_column = 3)
```
