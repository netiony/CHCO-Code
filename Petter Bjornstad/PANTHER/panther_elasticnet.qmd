...
mod_df_airg = as.data.frame(tidy(mod_airg, exponentiate = F, conf.int = T), digits = 3) %>% 
  left_join(retained_vars_airg) %>%
...
result_tkv_100 <- head(result_tkv, 100)$AptName
...
result_gfr_bsa_100 <- head(result_gfr_bsa, 100)$AptName
