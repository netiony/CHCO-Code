...
# Descriptive tables
## By risk
summary(tableby(group_risk ~ age + sex + tanner_stage_comp + group + weight + height + bmi + bmip + hba1c + gfr_raw_plasma + gfr_bsa_plasma + erpf_raw_plasma + erpf_bsa_plasma + total_kidney_volume_ml + ht_adj_tkv + avg_c_adc + avg_c_r2 + avg_pcascl + mm_airg + mm_bcell + mm_di + mm_ir + mm_si + dexa_body_fat + dexa_fat_kg + dexa_lean_mass + dexa_lean_kg + dexa_trunk_mass + dexa_trunk_kg + dexa_bone_mineral_density + fsh + lh + estrad + tot_test + free_test + igf_1 + igf1_z_score + sbp_p + dbp_p, data = panther, total = T, test = F))
```
...
iqr_plot(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_adc",
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical ADC")

iqr_plot(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_r2",
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical R2*")

iqr_plot(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_pcascl",
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical pCASCL")

# iqr_plot(data = panther, 
#          x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_t1",
...
iqr_plot_grp <- function(data, x_var, y_var, group_var = NULL,
  ...
  ggplot(data = data, aes_string(x = x_var, y = y_var, linetype = group_var, 
                                 color = group_var)) +
    geom_jitter(width = 0.2, alpha = 0.5) +
    stat_summary(
      fun = median, 
...
iqr_plot_grp(data = subset(panther, mm_si < 500), 
         x_var = "tanner_stage_comp_panther_cat", y_var = "mm_si",group_var = "group_risk", 
         x_var_lab = "Tanner stage", y_var_lab = "SI (excluding outliers)", group_lab = "Risk group")
...
# (ADC, R2*, ASL, T1 mapping)
iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_adc", group_var = "group_risk", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical ADC", group_lab = "Risk group")

iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_r2", group_var = "group_risk", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical R2*", group_lab = "Risk group")

iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_pcascl", group_var = "group_risk", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical pCASCL", group_lab = "Risk group")

# iqr_plot_grp(data = panther, 
#          x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_t1", group_var = "group_risk", 
#          x_var_lab = "Tanner stage", y_var_lab = "Avg cortical T1", group_lab = "Risk group")
...
iqr_plot_grp(data = subset(panther, mm_si < 500), 
         x_var = "tanner_stage_comp_panther_cat", y_var = "mm_si",group_var = "sex", 
         x_var_lab = "Tanner stage", y_var_lab = "SI (excluding outliers)", group_lab = "Sex")
...
# (ADC, R2*, ASL, T1 mapping)
iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_adc", group_var = "sex", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical ADC", group_lab = "Sex")

iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_r2", group_var = "sex", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical R2*", group_lab = "Sex")

iqr_plot_grp(data = panther, 
         x_var = "tanner_stage_comp_panther_cat", y_var = "avg_pcascl", group_var = "sex", 
         x_var_lab = "Tanner stage", y_var_lab = "Avg cortical pCASCL", group_lab = "Sex")

# iqr_plot_grp(data = panther, 
#          x_var = "tanner_stage_comp_panther_cat", y_var = "avg_c_t1", group_var = "sex", 
