...
D[2, 1] <- -0.1
delta <- 1.0 ### standardized effect size

age1 <- c(9, 10, 11) ### age stages of measurement cohort 1
age2 <- c(10, 11, 12) ### age stages of measurement cohort 2
age3 <- c(11, 12, 13) ### age stages of measurement cohort 3
age4 <- c(12, 13, 14) ### age stages of measurement cohort 4
