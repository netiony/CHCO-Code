...
igfr_plot = ggplot(plot_df,aes(y = igfr,x = pred)) + 
  ...
  geom_text(x=160, y=100, label=expression(paste("Multiple ",R^2," = 0.538",sep = "")),inherit.aes = F) +
  xlab("Model Predicted Value") + theme_bw() + theme(axis.text.y = element_blank(),
...
igfr_ab_plot = ggplot(plot_df,aes(y = igfr_ab,x = pred)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  geom_text(x=130, y=95, label=expression(paste("Multiple ",R^2," = 0.654",sep = "")),inherit.aes = F) +
  xlab("Model Predicted Value") + theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank())
```
...
egfr_sch_plot = ggplot(df,aes(y = igfr,x = eGFR_schwartz)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  geom_text(x=225, y=100, label=expression(paste(R^2," = 0.169",sep = "")),inherit.aes = F) +
  theme_bw() + ylab("IGFR") + xlab("eGFR (Schwartz)")
egfr_sch_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_schwartz)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  geom_text(x=225, y=100, label=expression(paste(R^2," = 0.003",sep = "")),inherit.aes = F) +
  theme_bw() + ylab("IGFR Ab") + xlab("eGFR (Schwartz)")
```
...
egfr_pot_plot = ggplot(df,aes(y = igfr,x = eGFR_cr)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  geom_text(x=250, y=100, label=expression(paste(R^2," = 0.299",sep = "")),inherit.aes = F) +
  theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank()) + xlab("eGFR (Pottel)")
egfr_pot_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_cr)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  geom_text(x=250, y=100, label=expression(paste(R^2," = 0.048",sep = "")),inherit.aes = F) +
  theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank()) + xlab("eGFR (Pottel)")
```
