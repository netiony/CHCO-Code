...
igfr_plot = ggplot(plot_df,aes(y = igfr,x = pred)) + 
  ...
  xlab("GFR Estimated by MRI Model (ml/min/1.73 sqm)") + theme_bw() + theme(axis.text.y = element_blank(),
...
igfr_ab_plot = ggplot(plot_df,aes(y = igfr_ab,x = pred)) + 
  ...
  xlab("GFR Estimated by MRI Model (ml/min)") + theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank())
```
...
egfr_sch_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_schwartz)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  annotate("text",x=225, y=100, label=expression(paste(R^2," = 0.003",sep = ""))) +
  theme_bw() + ylab("IGFR Ab (ml/min)" ) + xlab("eGFR Schwartz (ml/min/1.73 sqm)")
```
...
egfr_pot_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_cr)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  annotate("text",x=250, y=100, label=expression(paste(R^2," = 0.048",sep = ""))) +
  theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank()) + xlab("eGFR Pottel (ml/min/1.73 sqm)")
```
