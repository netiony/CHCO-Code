...
igfr_plot = ggplot(plot_df,aes(y = igfr,x = pred)) + 
  ...
  xlab("Predicted Value") + ylab("Actual Value") + ggtitle("IFGR") + theme_bw()
```
...
igfr_ab_plot = ggplot(plot_df,aes(y = igfr_ab,x = pred)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  xlab("Predicted Value") + ylab("Actual Value") + ggtitle("IFGR AB") + theme_bw()
```
...
plot_df = mod$model
plot_df$pred = predict(mod)
egfr_sch_plot = ggplot(plot_df,aes(y = eGFR_schwartz,x = pred)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  xlab("Predicted Value") + ylab("Actual Value") + ggtitle("eGFR (Schwartz)") + theme_bw()
```
...
plot_df = mod$model
plot_df$pred = predict(mod)
egfr_pot_plot = ggplot(plot_df,aes(y = eGFR_cr,x = pred)) + 
  geom_point() + geom_abline(intercept = 0,slope = 1) +
  xlab("Predicted Value") + ylab("Actual Value") + ggtitle("eGFR (Pottel)") + theme_bw()
```

# Model performance plot

```{r}
(igfr_plot + igfr_ab_plot)/(egfr_sch_plot + egfr_pot_plot)
```
