...
library(caret)
library(patchwork)
knitr::opts_chunk$set(echo = FALSE,fig.height = 10,fig.width = 10,dpi = 600)
...
egfr_sch_plot = ggplot(df,aes(y = igfr,x = eGFR_schwartz)) + 
  ...
  theme_bw() + ylab("IGFR (ml/min/1.73 sqm)") + xlab("eGFR Schwartz (ml/min/1.73 sqm)")
...
egfr_sch_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_schwartz_unadj)) + 
  ...
  theme_bw() + ylab("IGFR Ab (ml/min)" ) + xlab("eGFR Schwartz (ml/min)")
```
...
egfr_pot_plot = ggplot(df,aes(y = igfr,x = eGFR_cr)) + 
  ...
  theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank()) + xlab("eGFR Pottel (ml/min/1.73 sqm)")
# Calculate eGFR not adjusted for BSA
...
egfr_pot_plot2 = ggplot(df,aes(y = igfr_ab,x = eGFR_cr_unadj)) + 
  ...
  theme_bw() + theme(axis.text.y = element_blank(),
                     axis.ticks.y = element_blank(),
                     axis.title.y = element_blank()) + xlab("eGFR Pottel (ml/min)")
```
