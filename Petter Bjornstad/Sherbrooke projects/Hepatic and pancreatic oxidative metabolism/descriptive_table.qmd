...
summary(tableby(group ~ age + sex + race + ethnicity + eGFR_fas_cr + combined_tkv + combined_ht_tkv + avg_c_k1 + avg_m_k1 + avg_c_k2 + avg_m_k2 + avg_c_f + avg_m_f, data = dat), test = F, total = F)
```