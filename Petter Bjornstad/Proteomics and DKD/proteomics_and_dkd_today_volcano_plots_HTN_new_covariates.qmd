...
volcano_htn <- function(data, lab = "Target", xcol = "estimate", ycol = "p.value",
                    top = c("WFKN2","SEZ6L","NCAM-120","Coagulation Factor IXab","NCAM1",
                            "STA10","SCG3","Aminoacylase-1","ESPN","PURA1","SERB",
                            "CHL1","TMEDA","PEDF","UGDH","LSAMP","H6ST3","OFUT1",
                            "Growth hormone receptor","carboxylesterase, liver"),
                    xlimit = c(-1, 1), ylimit = c(0, -log10(10e-7)),
