...
v_htn
ggsave(
  filename = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/HTN_volcano_1600x900.jpeg", plot = v_htn,
  width = 1600, height = 900, units = "px", scale = 2
)
ggsave(
