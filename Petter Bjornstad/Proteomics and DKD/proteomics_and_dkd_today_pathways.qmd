...
volcano_htn <- function(data, lab = "Target", xcol = "estimate", ycol = "p.value",
                    top = c("WFKN2","SEZ6L","SCG3","PEDF","TLR5","PSA","Myosin light chain 1","PSB3","PSPC1","H6ST3"),
                    xlimit = c(-1, 1), ylimit = c(0, -log10(10e-7)),
                    xlabel = "HR", pCutoff = 0.05, overlaps = 10,
                    log_t = F) {
  data <- as.data.frame(data)
...
v_htn
ggsave(
  filename = "/Volumes/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/HTN_volcano_1600x900.jpeg", plot = v_htn,
  width = 1600, height = 900, units = "px", scale = 2
)
```
