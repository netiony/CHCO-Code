...
so = readRDS("/Volumes/Peds Endo/Petter Bjornstad/scRNA/Data_Raw/PB_68samples_harmonyIntegration_092322_Fadhl.RDS")
# Remove dimension reductions etc.
so = DietSeurat(so)
# Save smaller object
saveRDS(so,file = "/Volumes/Peds Endo/Petter Bjornstad/scRNA/Data_Clean/pbscrna.RDS")
# # Convert to AnnData
# SaveH5Seurat(so, filename = "/Volumes/Peds Endo/Petter Bjornstad/scRNA/Data_Clean/pbscrna.h5Seurat")
# Convert("/Volumes/Peds Endo/Petter Bjornstad/scRNA/Data_Clean/pbscrna.h5Seurat", dest = "h5ad")
```

```{r}
so = readRDS("/Volumes/Peds Endo/Petter Bjornstad/scRNA/Data_Clean/pbscrna.RDS")
```
