...
pathway_comparison <- function(de_gene_list) {
  ...
  data = lapply(names(de_gene_list),function(n){
    genes = names(de_gene_list[[n]])
    t = data.frame("Entrez"=genes,"logFC"=de_gene_list[[n]],"Time"=n)
  })
  data = do.call(rbind,data)
  # Compare with GO enrichment
  ck <- compareCluster(Entrez~Time,data = data, fun='groupGO', OrgDb='org.Hs.eg.db')
  # Plots
  dot <- dotplot(ck)
  net <- cnetplot(ck)
  # Return
...
p_mic <- mic_p$dot +
  ggtitle("Moderate Albuminuria") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/MIC_pathway_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 1.5, plot = p_mic, device = "jpeg"
)

p_mac <- mac_p$dot +
  ggtitle("Severe Albuminuria") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/MAC_pathway_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 1.5, plot = p_mac, device = "jpeg"
)
...
p_htn <- htn_p$dot +
  ggtitle("Hypertension") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/HTN_pathway_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 1.5, plot = p_htn, device = "jpeg"
)
...
p_mic <- mic_p_comp$dot +
  ggtitle("Moderate Albuminuria") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/MIC_pathway_comp_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 2, plot = p_mic, device = "jpeg"
)

p_mac <- mac_p_comp$dot +
  ggtitle("Severe Albuminuria") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/MAC_pathway_comp_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 2, plot = p_mac, device = "jpeg"
)
...
p_htn <- htn_p_comp$dot +
  ggtitle("Hypertension") +
  theme(plot.title = element_text(hjust = 0.5))
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/HTN_pathway_comp_1600x900.jpeg",
  units = "px",
  width = 1600, height = 900, scale = 2, plot = p_htn, device = "jpeg"
)
