...
retino_p_comp = pathway_comparison(list(Baseline = de_genes_retino,
                                     Followup=de_genes_retino_10))
```
...
fig1
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_1_1512x916.jpeg",units = "px",
       width = 1512,height = 916,scale = 2,plot = fig1,device = "jpeg")
```
...
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_2_1512x916.jpeg",units = "px",
       width = 1512,height = 916,scale = 3,plot = fig2,device = "jpeg")
```
