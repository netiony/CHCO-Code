...
top_mic_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "MIC CPH")
...
top_mic <- top_mic_df %>%
  ...
  pull(AptName)
top_mac_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "MAC CPH")
...
top_mac <- top_mac_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_hyp_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HYP CPH")
...
top_hyp <- top_hyp_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_rapid_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "RAPID CPH")
...
top_rapid <- top_rapid_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_htn_sbp_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HTN with SBP CPH")
...
top_htn_sbp <- top_htn_sbp_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_htn_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HTN CPH")
...
top_htn <- top_htn_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_neuro_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "NEURO CPH")
...
top_neuro <- top_neuro_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_retino_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "RETINO CPH")
...
top_retino <- top_retino_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_glyc_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "GLYC CPH")
...
top_glyc <- top_glyc_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_glyc_a1c_df <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "GLYC with A1c CPH")
...
top_mac_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "MAC_moderated_FDR")
...
top_mic_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "MIC_moderated_FDR")
...
top_hyp_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "hyperfilt_moderated_FDR")
...
top_rapid_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "rapid_moderated_FDR")
...
top_htn_sbp_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "htn_with_SBP_moderated_FDR")
...
top_htn_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "htn_moderated_FDR")
...
top_neuro_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "neuro_moderated_FDR")
...
top_glyc_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "glyc_moderated_FDR")
...
top_glyc_a1c_df_10 <- read_excel("~/Documents/Work/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "glyc_with_a1c_moderated_FDR")
...
olink_map <- read.csv("~/Documents/Work/Petter Bjornstad/Olink Data/Data_Clean/olink_id_map.csv")
load("~/Documents/Work/Petter Bjornstad/IMPROVE T2D/Olink Data/improve_olink_plasma.Rdata")
load("~/Documents/Work/Petter Bjornstad/IMPROVE T2D/Olink Data/improve_olink_urine.Rdata")
load("~/Documents/Work/Petter Bjornstad/Renal HERITAGE/Olink Data/rh_olink_plasma.Rdata")
load("~/Documents/Work/Petter Bjornstad/Renal HERITAGE/Olink Data/rh_olink_urine.Rdata")
