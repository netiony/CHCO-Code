...
mac_p_comp = pathway_comparison(list(Baseline = de_genes_mac,
...
mic_p_comp = pathway_comparison(list(Baseline = de_genes_mic,
...
hyp_p_comp = pathway_comparison(list(Baseline = de_genes_hyp,
...
rapid_p_comp = pathway_comparison(list(Baseline = de_genes_rapid,
...
htn_sbp_p_comp = pathway_comparison(list(Baseline = de_genes_htn_sbp,
...
htn_p_comp = pathway_comparison(list(Baseline = de_genes_htn,
...
neuro_p_comp = pathway_comparison(list(Baseline = de_genes_neuro,
                                     Followup=de_genes_neuro_10))
```
...
```{r warning=FALSE}
v_retino = volcano(top_retino_df)
v_retino = v_retino + 
  ggtitle("Hypertension") + 
  theme(plot.title = element_text(hjust = 0.5))
v_retino
...
```{r results='asis'}
cor_and_plot_olink(vars = top_glyc_olink)
```
...
glyc_p_comp = pathway_comparison(list(Baseline = de_genes_glyc,
                                     Followup=de_genes_glyc_10))
```
...
```{r warning=FALSE}
v_glyc_a1c = volcano(top_glyc_a1c_df)
v_glyc_a1c = v_glyc_a1c + 
  ggtitle("Hypertension") + 
  theme(plot.title = element_text(hjust = 0.5))
v_glyc_a1c
```
...
glyc_a1c_p_comp = pathway_comparison(list(Baseline = de_genes_glyc_a1c,
                                     Followup=de_genes_glyc_a1c_10))
```
...
fig1
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_1_1600x900.jpeg",units = "px",
...
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_2_1600x900.jpeg",units = "px",
...
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_3_1600x900.jpeg",units = "px",
...
ggsave("/home/tim/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Proteomics and DKD/Figures/Figure_S1_1600x900.jpeg",units = "px",
