...
so <- so[, sub("_BL","",so$michigan_id) %in% ids]
# Combined groups
...
so$elevated_uacr <- factor(so$acr_u >= 30,labels = c("UACR < 30","UACR >= 30"))
# Normalize and scale
so <- NormalizeData(so)
...
df %>%
  ...
  select(
    group, age, sex, race_ethnicity_condensed, diabetes_duration, hba1c, bmi, 
    acr_u, elevated_albuminuria, soma, olink_plasma, olink_urine, scRNA
  ) %>%
...
```{r results='asis', dpi=1200}
de(outcome = "elevated_uacr", ref_group = "UACR < 30", vars = top_hyp)
```
...
```{r results='asis', dpi=1200}
de(outcome = "elevated_uacr", ref_group = "UACR < 30", vars = top_rapid)
```
...
```{r results='asis', dpi=1200}
de(outcome = "elevated_uacr", ref_group = "UACR < 30", vars = top_htn)
```
...
```{r results='asis', dpi=1200}
de(outcome = "elevated_uacr", ref_group = "UACR < 30", vars = top_htn_sbp)
```
...
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/MAC_ORA_1600x900.jpeg",plot = mac_plot,
...
mac_comp_plot = mac_p_comp$updot + mac_p_comp$downdot + 
  plot_annotation(title = "Severe Albuminuria",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/MAC_ORA_comparison_1600x900.jpeg",
...
mic_plot = mic_p$updot + mic_p$downdot + 
  plot_annotation(title = "Moderate Albuminuria",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/MIC_ORA_1600x900.jpeg",plot = mic_plot,
       width = 1600,height = 900,units = "px",scale = 2.5)
...
mic_comp_plot = mic_p_comp$updot + mic_p_comp$downdot + 
  plot_annotation(title = "Moderate Albuminuria",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/MIC_ORA_comparison_1600x900.jpeg",
...
hyp_plot = hyp_p$updot + hyp_p$downdot + 
  plot_annotation(title = "Hyperfiltration",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/HYP_ORA_1600x900.jpeg",plot = hyp_plot,
...
hyp_comp_plot = hyp_p_comp$updot + hyp_p_comp$downdot + 
  plot_annotation(title = "Hyperfiltration",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/HYP_ORA_comparison_1600x900.jpeg",
...
rapid_plot = rapid_p$updot + rapid_p$downdot + 
  plot_annotation(title = "Rapid eGFR decline",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/RAPID_ORA_1600x900.jpeg",plot = rapid_plot,
...
rapid_comp_plot = rapid_p_comp$updot + rapid_p_comp$downdot + 
  plot_annotation(title = "Rapid eGFR decline",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/RAPID_ORA_comparison_1600x900.jpeg",
...
htn_plot = htn_p$updot + htn_p$downdot + 
  plot_annotation(title = "Hypertension",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/HTN_ORA_1600x900.jpeg",plot = htn_plot,
       width = 1600,height = 900,units = "px",scale = 2.8)
...
htn_comp_plot = htn_p_comp$updot + htn_p_comp$downdot + 
  plot_annotation(title = "Hypertension",
                  theme = theme(plot.title = element_text(hjust = 0.5)))
ggsave(filename = "/Users/timvigers/Library/CloudStorage/Dropbox/TODAY/TODAY DKD manuscript [shared]/Figures/HTN_ORA_comparison_1600x900.jpeg",
