...
top_mic_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "MIC CPH")
...
top_mic <- top_mic_df %>%
  ...
  pull(AptName)
top_mac_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "MAC CPH")
...
top_mac <- top_mac_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_hyp_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HYP CPH")
...
top_hyp <- top_hyp_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_rapid_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "RAPID CPH")
...
top_rapid <- top_rapid_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_htn_sbp_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HTN with SBP CPH")
...
top_htn_sbp <- top_htn_sbp_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_htn_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "HTN CPH")
...
top_htn <- top_htn_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_neuro_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "NEURO CPH")
...
top_neuro <- top_neuro_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_retino_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "RETINO CPH")
...
top_retino <- top_retino_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_glyc_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "GLYC CPH")
...
top_glyc <- top_glyc_df %>%
  ...
  slice_max(abs(log(estimate)), n = 5) %>%
  pull(AptName)
top_glyc_a1c_df <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic Cox models scaled baseline adjusted.xlsx", sheet = "GLYC with A1c CPH")
...
top_mac_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "MAC_moderated_FDR")
...
top_mic_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "MIC_moderated_FDR")
...
top_hyp_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "hyperfilt_moderated_FDR")
...
top_rapid_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "rapid_moderated_FDR")
...
top_htn_sbp_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "htn_with_SBP_moderated_FDR")
...
top_htn_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "htn_moderated_FDR")
...
top_neuro_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "neuro_moderated_FDR")
...
top_glyc_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "glyc_moderated_FDR")
...
top_glyc_a1c_df_10 <- read_excel("/home/yejichoi/UCD/Petter Bjornstad/TODAY subaward/Results/Linear and Cox models/TODAY somalogic limma yr10 adjusted.xlsx", sheet = "glyc_with_a1c_moderated_FDR")
...
df <- read.csv("/home/yejichoi/UCD/Petter Bjornstad/Data Harmonization/Data Clean/harmonized_dataset.csv", na.strings = "")
df <- df %>%
  filter(
...
load("/home/yejichoi/UCD/Petter Bjornstad/Renal HERITAGE/Somalogic data/analytes.Rdata")
load("/home/yejichoi/UCD/Petter Bjornstad/Renal HERITAGE/Somalogic data/rh_soma.Rdata")
load("/home/yejichoi/UCD/Petter Bjornstad/IMPROVE T2D/Somalogic data/improve_soma.Rdata")
# Format and combine
...
olink_map <- read.csv("/home/yejichoi/UCD/Petter Bjornstad/Olink Data/Data_Clean/olink_id_map.csv")
load("/home/yejichoi/UCD/Petter Bjornstad/IMPROVE T2D/Olink Data/improve_olink_plasma.Rdata")
load("/home/yejichoi/UCD/Petter Bjornstad/IMPROVE T2D/Olink Data/improve_olink_urine.Rdata")
load("/home/yejichoi/UCD/Petter Bjornstad/Renal HERITAGE/Olink Data/rh_olink_plasma.Rdata")
load("/home/yejichoi/UCD/Petter Bjornstad/Renal HERITAGE/Olink Data/rh_olink_urine.Rdata")
...
so <- readRDS("/home/yejichoi/UCD/Petter Bjornstad/scRNA/Data_Raw/PB_68samples_harmonyIntegration_092322_Fadhl.RDS")
# Strip computations
so <- DietSeurat(so)
...
cor_and_plot_olink <- function(plasma_df = plasma, urine_df = urine, vars) {
  ...
  # Format matrices
  plasma_df <- plasma_df[plasma_df$group == "Type 2 Diabetes", 
                         c(vars, "acr_u","map", "gfr_raw_plasma", "gfr_bsa_plasma")]
  urine_df <- urine_df[urine_df$group == "Type 2 Diabetes", 
                       c(vars, "acr_u","map", "gfr_raw_plasma", "gfr_bsa_plasma")]
  # Gene names
  n <- c(olink_map$Assay[match(vars, olink_map$OlinkID)], "acr_u","map", "gfr_raw_plasma", "gfr_bsa_plasma")
  n[duplicated(n)] <- paste0(n[duplicated(n)], "(2)")
  names(plasma_df) <- n
  names(urine_df) <- n
  # Plasma correlations
...
scRNA_corr <- function(seurat_object = so, vars) {
  # Get Entrez Gene IDs
  entrez <- as.list(analytes$EntrezGeneSymbol[match(vars, analytes$AptName)])
  names(entrez) = vars
  entrez <- entrez[entrez %in% rownames(seurat_object)]
  ...
  # Correlations
  corr_tables <- lapply(names(max), function(n) {
    ...
    avg_exp = t(avg_exp[rownames(avg_exp) ==n,])
    prot= names(entrez[which(entrez==n)])
  })
  # Combine rows and print
  de_table <- data.frame(do.call(rbind, de_tables))
  de_table <- de_table[order(de_table$p_val), ]
...
volcano <- function(data, lab = "Target", xcol = "estimate", ycol = "p.value", top = 3,
                    ...
                    xlabel = "HR", pCutoff = 0.05, overlaps = 10, log_t = T) {
...
```{r message = FALSE}
ids = unique(sub("_BL|_12M","",c(olink_plasma$record_id,olink_urine$record_id,
                                 soma$record_id, so@meta.data[["michigan_id"]])))
df %>% filter(record_id %in% ids) %>%
  ...
  select(group,age,sex,race_ethnicity_condensed,diabetes_duration,hba1c,bmi,acr_u,albuminuria_cat,
...
```{r}
t = AverageExpression(so,group.by = c("ident","michigan_id"))
```
...
fig1
ggsave("/home/yejichoi/UCD/Petter Bjornstad/Proteomics and DKD/Figures/Figure_1_1600x900.jpeg",
       units = "px",
...
fig2 <- fig2 + plot_layout(guides = "collect") & theme(legend.position = "none")
ggsave("/home/yejichoi/UCD/Petter Bjornstad/Proteomics and DKD/Figures/Figure_2_1600x900.jpeg",
       units = "px",
...
ggsave("/home/yejichoi/UCD/Petter Bjornstad/Proteomics and DKD/Figures/Figure_3_1600x900.jpeg",
       units = "px",
...
ggsave("/home/yejichoi/UCD/Petter Bjornstad/Proteomics and DKD/Figures/Figure_S1_1600x900.jpeg",
       units = "px",
