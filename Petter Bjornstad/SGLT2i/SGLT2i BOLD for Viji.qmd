...
kidney_vars = c("erpf_bsa_plasma","erpf_bsa_plasma_urine","erpf_raw_plasma",
                "erpf_raw_plasma_urine","ff","glomerular_pressure")
df = df %>% 
...
```{r figure 3}
#| label: fig-3
#| fig-cap: Linear relationships with kidney measures
pm = ggpairs(df[, c(bold_vars, kidney_vars)]) +
  theme_bw() +
  theme(
