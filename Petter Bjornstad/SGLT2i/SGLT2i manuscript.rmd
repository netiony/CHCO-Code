...
```{r}
bold_vars = c("bold_r_bl_cortex", "bold_r_bl_medulla",
  "bold_r_bl_kidney", "bold_r_pf_cortex", "bold_r_pf_medulla",
  "bold_r_pf_kidney", "bold_l_bl_cortex", "bold_l_bl_medulla", "bold_l_bl_kidney",
  "bold_l_pf_cortex", "bold_l_pf_medulla", "bold_l_pf_kidney")
skimr::skim(t1data[,bold_vars])
```

### All groups

```{r results='asis'}
f = as.formula(paste0("three_groups~",paste0(bold_vars,collapse = "+")))
t2 <- tableby(formula = f,data = t1data, control = list(digits = 2))
...
```{r results='asis'}
t2 <- tableby(formula = f,data = t1data_nocontrol, control = list(digits = 2))
summary(t2,pfootnote = T)
```
...
```{r results='asis'}
f = as.formula(paste0("Group~",paste0(bold_vars,collapse = "+")))
t2 <- tableby(formula = f,data = t1data, control = list(digits = 2))
summary(t2,pfootnote = T)
```
