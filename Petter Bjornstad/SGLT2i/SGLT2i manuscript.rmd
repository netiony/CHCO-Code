...
vars <- c("Age","sex","clamp_bmi","dxa_body_fat","cholesterol","ldl","hdl","triglycerides","clamp_sbp","clamp_dbp","clamp_map","clamp_acr_baseline",
          ...
          "Insulin","TZD","GLPYES","Fractional.Interstitial.Area","Glomerular.Tuft.Area..um.2.","Glomerular.Volume...Weibel..10.6.um.3.",
          "Glomerular.Volume...Wiggins..10.6.um.3.","Glomerular.Volume...Consensus..10.6.um.3.","Mesangial.Matrix.Area..um.2.",
          "Mesangial.Index....","Mesangial.Volume...Weibel..10.6.um.3.","Mesangial.Volume...Wiggins..10.6.um.3.",
          "Mesangial.Volume...Consensus..10.6.um.3.","Glomerular.Nuclear.Count")
...
t1 <- print(t1,nonnormal = c("Age","clamp_bmi","triglycerides","clamp_acr_baseline","hba1c","gfr","serum_creatinine","GIR","labs_bun",
                             "Fractional.Interstitial.Area","Glomerular.Tuft.Area..um.2.","Glomerular.Volume...Weibel..10.6.um.3.",
                             "Glomerular.Volume...Wiggins..10.6.um.3.","Glomerular.Volume...Consensus..10.6.um.3.","Mesangial.Matrix.Area..um.2.",
                             "Mesangial.Index....","Mesangial.Volume...Weibel..10.6.um.3.","Mesangial.Volume...Wiggins..10.6.um.3.",
                             "Mesangial.Volume...Consensus..10.6.um.3.","Glomerular.Nuclear.Count"),
