...
if(Sys.info()["sysname"] == "Windows"){
  home_dir = "E:/Petter Bjornstad/T2D scRNA SGLT2i"
} else if (Sys.info()["sysname"] == "Linux"){
  home_dir = "~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/T2D scRNA SGLT2i"
} else if (Sys.info()["sysname"] == "Darwin"){
  home_dir = "/Volumes/som/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/T2D scRNA SGLT2i"
}
...
exact <- c("screen_elevated_albuminuria","clamp_elevated_albuminuria","Metformin","Insulin","TZD","GLPYES","ACEi","ARB")
...
t1 <- tableby(three_groups ~ Age + sex + clamp_bmi + dxa_body_fat + cholesterol +
  ldl + hdl + triglycerides + clamp_sbp + clamp_dbp + kwt(clamp_acr_baseline,"Nmiss","median","q1q3") +
