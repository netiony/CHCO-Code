...
# List variables
bold_vars = c("age","gender", "eGFR_fas_cr", "gfr","gfr_bsa","bmi",
...
bold_data = bold_data %>% 
  ...
  select(subject_id,study,visit,group,sglt2_inhibitors,all_of(bold_vars))
# Summarize
...
```{r results='asis'}
f = as.formula(paste0("sglt2_inhibitors~",paste0(bold_vars,collapse = "+")))
