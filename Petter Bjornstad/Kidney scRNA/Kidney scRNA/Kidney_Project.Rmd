...
so_kpmp_sc <- qc_function(so=so_kpmp_sc,cut_low=200,cut_high=5000,mt_pct=0.5,var_pct=0.75) 

#Visualize data
umap <- umap_vis(so=so_kpmp_sc,cell_type="KPMP_celltype",group_variable="group") 
print(umap)
...
for (celltype in so_kpmp_sc$KPMP_celltype) {
  so_celltype <- subset(so_kpmp_sc,KPMP_celltype %in% celltype)
