...
so_kidney_sc@meta.data <- so_kidney_sc@meta.data %>% 
  ...
  mutate(hc=ifelse(group=="Lean Control", "Yes","No"))
...
so_kidney_sc@meta.data <- so_kidney_sc@meta.data %>% 
  mutate(group2 = case_when(both == "Yes" ~ "both",
                            ...
                            neither == "Yes" ~ "neither",
                            hc=="Yes" ~ "healthy_control"))

so_kidney_sc@meta.data$group2 <- factor(so_kidney_sc@meta.data$group2, levels = c("healthy_control","neither", "both", "exclusive_sglt2", "exclusive_glp1"))
