...
#Save 
write.csv(harm_data3,fs::path(dir.dat,"Kidney Project","Data","harmonized_data_kidney_sc_all_metadata.csv"))
harm_data_check <- read.csv(fs::path(dir.dat,"Kidney Project","Data","harmonized_data_kidney_sc_all_metadata.csv"))
