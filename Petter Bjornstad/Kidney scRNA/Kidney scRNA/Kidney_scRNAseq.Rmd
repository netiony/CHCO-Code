...
so_subgroup <- subset(so_diab,mfm_1=="Yes" | mfm_1=="No")
so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
all_genes <- rownames(so_subgroup)result <- degs_fxn(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30)
print (result)
