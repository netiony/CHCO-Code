...
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Hemodynamics")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), hemo1))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Hemodynamics")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), hemo1))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Hemodynamics")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), hemo1))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Hemodynamics")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), hemo1))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Hemodynamics")
...
#Run
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl,exposure="medication",additional_group="Typ_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Inflammation1")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Inflammation1")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Inflammation1")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Inflammation1")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Inflammation1")
#############
...
#Run
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=infl2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="infl2ammation2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="infl2ammation2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="infl2ammation2")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="infl2ammation2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), infl2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=infl2,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="infl2ammation2")
##############
...
#Run
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=ros,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species")
################
...
#Run
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=ros2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species2")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species2")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), ros2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=ros2,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Reactive_Oxygen_Species2")
########
...
#Run
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=injury,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers")
...
#Run
degs_fxn4(so=so_subgroup2,cell=NULL,gene_set=injury2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers22")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers22")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers22")

#Glp1 vs. sglt2
so_subgroup <- subset(so_diab,medication=="glp1" | medication=="sglt2")
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury2,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers22")
...
so_subgroup$medication <- factor(so_subgroup$medication)
so_subgroup2 <- subset(so_subgroup, features = intersect(rownames(so_subgroup), injury2))
degs_fxn4(so=so_subgroup,cell=NULL,gene_set=injury2,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT",pathway="Injury_Markers22")
```
