...
pseudobulked_data <- AggregateExpression(so_kidney_sc, group.by = c("celltype", "kit_id"))
...
all_genes <- rownames(so_pb_total) #9276 genes for 81 people

#PT
so_pb <- subset(so_pb_total,celltype=="PT")

# #Disease Groups
# #1. T2D vs. OB
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes" | group=="Obese Control")
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Obese_Control",enrichment="No",top_gsea = 30,cellname="PT")
# # ipa <- read_delim()
# 
# #2. T2D vs. T1D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes" | group=="Type 1 Diabetes")
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Type_1_Diabetes",enrichment="No",top_gsea = 30,cellname="PT")
# 
# 
# #3. T2D vs. LC
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes" | group=="Lean Control")
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Lean_Control",enrichment="No",top_gsea = 30,cellname="PT")
# 
# 
# #4. T2D/OB vs. LC
# so_subgroup <- subset(so_pb,group2=="T2D + OB" | group2=="Lean Control")
# so_subgroup$DiseaseGroup <- so_subgroup$group2
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="T2D + OB",ref_group="Lean Control",enrichment="Yes",top_gsea = 30,cellname="PT")
# 
# #5. T2D/OB vs. T1D
# so_subgroup <- subset(so_pb,group2=="T2D + OB" | group2=="Type 1 Diabetes")
# so_subgroup$DiseaseGroup <- so_subgroup$group2
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="T2D + OB",ref_group="Type 1 Diabetes",enrichment="Yes",top_gsea = 30,cellname="PT")
# 
# #1. Albuminuria (Y/N) - UACR >= 30 mg/g
# so_pb$albuminuria_30 <- ifelse(so_pb$acr_u>=30,"Above_30","Below_30")
# #  a. T2D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_30 <- factor(so_subgroup$albuminuria_30)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_30",additional_group="Type_2_Diabetes",exp_group="Above_30",ref_group="Below_30",enrichment="No",top_gsea = 30,cellname="PT")
# 
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_30 <- factor(so_subgroup$albuminuria_30)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_30",additional_group="T2D + OB",exp_group="Above_30",ref_group="Below_30",enrichment="No",top_gsea = 30,cellname="PT")
# 
# 
# #2. UACR >= 100mg/g
# so_pb$albuminuria_100 <- ifelse(so_pb$acr_u>=100,"Above_100","Below_100")
# #  a. T2D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_100 <- factor(so_subgroup$albuminuria_100)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_100",additional_group="Type_2_Diabetes",exp_group="Above_100",ref_group="Below_100",enrichment="No",top_gsea = 30,cellname="PT")
# 
# #"PT_lowQuality" has fewer than 3 cells in group 1, remove from analyses
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_100 <- factor(so_subgroup$albuminuria_100)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_100",additional_group="T2D + OB",exp_group="Above_100",ref_group="Below_100",enrichment="No",top_gsea = 30,cellname="PT")
# 
# #3. UACR >= 300mg/g
# so_pb$albuminuria_300 <- ifelse(so_pb$acr_u>=300,"Above_300","Below_300")
# #  a. T2D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_300 <- factor(so_subgroup$albuminuria_300)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_300",additional_group="Type_2_Diabetes",exp_group="Above_300",ref_group="Below_300",enrichment="No",top_gsea = 30,cellname="PT")
# 
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_300 <- factor(so_subgroup$albuminuria_300)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_300",additional_group="T2D + OB",exp_group="Above_300",ref_group="Below_300",enrichment="No",top_gsea = 30,cellname="PT")
...
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT")

#Combo vs. GLP1
so_subgroup <- subset(so_diab,medication=="glp1_sglt2" | medication=="glp1")
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="PT")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="PT")
# 
# ##RAASI - Type_2_Diabetes
# # #Filter out NAs for ace inhibitors
# so_diab <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup <- subset(so_diab,raasi_1=="Yes" | raasi_1=="No")
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# print (result)
# 
# ##RAASI - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# print (result)
# 
...
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# print (result)
# #
# #Metformin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# print (result)
# 
...
# all_genes <- rownames(so_subgroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# 
# #
# #Insulin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$insulin_1 <- factor(so_subgroup$insulin_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="PT")
# print (result)

#TAL
so_pb <- subset(so_pb_total,celltype=="TAL")
...
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Obese_Control",enrichment="No",top_gsea = 30,cellname="TAL")
# # ipa <- read_delim()
# 
# #2. T2D vs. T1D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes" | group=="Type 1 Diabetes")
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Type_1_Diabetes",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# 
# #3. T2D vs. LC
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes" | group=="Lean Control")
# so_subgroup$DiseaseGroup <- so_subgroup$group
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="Type_2_Diabetes",ref_group="Lean_Control",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# 
# #4. T2D/OB vs. LC
# so_subgroup <- subset(so_pb,group2=="T2D + OB" | group2=="Lean Control")
# so_subgroup$DiseaseGroup <- so_subgroup$group2
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="T2D + OB",ref_group="Lean Control",enrichment="Yes",top_gsea = 30,cellname="TAL")
# 
# #5. T2D/OB vs. T1D
# so_subgroup <- subset(so_pb,group2=="T2D + OB" | group2=="Type 1 Diabetes")
# so_subgroup$DiseaseGroup <- so_subgroup$group2
# so_subgroup$DiseaseGroup <- factor(so_subgroup$DiseaseGroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,additional_group = NULL,exposure="DiseaseGroup",exp_group="T2D + OB",ref_group="Type 1 Diabetes",enrichment="Yes",top_gsea = 30,cellname="TAL")
# 
# #1. Albuminuria (Y/N) - UACR >= 30 mg/g
# so_pb$albuminuria_30 <- ifelse(so_pb$acr_u>=30,"Above_30","Below_30")
# #  a. T2D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_30 <- factor(so_subgroup$albuminuria_30)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_30",additional_group="Type_2_Diabetes",exp_group="Above_30",ref_group="Below_30",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_30 <- factor(so_subgroup$albuminuria_30)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_30",additional_group="T2D + OB",exp_group="Above_30",ref_group="Below_30",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# 
# #2. UACR >= 100mg/g
# so_pb$albuminuria_100 <- ifelse(so_pb$acr_u>=100,"Above_100","Below_100")
...
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_100 <- factor(so_subgroup$albuminuria_100)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_100",additional_group="Type_2_Diabetes",exp_group="Above_100",ref_group="Below_100",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# #"PT_lowQuality" has fewer than 3 cells in group 1, remove from analyses
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_100 <- factor(so_subgroup$albuminuria_100)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_100",additional_group="T2D + OB",exp_group="Above_100",ref_group="Below_100",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# #3. UACR >= 300mg/g
# so_pb$albuminuria_300 <- ifelse(so_pb$acr_u>=300,"Above_300","Below_300")
# #  a. T2D
# so_subgroup <- subset(so_pb,group=="Type 2 Diabetes")
# so_subgroup$albuminuria_300 <- factor(so_subgroup$albuminuria_300)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_300",additional_group="Type_2_Diabetes",exp_group="Above_300",ref_group="Below_300",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# #  b. T2D/OB
# so_subgroup <- subset(so_pb,group2=="T2D + OB")
# so_subgroup$albuminuria_300 <- factor(so_subgroup$albuminuria_300)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="albuminuria_300",additional_group="T2D + OB",exp_group="Above_300",ref_group="Below_300",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="TAL")

#Combo vs. GLP1
so_subgroup <- subset(so_diab,medication=="glp1_sglt2" | medication=="glp1")
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="TAL")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# ##RAASI - Type_2_Diabetes
# # #Filter out NAs for ace inhibitors
# so_diab <- subset(so_pb,group=="Type 2 Diabetes")
...
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")
# print (result)
# 
# ##RAASI - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")
# print (result)
# 
# #Metformin - type 2s only
# #Filter out NAs for ace inhibitors
...
# so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")
# print (result)
# #
# #Metformin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")
# print (result)
# 
# #Insulin - type 2s only
# #Filter out NAs for ace inhibitors
...
# so_subgroup$insulin_1 <- factor(so_subgroup$insulin_1)
# all_genes <- rownames(so_subgroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")
# 
# #
# #Insulin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$insulin_1 <- factor(so_subgroup$insulin_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="TAL")



#EC
so_pb <- subset(so_pb_total,celltype=="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="Type_2_Diabetes",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="EC")

#Combo vs. GLP1
so_subgroup <- subset(so_diab,medication=="glp1_sglt2" | medication=="glp1")
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1_sglt2",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="glp1",ref_group="sglt2",enrichment="No",top_gsea = 30,cellname="EC")
...
so_subgroup$medication <- factor(so_subgroup$medication)
all_genes <- rownames(so_subgroup)
degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="medication",additional_group="T2D + OB",exp_group="sglt2",ref_group="no_med",enrichment="No",top_gsea = 30,cellname="EC")
# 
# ##RAASI - Type_2_Diabetes
# # #Filter out NAs for ace inhibitors
# so_diab <- subset(so_pb,group=="Type 2 Diabetes")
...
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# print (result)
# 
# ##RAASI - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$raasi_1 <- factor(so_subgroup$raasi_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="raasi_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# print (result)
# 
# #Metformin - type 2s only
# #Filter out NAs for ace inhibitors
...
# so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# print (result)
# #
# #Metformin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$mfm_1 <- factor(so_subgroup$mfm_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="mfm_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# print (result)
# 
# #Insulin - type 2s only
# #Filter out NAs for ace inhibitors
...
# so_subgroup$insulin_1 <- factor(so_subgroup$insulin_1)
# all_genes <- rownames(so_subgroup)
# degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="Type_2_Diabetes",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# 
# #
# #Insulin - T2D + OB
# # #Filter out NAs for ace inhibitors
...
# so_subgroup$insulin_1 <- factor(so_subgroup$insulin_1)
# all_genes <- rownames(so_subgroup)
# result <- degs_fxn2(so=so_subgroup,cell=NULL,gene_set=all_genes,exposure="insulin_1",additional_group="T2D + OB",exp_group="Yes",ref_group="No",enrichment="No",top_gsea = 30,cellname="EC")
# print (result)
```
...
#Run
degs_fxn2(so=so_subgroup2,cell=NULL,gene_set=hemo1,exposure="medication",additional_group="Type_2_Diabetes",exp_group="glp1_sglt2",ref_group="glp1",enrichment="No",top_gsea = 30,cellname="PT")
