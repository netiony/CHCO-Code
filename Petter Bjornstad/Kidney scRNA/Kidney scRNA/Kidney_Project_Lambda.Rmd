...
genes <- gene_hold  # Assuming gene_hold is your full list of genes
...
write.csv(final_results, file = fs::path(dir.results,"PT_S1_S2_T2D_Medication_Full_results_all_genes_04_07_2025.csv"))

# Stop the parallel cluster
stopCluster(cl)
Nonconvergence_Rate <- paste0(round((1-length(unique(final_results$Gene))/length(gene_hold))*100,3),"%")
...
# Save the final combined results
write.csv(final_results, file = fs::path(dir.results,"PT_S3_T2D_Medication_Full_results_all_genes_04_07_2025.csv"))
...
gene_list_total <- gene_hold[3001:4000]
# Define your function for processing a gene
process_gene <- function(gene) {
    # Define the formula for the linear mixed-effects model
    formula <- as.formula(paste0(gene, " ~ medication + age + sex + bmi + (1 | kit_id)"))
...
# Save the final combined results
write.csv(final_results, file = fs::path(dir.results,"aPT_T2D_Medication_Full_results_all_genes_04_07_2025.csv"))
