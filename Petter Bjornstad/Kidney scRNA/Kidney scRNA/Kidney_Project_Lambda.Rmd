...
write.csv(full_results,fs::path(dir.results,"EC-AEA_No_Med_T2D_LC_adj_cov.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_EC_AEA_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/PT-S1/S2_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"PT-S1/S2_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","PT-S1/S2_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_PT-S1/S2_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
#### iii. PT-S3
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/PT-S3_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"PT-S3_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","PT-S3_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_PT-S3_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
#### iv. aPT
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/aPT_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"aPT_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","aPT_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_aPT_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
## b. EC Cells
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/EC_Pseudobulk_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"EC_Pseudobulk_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","EC_Pseudobulk_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot <- ggplot(full_results, aes(x = Beta, y = PValue10, color = color)) +
  ...
  labs(
    title = "Type 2 Diabetes vs. Lean Controls (All No Medication)",
    subtitle = "EC Pseudobulk, Adjusted for Age, Sex & BMI",
    x = "Log2FC",
    y = "-log10(P-Value)",
    color = "FC Direction Direction",
    caption = paste0("FDR < 0.05, Genes = ",Genes,", Cells = ",Cells)
...
volcano_plot
pdf(fs::path(dir.results,"Plot_EC_Pseudobulk_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
#### ii. EC-AVR
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/EC_AVR_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"EC_AVR_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","EC_AVR_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_EC_AVR_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/EC_GC_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"EC_GC_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","EC_GC_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_EC_GC_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
#### iv. EC-PTC
...
write.csv(full_results,fs::path(dir.results,"EC_PTC_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","EC_AEA_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_EC_PTC_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/TAL_Pseudobulk_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"TAL_Pseudobulk_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","TAL_Pseudobulk_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_TAL_Pseudobulk_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
### i. C-TAL-1 
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/C_TAL_1_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"C_TAL_1_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","C_TAL_1_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_C_TAL_1_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
### ii. C-TAL-2
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/C_TAL_2_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"C_TAL_2_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","C_TAL_2_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_C_TAL_2_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
### iii. dTAL
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/dTAL_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"dTAL_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","dTAL_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_dTAL_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
### iv. aTAL
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/aTAL_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"aTAL_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","aTAL_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_aTAL_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
## d. Podocytes
...
# temp_file <- tempfile(fileext = ".csv") # need to create a temporary file
# write.csv(full_results, row.names = FALSE) # save the temp file locally (will delete after R session)
# s3$upload_file(temp_file, bucket, "Kidney transcriptomics/Results/POD_No_Med_T2D_LC_adj_cov.csv")
# write.csv(full_results,"test.csv")

write.csv(full_results,fs::path(dir.results,"POD_No_Med_T2D_LC_adj_cov.csv"))
# write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","POD_No_Med_T2D_LC_adj_cov.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
volcano_plot
pdf(fs::path(dir.results,"Plot_POD_T2D_LC_NoMed.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
```
