...
harm_meta_data <- read.csv(fs::path(dir.dat,"Kidney Project","Data","harmonized_data_kidney_sc_all_metadata2.csv"))
#Get coenrolled IDs
...
so_kidney_sc2 <- subset(so_kidney_sc, features = setdiff(rownames(so_kidney_sc@assays$RNA@counts), mito_genes))
...
dim(so_kidney_sc@assays$RNA@counts) #9289 186125
dim(so_kidney_sc@assays$RNA@data) #9289 186125
...
dim(so_kpmp_sc@assays$RNA@layers$counts) #5714 186125
...
# Check dimensions after filtering
dim(so_kpmp_sc@assays$RNA@counts) #9289 81882
dim(so_kpmp_sc@assays$RNA)#9289 81882
dim(so_kpmp_sc)#9289 81882

# Optionally, you can also check how many MT genes remain in the filtered dataset
sum(grepl("^MT", rownames(so_kpmp_sc@assays$RNA@counts)))
...
#Check normalized slot
dim(so_kpmp_sc@assays$RNA@data) #5714 186125
sum(grepl("^MT", rownames(so_kpmp_sc@assays$RNA@data))) #70
ncol(so_kpmp_sc) #186125 cells
nrow(so_kpmp_sc) #5714 genes
