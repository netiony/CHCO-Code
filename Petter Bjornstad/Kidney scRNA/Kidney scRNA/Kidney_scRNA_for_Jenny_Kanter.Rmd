...
#SGLT2is
#HC
de.markers(so_HC, NULL, "sglt2i_ever", id1 = "No", id2 = "Yes", NULL, "_top")
m_top <- m_top %>% head(2000)
#OB
de.markers(so_OB, NULL, "sglt2i_ever", id1 = "No", id2 = "Yes", NULL, "_top")
m_top <- m_top %>% head(2000)
#T1
de.markers(so_T1, NULL, "sglt2i_ever", id1 = "No", id2 = "Yes", NULL, "_top")
m_top <- m_top %>% head(2000)
#T2
...
#SGLT2is
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MON", "")
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MAC", "")
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-GC", "")
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-LYM", "")
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-AEA", "")
de.markers(so_HC, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-PTC", "")
```
...
#SGLT2is
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MON", "")
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MAC", "")
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-GC", "")
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-LYM", "")
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-AEA", "")
de.markers(so_OB, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-PTC", "")
```
...
#SGLT2is
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MON", "")
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "MAC", "")
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-GC", "")
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-LYM", "")
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-AEA", "")
de.markers(so_T1, genes, "sglt2i_ever", id2 = "No", id1 = "Yes", "EC-PTC", "")
```
