...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_PT_cells_diabetes_unadjusted_2000_hvg_reml.csv"))
...
# print(volcano_plot)
# dev.off()
png(fs::path(dir.results, "Plot_NEBULA_PT_Diabetes_unadjusted_2000_hvg.png"), 
...
writereml.csv(full_results,fs::path(dir.results,"Targeted_PT_Cells_T2D_LC_full_cov_setreml.csv"))
full_results <- full_results %>%
  mutate(
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_aPT_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_PT_S1_S2_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_PT_S3_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_TAL_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_C_TAL_1_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_C_TAL_2_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_dTAL_cells_diabetes_unadjusted_2000_hvgreml.csv"))
...
writereml.csv(full_results,fs::path(dir.results,"NEBULA_aTAL_cells_diabetes_unadjusted_2000_hvgreml.csv"))
