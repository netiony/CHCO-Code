...
Notes from meeting w/ Carson on 7/27/23:

-   Try the absolute mass vars for DEXA
-   Add trunk mass
-   Adjust for BMI in hba1c model
-   Try different groups or subsetting groups
...
```{r, include=F}
table_one <- tableby(group ~ study + sex + age + race + ethnicity + kwt(hba1c, "Nmiss", "median", "q1q3", "range") + kwt(bmi, "Nmiss", "median", "q1q3", "range") + dexa_body_fat + dexa_fat_kg + dexa_lean_mass + dexa_bone_mineral_density + map, data = dat)
```
