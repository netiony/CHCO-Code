...
write.csv(results,fs::path(dir.results,"Brain_Biomarkers_Log_Proteomics_Log_Metabolomics_Adj_Results.csv"))
sig <- results %>% 
  filter(fdr<0.05)
write.csv(results,fs::path(dir.results,"Brain_Biomarkers_Log_Proteomics_Log_Metabolomics_Adj_Sig_Results.csv"))
...
# Create the heatmap
ggplot(df, aes(x = Feature, y = Biomarker, fill = Beta)) +
