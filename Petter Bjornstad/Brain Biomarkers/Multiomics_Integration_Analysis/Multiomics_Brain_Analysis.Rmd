...
#Filter to CROCODILE (HC) and PENGUINE (CASES) & procedure of interest
dat_harm <- dat_harm %>% 
  filter(study=="CROCODILE" | study=="PENGUINE") %>% 
  filter(procedure=="neuro_markers" | procedure == "metabolomics_blood")
