...
write.csv(res_for_enrichment, file = "/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/limma_intercept_only_results_for_enrichment.csv", row.names = F)
# Table
```
...
openxlsx::write.xlsx(means_res, file = "/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/Teen LABS emmeans.xlsx")
```
...
openxlsx::write.xlsx(lmm_res, file = "/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/Teen LABS change_from_m1.xlsx", sheetName=names)
```
