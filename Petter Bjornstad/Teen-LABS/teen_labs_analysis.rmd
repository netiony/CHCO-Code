...
write.csv(res_for_enrichment, file = "/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/limma_intercept_only_results.csv", row.names = F)
# Table
```
...
openxlsx::write.xlsx(means_res, file = "/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/emmeans.xlsx")
```
