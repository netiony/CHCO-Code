...
write.csv(res_for_enrichment, file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/limma_intercept_only_results_for_enrichment.csv", row.names = F)
# Table
```
...
openxlsx::write.xlsx(means_res, file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/Teen LABS emmeans.xlsx")
```
...
openxlsx::write.xlsx(lmm_res, file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/Teen LABS change_from_m1.xlsx", sheetName=names)
```

```{r}
# write files for IPA
openxlsx::write.xlsx(lmm_res[[1]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_6mo_IPA.xlsx")
openxlsx::write.xlsx(lmm_res[[2]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_year1_IPA.xlsx")
openxlsx::write.xlsx(lmm_res[[3]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_year2_IPA.xlsx")
openxlsx::write.xlsx(lmm_res[[4]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_year3_IPA.xlsx")
openxlsx::write.xlsx(lmm_res[[5]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_year4_IPA.xlsx")
openxlsx::write.xlsx(lmm_res[[6]], file = "/Volumes/PEDS/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/Results/IPA/Teen LABS change_from_m1_year5_IPA.xlsx")
```