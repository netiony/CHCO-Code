...
if(Sys.info()["sysname"] == "Windows"){
  home_dir = "E:/Petter Bjornstad/Teen Labs"
} else if (Sys.info()["sysname"] == "Linux"){
  home_dir = "~/UCD/PEDS/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/Teen Labs/"
...
# CODE BELOW HAS NOT BEEN UPDATED FROM TODAY DATA
