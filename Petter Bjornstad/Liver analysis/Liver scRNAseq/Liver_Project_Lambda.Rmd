...
s3$download_file(bucket, "Liver transcriptomics/Single nucleus RNA seq/liver_biopsy_metadata_PN.csv", temp_file)
meta_liver_raw <- readRDS(temp_file)
...
Nuclei <- ncol(so_celltype) #4674 nuclei
# Extract the gene expression data for all genes
gene_expression <- as.data.frame(GetAssayData(so_celltype, layer = "data"))
