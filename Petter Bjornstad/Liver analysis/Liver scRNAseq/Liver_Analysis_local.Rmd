...
table1(~ tg + creatinine + sglt2_exclusive + glp1_exclusive + either + both | diagnosis_of_diabetes, data=dat)

table1(~ age + nih_sex + nih_race + nih_ethnicity + diagnosis_of_MASLD + bmi + sbp + dbp | diagnosis_of_diabetes, data=dat)
