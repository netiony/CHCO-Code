...
so_sens_PT@meta.data$group1 <- ifelse(so_sens_PT@meta.data$group=="Type 2 Diabetes","Yes","No")
...
###i. Quality Control & Visualizations
```{r}
so_sens <- so_sens_TAL1
# Check the metadata for NA values
table(is.na(so_sens_TAL1$acr_u))
so_sens@meta.data$group
