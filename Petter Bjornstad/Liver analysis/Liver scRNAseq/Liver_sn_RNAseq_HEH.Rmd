...
# Define the model with the outcome variable
outcomes <- c("ast","alt","fibrosis_stage","steatosis_grade","lobular_inflammation_grade")
# Convert 'lobular_inflammation_grade' to a factor in the Seurat object metadata
so_sens@meta.data$lobular_inflammation_grade <- factor(so_sens@meta.data$lobular_inflammation_grade)
