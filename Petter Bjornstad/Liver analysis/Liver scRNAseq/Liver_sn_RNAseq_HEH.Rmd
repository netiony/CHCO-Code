...
write.csv(m,fs::path("SeneDifferential_Expression_Diabetes.csv"))
m_top <- m
...
p <- EnhancedVolcano(m_top,
                     ...
                     x = 'avg_log2FC',
                     y = 'p_val_adj',
                     title = paste0("Differentially Expressed Senesence Genes by Diabetes (Pseudobulk)"),
                     subtitle = paste0("Positive Log2 FC = Greater Expression in T2D vs. OC\n",
...
# Save to CSV
write.csv(eaRes, "GSEA_Senesence_Diabetes.csv", row.names = FALSE)
```

#8. IPA Pathway Analysis 
