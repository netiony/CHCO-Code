...
#AST
for (cell in all_cell_types){
  mast_sens_fxn(so=so_diab,cell=cell,exposure="ast",covariate=NULL,gene_set=gene_set,exp_group=NULL,ref_group=NULL)
} 

#ALT
for (cell in all_cell_types){
  mast_sens_fxn(so=so_diab,cell=cell,exposure="alt",covariate=NULL,gene_set=gene_set,exp_group=NULL,ref_group=NULL)
}
...
gene_set <- rownames(so_subset)
for (cell in all_cell_types){
  mast_sens_fxn(so=so_subset,cell=cell,covariate="alt",exposure="Medication",gene_set=gene_set,exp_group="glp1_exclusive",ref_group="neither")
}
...
gene_set <- rownames(so_subset)
for (cell in all_cell_types){
  mast_sens_fxn(so=so_subset,cell=cell,covariate="alt",exposure="Medication",gene_set=gene_set,exp_group="both",ref_group="neither")
} 
