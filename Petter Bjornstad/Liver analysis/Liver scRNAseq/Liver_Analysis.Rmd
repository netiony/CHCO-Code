...
expr_data <- as.data.frame(t(so_liver_sn@assays$RNA@data))

# Add participant IDs
expr_data$kit_id <- so_liver_sn@meta.data$kit_id

# Add group information if available
expr_data$group <- seurat_obj@meta.data$group
...
for (oro in oro_vars){
mast_fxn(so=so_sens_all,cell=NULL,exposure=oro,gene_set=genes,exp_group=NULL,ref_group=NULL)
}
