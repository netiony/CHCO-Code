...
dir.results <- c(fs::path(dir.dat,"Liver project/NEBULA Results"))
...
pred = model.matrix(~steatosis_cat, data = meta_hvg)
...
# data_g_hvg = group_cell(count = counts_hvg, id = id, pred = pred_gene_hvg)
offset_hvg = Matrix::colSums(counts_hvg) 
...
=======
    result <- nebula(count = count_gene, id = meta_gene$Kit_Lot, pred = pred_gene, ncore = 1,reml=T,output_re = T,covariance=T,offset = offset_hvg)
>>>>>>> d9e66692ea275f30163224ff6a2b9fd2c0095686
...
#Lambda
write.csv(full_results,"/home/hailey/Documents/NEBULA Liver Results/NEBULA_Hepatocytes_Steatosis_unadjusted_2000_hvg_reml.csv")
...
#Lambda
png("/home/hailey/Documents/NEBULA Liver Results/Plot_NEBULA_Hepatocytes_Steatosis_unadjusted_2000_hvg_reml_offset.png", 
    width = 3000, height = 2100, res = 300)
print(volcano_plot)
dev.off()
...
#Mac Studio
# write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_1_Steatosis_unadjusted_2000_hvg_reml_offset.csv"))
#Lambda
write.csv(full_results,"/home/hailey/Documents/NEBULA Liver Results/NEBULA_Hep_1_Steatosis_unadjusted_2000_hvg_reml_offset.csv")
...
volcano_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = PValue10, color = color)) +
  ...
  labs(
    title = "High Steatosis (2+3) vs. Low Steatosis (0+1)",
    subtitle = "Hep-1, Unadjusted (REML, Offset)",
    x = "logFC",
    y = "-log10(P-Value)",
