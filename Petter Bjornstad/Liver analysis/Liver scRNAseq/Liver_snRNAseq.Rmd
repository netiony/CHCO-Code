...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 KEGG (REML)", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hepatocytes_top30_kegg_pathways_unadjusted_reml.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 REACTOME (REML)", xlimit = 5)

ggsave(fs::path(dir.results,"Hepatocytes_top30_reactome_pathways_unadjusted_reml.jpeg"),
       width = 13, height = 10, scale = 1)
##### GO
plot_fgsea(go_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 GO (REML)", xlimit = 8)
