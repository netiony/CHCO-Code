...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hepatocytes_Steatosis_unadjusted_2000_hvg.csv"))
...
volcano_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = PValue10, color = color)) +
  ...
  labs(
    ...
    subtitle = "Hepatocytes, Unadjusted",
    x = "FC",
    y = "-log10(P-Value)",
...
pdf(fs::path(dir.results,"Plot_NEBULA_Hepatocytes_Steatosis_unadjusted_2000_hvg.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hepatocytes_Steatosis_unadjusted_2000_hvg.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hepatocytes_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"Hepatocytes_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
##### GO
plot_fgsea(go_res_Hepatocytes, title = "Hepatocytes Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"Hepatocytes_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
### iv. Targeted Genes
```{r}
...
dot_plot
ggsave(fs::path(dir.results, "NEBULA_Targeted_Hepatocytes_Steatosis_Unadjusted.jpeg"), dot_plot, width = 7, height = 6)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_1_Steatosis_unadjusted_2000_hvg.csv"))
...
```{r echo = F}
#Hep-1
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_1_Steatosis_unadjusted_2000_hvg.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_hep1, title = "Hep-1 Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hep1_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_hep1, title = "Hep-1 Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"Hep1_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_hep1, title = "Hep-1 Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"Hep1_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
...
dot_plot <- ggplot(full_results, aes(x = `logFC_steatosis_catHigh Steatosis (2+3)`, y = Gene)) +
  ...
  theme(axis.text.y = element_text(size = 10),
        ...
        text =element_text(size=10)) 
dot_plot
ggsave(fs::path(dir.results, "NEBULA_Targeted_Hep_1_Steatosis_Unadjusted.jpeg"), dot_plot, width = 7, height = 6)
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_2_Steatosis_unadjusted_2000_hvg.csv"))
...
```{r echo = F}
#Hep-2
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_2_Steatosis_unadjusted_2000_hvg.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::select(c("gene","log_fc_steatosis_cat_high_steatosis_2_3","fdr")) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_hep2, title = "Hep-2 Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"hep2_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_hep2, title = "Hep-2 Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"hep2_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_hep2, title = "Hep-2 Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"hep2_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_3_Steatosis_unadjusted_2000_hvg.csv"))
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_3_Steatosis_unadjusted_2000_hvg.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_Hep3, title = "Hep-3 Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hep3_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_Hep3, title = "Hep-3 Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"Hep3_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_Hep3, title = "Hep-3 Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"Hep3_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_4_Steatosis_unadjusted_2000_hvg.csv"))
...
### iii. GSEA
```{r echo = F}
full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_4_Steatosis_unadjusted_2000_hvg.csv")) %>%
  clean_names() %>% 
  dplyr::select(-x) %>% 
  dplyr::rename(Gene=gene,LogFC=log_fc_steatosis_cat_high_steatosis_2_3)
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_Hep4, title = "Hep-4 Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hep4_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_Hep4, title = "Hep-4 Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"Hep4_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_Hep4, title = "Hep-4 Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"Hep4_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
...
write.csv(full_results,fs::path(dir.results,"NEBULA_Hep_5_Steatosis_unadjusted_2000_hvg.csv"))
# full_results <- read.csv(fs::path(dir.results,"NEBULA_Hep_5_Steatosis_unadjusted_2000_hvg.csv")) %>%
#   dplyr::select(-X) %>% 
#   clean_names() %>% 
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_Hep5, title = "Hep-5 Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"Hep5_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_Hep5, title = "Hep-5 Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"Hep5_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_Hep5, title = "Hep-5 Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"Hep5_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
...
write.csv(full_results,fs::path(dir.results,"NEBULA_dHep_Steatosis_unadjusted_2000_hvg.csv"))
# full_results <- read.csv(fs::path(dir.results,"NEBULA_dHep_Steatosis_unadjusted_2000_hvg.csv")) %>%
#   dplyr::select(-X) %>% 
#   clean_names() %>% 
#   dplyr::rename(`logFC_steatosis_catHigh Steatosis (2+3)`=log_fc_steatosis_cat_high_steatosis_2_3,
#                 PValue10=p_value10)
...
##### KEGG Legacy
plot_fgsea(kegg_legacy_res_dHep, title = "dHep Unadjusted Top 30 KEGG", xnudge = 0.03)

ggsave(fs::path(dir.results,"dHep_top30_kegg_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### REACTOME
plot_fgsea(reactome_res_dHep, title = "dHep Unadjusted Top 30 REACTOME", xlimit = 5)

ggsave(fs::path(dir.results,"dHep_top30_reactome_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)

##### GO
plot_fgsea(go_res_dHep, title = "dHep Unadjusted Top 30 GO", xlimit = 8)

ggsave(fs::path(dir.results,"dHep_top30_go_pathways_unadjusted.jpeg"),
       width = 13, height = 10, scale = 1)
```
