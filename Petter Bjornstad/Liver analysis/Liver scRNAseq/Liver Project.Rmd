...
write.csv(full_results,fs::path(dir.results,"Target_Genes_Pseudobulk_All_Celltypes_High_vs_Low_steatosis_04_02.csv"))
...
dot_plot
pdf(fs::path(dir.results,"Plot_Targeted_Genes_Pseudobulk_All_Celltypes_High_vs_Low_steatosis_04_02.pdf"),width=6,height=4)
print(dot_plot)
dev.off()
```
##### Fibrosis
...
write.csv(full_results,fs::path(dir.results,"Target_Genes_Pseudobulk_Hepatocytes_High_vs_Low_steatosis_04_02.csv"))
# full_results <- read.csv(fs::path(dir.results,"Pseudobulk_Hepatocytes_High_vs_Low_steatosis.csv"))
...
dot_plot <- ggplot(full_results, aes(x = Beta, y = Gene)) +
  ...
  theme(axis.text.y = element_text(size = 10),
        ...
        text =element_text(size=10)) 
dot_plot
pdf(fs::path(dir.results,"Plot_Targeted_Genes_Pseudobulk_Hepatocytes_High_vs_Low_steatosis_04_02.pdf"),width=6,height=4)
print(dot_plot)
dev.off()
...
write.csv(full_results,fs::path(dir.results,"Target_Genes_Hep_1_High_vs_Low_steatosis_04_02.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_1_High_vs_Low_steatosis.csv"))
...
dot_plot <- ggplot(full_results, aes(x = Beta, y = Gene)) +
  ...
  theme(axis.text.y = element_text(size = 10),
        ...
        text =element_text(size=10)) 
dot_plot
pdf(fs::path(dir.results,"Plot_Targeted_Genes_Hep_1_High_vs_Low_steatosis_04_02.pdf"),width=6,height=4)
print(dot_plot)
dev.off()
```
##### Fibrosis
...
write.csv(full_results,fs::path(dir.results,"dHep_Oroboros_lipidrcr_state4_c12.csv"))
write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","dHep_Oroboros_lipidrcr_state4_c12.csv"))
# full_results <- read.csv(fs::path(dir.results,"dHep_Steatosis_03_31.csv")) %>%
# dplyr::select(-X)
...
volcano_plot <- ggplot(full_results, aes(x = Beta, y = PValue10, color = color)) +
  ...
  theme_minimal() +  # Minimal theme
  labs(
    title = "Oroboros Lipid le vs. Gene Expression",
    subtitle = "dHep Cells",
    x = "Log2FC",
    y = "-log10(P-Value)",
    color = "FC Direction Direction",
...
pdf(fs::path(dir.results,"Plot_dHep_Oroboros_Lipid_le.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
