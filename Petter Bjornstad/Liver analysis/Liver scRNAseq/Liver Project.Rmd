...
table1(~ carbp_m + carb_adp + carb_g + carb_cytoc + carb_s + carb_omy + carbfccp + 
         carbrcr_pm + carbrcr_pmgs + carbpe_pmgs + carb_ep + carbrcr_state2 + 
         carbrcr_state4_c1 + carbrcr_state4_c12 + carb_le | steatosis_cat, data=dat)

table1(~ lipidpc_m + lipid_adp + 
         lipid_cytoc + lipid_g + lipid_s + lipid_omy + lipidfccp + lipidrcr_pcm + 
         lipidrcr_pcmgs + lipidpe_pcmgs + lipid_ep + lipidrcr_state2 + 
