...
so_liver_sn$orig.ident <- so_liver_sn$Kit_Lot
so_liver_sc$orig.ident <- so_liver_sc$Kit_Lot
...
DimPlot(combined, reduction = "umap", group.by = "orig.ident", raster = F, label = T)
...
FeaturePlot(combined, features = c("Gene1", "Gene2"), min.cutoff = "q10", max.cutoff = "q90")
VlnPlot(combined, features = c("Gene1", "Gene2"), group.by = "seurat_clusters", pt.size = 0)
DotPlot(combined, features = c("Gene1", "Gene2"), group.by = "seurat_clusters")
