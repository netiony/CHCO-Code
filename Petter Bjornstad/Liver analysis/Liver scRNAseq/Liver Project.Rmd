...
#First half of genes
gene_list_total <- gene_list
# gene_list <- gene_list_total[2001:10000]
...
write.csv(full_results,fs::path(dir.results,"Pseudobulk_Hepatocytes_Steatosis_03_19_no_dHep_1_percent.csv"))
write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","Pseudobulk_Hepatocytes_Steatosis_03_19_no_dHep_1_percent.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
...
write.csv(full_results,fs::path(dir.results,"dHep_Steatosis_03_17.csv"))
write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","dHep_Steatosis_03_17.csv"))
...
pdf(fs::path(dir.results,"Plot_dHep_Steatosis_03_17.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
