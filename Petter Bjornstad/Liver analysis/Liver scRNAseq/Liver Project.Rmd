...
write.csv(full_results,fs::path(dir.results,"Hep_5_Steatosis.csv"))
write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","Hep_5_Steatosis.csv"))
...
volcano_plot <- ggplot(full_results, aes(x = Beta, y = PValue10, color = color)) +
  ...
  labs(
    title = "High Steatosis (2+3) vs. Low Steatosis (0+1)",
    subtitle = "Hep-5, Adjusted for HbA1c & Ethnicity",
    x = "Log2FC",
    y = "-log10(P-Value)",
    color = "FC Direction Direction",
    caption = paste0("FDR < 0.05, Genes = ",Genes,", Nuclei = ",Nuclei)
...
pdf(fs::path(dir.results,"Plot_Hep_5_Steatosis.pdf"),width=10,height=7)
print(volcano_plot)
dev.off()
