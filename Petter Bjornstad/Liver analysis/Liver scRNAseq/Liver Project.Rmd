...
#First half of genes
# gene_list_total <- gene_list
# gene_list <- gene_list_total[501:2245]
...
write.csv(full_results,fs::path(dir.results,"Pseudobulk_Hepatocytes_Steatosis_03_17.csv"))
write.csv(full_results,fs::path(dir.ipa %>% dirname(),"Liver Pathways","Pseudobulk_Hepatocytes_Steatosis_03_17.csv"))
# full_results <- read.csv(fs::path(dir.results,"Hep_5_Fibrosis_Steatosis.csv"))
