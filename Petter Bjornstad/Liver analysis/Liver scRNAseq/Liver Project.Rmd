...
for(oro_var in oro2[-1]) {
  ...
  write.csv(full_results,fs::path(dir.results,paste0(celltype,"_Oroboros_",oro_var,"_adjusted_04_07.csv")))
  # full_results <- read.csv(fs::path(dir.results,"dHep_Steatosis_03_31.csv")) %>%
  # dplyr::select(-X)
  ...
  pdf(fs::path(dir.results,paste0("Plot_",celltype,"_Oroboros_",oro_var,"_adjusted_04_07.pdf")),width=10,height=7)
  print(volcano_plot)
  dev.off()
}
# }
