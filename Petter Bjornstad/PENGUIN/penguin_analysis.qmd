...
df_pkd = df_pkd.loc[df_pkd["adpkd_grp"].notna()]
cyst_vars = ["total_cyst_volume_ml", "total_number_of_cysts"]
adpkd_grp_desc = TableOne(df_pkd,cyst_vars, groupby="adpkd_grp", pval=True, normal_test=True, tukey_test=True, decimals=3, rename=var_dict)
```
