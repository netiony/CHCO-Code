...
```{python, include=F}
t1_adpkd_vars = ["age", "sex","race","height","weight","bmi","sbp","dbp","pulse","creatinine_s","eGFR_CKD_epi","acr_u","aer_24", "aer_24_coltime","statin", "angiotensin_receptor_blocker","ace_inhibitor", "dexa_est_vat"]
...
df_R_correlation <- df_R %>%
  ...
  select(p1_raw_leanm, p2_raw_leanm, dexa_body_fat, dexa_lean_mass, dexa_est_vat, height_adj_total_kidney_volume, right_kidney_volume_ml, height_adj_right_kidney_volume, left_kidney_volume_ml, height_adj_left_kidney_volume, total_liver_volume_ml, total_cyst_volume_ml, total_number_of_cysts, p1_raw_leanm_row, p2_raw_leanm_row, dexa_body_fat_row, dexa_lean_mass_row, dexa_est_vat_row, lc_f, rc_f,lc_vb, rc_vb, lc_k1, rc_k1, lc_k2, rc_k2,	ltot_k1_w_cyst,	ltot_k1_wo_cyst,rtot_k1_w_cyst,	rtot_k1_wo_cyst,	ltot_k2_w_cyst,	ltot_k2_wo_cyst, rtot_k2_w_cyst,	rtot_k2_wo_cyst, avg_f, avg_k1, avg_k2_w_cyst, avg_k2_wo_cyst, k2_f, k2_k1)

# Correlation matrix in table format
M_table <- as.data.frame(cor(y = df_R_correlation[,1:13],x=df_R_correlation[,14:ncol(df_R_correlation)], use = "pairwise.complete.obs")) %>%
  select(p1_raw_leanm, p2_raw_leanm, dexa_body_fat, dexa_lean_mass, dexa_est_vat, height_adj_total_kidney_volume, right_kidney_volume_ml, height_adj_right_kidney_volume, left_kidney_volume_ml, height_adj_left_kidney_volume, total_liver_volume_ml, total_cyst_volume_ml, total_number_of_cysts)
...
corr_pval = corr_pval[14:nrow(corr_pval),]
