...
df["avg_k1_w_cyst_vw"] = df[["lc_k1_w_cyst_vw", "rc_k1_w_cyst_vw"]].mean(axis=1)
df["avg_k2_w_cyst_vw"] = df[["lc_k2_w_cyst_vw", "rc_k2_w_cyst_vw"]].mean(axis=1)
df["avg_k1_wo_cyst_vw"] = df[["lc_k1_wo_cyst_vw", "rc_k1_wo_cyst_vw"]].mean(axis=1)
df["avg_k2_wo_cyst_vw"] = df[["lc_k2_wo_cyst_vw", "rc_k2_wo_cyst_vw"]].mean(axis=1)
...
```{python, include=F}
t1_vars = ["age", "sex","race","height","weight","bmi","sbp","dbp","pulse","creatinine_s","eGFR_CKD_epi","acr_u","aer_24", "aer_24_coltime","statin", "angiotensin_receptor_blocker","ace_inhibitor","adpkd_classification", "adpkd_grp"]
...
# t1-non-normal
t1nn = ["acr_u", "creatinine_s", "sbp", "dbp", "bmi", "aer_24", "aer_24_col_time"]
```

```{python, include=F}
t1_adpkd_vars = ["age", "sex","race","height","weight","bmi","sbp","dbp","pulse","creatinine_s","eGFR_CKD_epi","acr_u","aer_24", "aer_24_coltime","statin", "angiotensin_receptor_blocker","ace_inhibitor"]
...
# t1-adpkd-non-normal
t1_adpkd_nn = ["bmi", "creatinine_s", "acr_u", "aer_24", "aer_24_col_time"]
```

```{python, include=F}
mri_vars = ["total_kidney_volume_ml","height_adj_total_kidney_volume","right_kidney_volume_ml","height_adj_right_kidney_volume","left_kidney_volume_ml","height_adj_left_kidney_volume","total_liver_volume_ml","total_cyst_volume_ml","total_number_of_cysts","lc_f","rc_f", "lc_k1", "rc_k1", "lc_k2", "rc_k2", "lc_vb","rc_vb", "rc_k1_w_cyst_vw",	"rc_k1_wo_cyst_vw",	"lc_k1_w_cyst_vw",	"lc_k1_wo_cyst_vw",	"rc_k2_w_cyst_vw",	"rc_k2_wo_cyst_vw",	"lc_k2_w_cyst_vw",	"lc_k2_wo_cyst_vw", "avg_f", "avg_k1", "avg_k2", "avg_vb",  "avg_k1_w_cyst_vw",	"avg_k1_wo_cyst_vw",		"avg_k2_w_cyst_vw",	"avg_k2_wo_cyst_vw"]
...
# t2-non-normal
t2nn = ["total_cyst_volume_ml", "total_number_of_cysts", "lc_f", "rc_f", "lc_k1", "rc_k1", "lc_vb", "rc_vb", "rc_k1_w_cyst_vw",	"rc_k1_wo_cyst_vw",	"lc_k1_w_cyst_vw",	"lc_k1_wo_cyst_vw",	"rc_k2_w_cyst_vw",	"rc_k2_wo_cyst_vw",	"lc_k2_w_cyst_vw",	"lc_k2_wo_cyst_vw", "avg_f", "avg_k1", "avg_vb",  "avg_k1_w_cyst_vw",	"avg_k1_wo_cyst_vw",		"avg_k2_w_cyst_vw",	"avg_k2_wo_cyst_vw"]
```
...
t4 = TableOne(df_pkd,mri_dxa_vars, groupby="adpkd_grp", nonnormal=t4nn, pval=True, dip_test=True, normal_test=True, tukey_test=True, decimals=3, rename=var_dict)
```
...
df_R_correlation <- df_R %>%
  mutate(p1_raw_leanm_row = p1_raw_leanm,
         p2_raw_leanm_row = p2_raw_leanm, 
         dexa_body_fat_row = dexa_body_fat, 
         dexa_lean_mass_row = dexa_lean_mass) %>%
  select(p1_raw_leanm, p2_raw_leanm, dexa_body_fat, dexa_lean_mass, height_adj_total_kidney_volume, right_kidney_volume_ml, height_adj_right_kidney_volume, left_kidney_volume_ml, height_adj_left_kidney_volume, total_liver_volume_ml, total_cyst_volume_ml, total_number_of_cysts, p1_raw_leanm_row, p2_raw_leanm_row, dexa_body_fat_row, dexa_lean_mass_row, lc_f, rc_f,lc_vb, rc_vb, lc_k1, rc_k1, lc_k2, rc_k2,	lc_k1_w_cyst_vw,	lc_k1_wo_cyst_vw,rc_k1_w_cyst_vw,	rc_k1_wo_cyst_vw,	lc_k2_w_cyst_vw,	lc_k2_wo_cyst_vw, rc_k2_w_cyst_vw,	rc_k2_wo_cyst_vw, avg_f, avg_k1, avg_k2_w_cyst_vw, avg_k2_wo_cyst_vw)

# Correlation matrix in table format
M_table <- as.data.frame(cor(y = df_R_correlation[,1:12],x=df_R_correlation[,13:ncol(df_R_correlation)], use = "pairwise.complete.obs")) %>%
  select(p1_raw_leanm, p2_raw_leanm, dexa_body_fat, dexa_lean_mass, height_adj_total_kidney_volume, right_kidney_volume_ml, height_adj_right_kidney_volume, left_kidney_volume_ml, height_adj_left_kidney_volume, total_liver_volume_ml, total_cyst_volume_ml, total_number_of_cysts)
...
var_R %<>%
  ...
  mutate(dexa_body_fat_row = dexa_body_fat) %>%
  mutate(dexa_lean_mass_row = dexa_lean_mass) %>%
  mutate(lc_k1_w_cyst_vw = paste0(lc_k1, " w/ cyst (Voxel-wise)")) %>%
  mutate(lc_k2_w_cyst_vw = paste0(lc_k2, " w/ cyst (Voxel-wise)")) %>%
  mutate(lc_k1_wo_cyst_vw = paste0(lc_k1, " wo/ cyst (Voxel-wise)")) %>%
  mutate(lc_k2_wo_cyst_vw = paste0(lc_k2, " wo/ cyst (Voxel-wise)")) %>%
  mutate(rc_k1_w_cyst_vw = paste0(rc_k1, " w/ cyst (Voxel-wise)")) %>%
  mutate(rc_k2_w_cyst_vw = paste0(rc_k2, " w/ cyst (Voxel-wise)")) %>%
  mutate(rc_k1_wo_cyst_vw = paste0(rc_k1, " wo/ cyst (Voxel-wise)")) %>%
  mutate(rc_k2_wo_cyst_vw = paste0(rc_k2, " wo/ cyst (Voxel-wise)")) %>%
  ...
  mutate(avg_k1_w_cyst_vw = paste0("Average cortex perfusion with cyst (K1)")) %>%
  mutate(avg_k1_wo_cyst_vw = paste0("Average cortex perfusion w/o cyst(K1)")) %>%
  mutate(avg_k2_w_cyst_vw = paste0("Average cortex perfusion with cyst (K2)")) %>%
  mutate(avg_k2_wo_cyst_vw = paste0("Average cortex perfusion w/o cyst(K2)"))
...
kable(M_table_p, 
  ...
  add_header_above(header = c(" "=1, 
                     ...
                     setNames(2, label(M_table_p)[17]), 
                     setNames(2, label(M_table_p)[19]), 
                     setNames(2, label(M_table_p)[21]), 
                     setNames(2, label(M_table_p)[23]))) %>%
...
vw_df <- df_R %>%
  rowwise() %>%
  mutate(avg_k1_w_cyst_low = mean(c(rc_k1_w_cyst_percent_low, lc_k1_w_cyst_percent_low), na.rm = T)) %>%
  mutate(avg_k1_w_cyst_avg = mean(c(rc_k1_w_cyst_percent_avg, lc_k1_w_cyst_percent_avg), na.rm = T)) %>%
  mutate(avg_k1_w_cyst_high = mean(c(rc_k1_w_cyst_percent_high, lc_k1_w_cyst_percent_high), na.rm = T)) %>%
  mutate(avg_k1_wo_cyst_low = mean(c(rc_k1_wo_cyst_percent_low, lc_k1_wo_cyst_percent_low), na.rm = T)) %>%
  mutate(avg_k1_wo_cyst_avg = mean(c(rc_k1_wo_cyst_percent_avg, lc_k1_wo_cyst_percent_avg), na.rm = T)) %>%
  mutate(avg_k1_wo_cyst_high = mean(c(rc_k1_wo_cyst_percent_high, lc_k1_wo_cyst_percent_high), na.rm = T)) %>%
  mutate(avg_k2_w_cyst_low = mean(c(rc_k2_w_cyst_percent_low, lc_k2_w_cyst_percent_low), na.rm = T)) %>%
  mutate(avg_k2_w_cyst_avg = mean(c(rc_k2_w_cyst_percent_avg, lc_k2_w_cyst_percent_avg), na.rm = T)) %>%
  mutate(avg_k2_w_cyst_high = mean(c(rc_k2_w_cyst_percent_high, lc_k2_w_cyst_percent_high), na.rm = T)) %>%
  mutate(avg_k2_wo_cyst_low = mean(c(rc_k2_wo_cyst_percent_low, lc_k2_wo_cyst_percent_low), na.rm = T)) %>%
  mutate(avg_k2_wo_cyst_avg = mean(c(rc_k2_wo_cyst_percent_avg, lc_k2_wo_cyst_percent_avg), na.rm = T)) %>%
  mutate(avg_k2_wo_cyst_high = mean(c(rc_k2_wo_cyst_percent_high, lc_k2_wo_cyst_percent_high), na.rm = T)) %>%
...
# Subset of Average Cortex K1 w cyst
...
superheat(vw_df_k1_w_cyst, 
          title = "Average Cortex K1 Activity (Including Cysts)",
          scale = F,
...
# Subset of Average Cortex K1 wo cyst
...
superheat(vw_df_k1_wo_cyst, 
          title = "Average Cortex K1 Activity (Excluding Cysts)",
          scale = F,
...
```{r layout="[[1,1]]"}
# Subset of Average Cortex K2 w cyst
...
superheat(vw_df_rck2_w_cyst, 
          title = "Average Cortex K2 Activity (Including Cysts)",
          scale = F,
...
# Subset of Average Cortex K2 wo cyst
...
superheat(vw_df_rck2_wo_cyst, 
          title = "Average Cortex K2 Activity (Excluding Cysts)",
          scale = F,
