...
dat$group_w_class <- factor(dat$group_w_class,
       level = c("NWC", "Mild ADPKD", "Severe ADPKD"))

comparison_groups = list(c("NWC", "Mild ADPKD"),
                         c("NWC", "Severe ADPKD"),
...
rects <- data.frame(xstart = c(0, (count(vw_activity$group)$freq)[1]), 
...
vw_activity$group<- factor(vw_activity$group, levels = c("NWC", "ADPKD"))
```
