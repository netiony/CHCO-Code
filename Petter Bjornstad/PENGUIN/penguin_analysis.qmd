...
```{python, include=F}
t1_vars = ["age", "sex","race","height","weight", "adjusted_bmi", "bmi","sbp","dbp","pulse","creatinine_s","eGFR_CKD_epi","acr_u","aer_24", "aer_24_coltime","statin", "angiotensin_receptor_blocker","ace_inhibitor","adpkd_classification", "adpkd_grp"]
...
"adjusted_bmi", "bmi","sbp","dbp","pulse","creatinine_s","eGFR_CKD_epi","acr_u","aer_24", "aer_24_coltime","statin", "angiotensin_receptor_blocker","ace_inhibitor", "dexa_est_vat"]
