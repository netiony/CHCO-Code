...
ggplot(df_R, aes(dexa_body_fat, avg_f)) +
...
ggplot(df_HC, aes(dexa_body_fat, avg_f)) +
...
ggplot(df_PKD, aes(dexa_body_fat, avg_f)) +
...
ggplot(df_R, aes(dexa_body_fat, avg_k1)) +
...
ggplot(df_HC, aes(dexa_body_fat, avg_k1)) +
...
ggplot(df_PKD, aes(dexa_body_fat, avg_k1)) +
...
# Body Fat vs. k2/f
ggplot(df_R, aes(dexa_body_fat, k2_f)) +
...
ggplot(df_HC, aes(dexa_body_fat, k2_f)) +
...
ggplot(df_PKD, aes(dexa_body_fat, k2_f)) +
