...
kidney_meta_raw_sc <- meta_raw %>%
  filter(Cryostor_ID!="")
form <- paste("diagnosis_of_diabetes", paste(colnames(kidney_meta_raw_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
meta_oat_sc <- so_oat_sc@meta.data %>%
  filter(cryostor_id!="")
form <- paste("diagnosis_of_MASLD", paste(colnames(meta_oat_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
kidney_meta_raw_sc <- meta_raw %>%
  filter(cryostor_id!="")
form <- paste("diagnosis_of_osa", paste(colnames(kidney_meta_raw_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
```{r echo = F}
# Descriptive stats
kidney_meta_raw_sc <- liver_meta_raw %>%
  filter(Cryostor_ID!="")
form <- paste("glp1agonist", paste(colnames(kidney_meta_raw_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
kidney_meta_raw_sc <- meta_raw %>%
  filter(Cryostor_ID!="")
form <- paste("insulin", paste(colnames(kidney_meta_raw_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
kidney_meta_raw_sc <- meta_raw %>%
  filter(Cryostor_ID!="")
form <- paste("diagnosis_of_kidney_disease", paste(colnames(kidney_meta_raw_sc)[c(15,18:27)], collapse = " + "), sep = " ~ ")
...
meta_kidney_raw <- meta_kidney_raw %>%
  filter(cryostor_id!="")
form <- paste("diagnosis_of_diabetes", paste(colnames(meta_kidney_raw)[c(15,18:27)], collapse = " + "), sep = " ~ ")
