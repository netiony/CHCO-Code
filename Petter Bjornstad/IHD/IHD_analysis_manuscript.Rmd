...
```{r echo=FALSE,comment=''}
b_cell_vars <- c("acr_u", "bold_l_bl_cortex", "bold_r_bl_cortex", "bold_l_bl_medulla", "bold_r_bl_medulla", "bold_l_bl_kidney", "bold_r_bl_kidney", "fsoc_r_cortex", "fsoc_r_medulla", "fsoc_r_kidney", "fsoc_l_cortex", "fsoc_l_medulla", "fsoc_l_kidney",  "glomerular_pressure", "ff")
