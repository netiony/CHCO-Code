...
2. For albuminuria, we used variable "acr_u" - is that correct?
...
```{r echo=FALSE,comment=''}
ffa_vars <- c("fsoc_r_cortex", "fsoc_r_medulla", "fsoc_r_kidney", "fsoc_l_cortex", "fsoc_l_medulla", "fsoc_l_kidney","acr_u", "glomerular_pressure", "re", "rvr")
