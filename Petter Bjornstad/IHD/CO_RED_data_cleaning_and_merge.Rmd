...
CO_clean <- left_join(CO_raw, coenroll_id, by = 'record_id') %>% 
  ...
  mutate(bsa = sqrt(weight * height / 3600)) %>% # formula used by Netherlands site
...
Neth_clean <- Neth_clean %>% 
  rename('age'='G_V2_Age.c', 'sex'='G_Sex.c', 'height'='Anthro_Length.c', 'bmi'='Anthro_V2_BMI.a',
         ...
         'ff'='Renal_FF_V2_Hyper', 'glomerular_pressure'='Renal_Pglo_V2_Hyper', 'ra'='Renal_Ra_V2_Hyper',
         're'='Renal_Re_V2_Hyper',
