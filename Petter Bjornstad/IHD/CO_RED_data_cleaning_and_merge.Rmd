...
Neth_clean <- Neth_clean %>% 
  select(site, study, record_id, ethnicity, group, INUorIOH, G_V2_Age.c, G_Sex.c, 
         ...
         Renal_Pglo_V2_Eu, Renal_Ra_V2_Eu, Renal_Re_V2_Eu, CV_RR_V2_Fasting_SBP, CV_RR_V2_Fasting_DBP,
...
Neth_clean <- Neth_clean %>% 
  rename('age'='G_V2_Age.c', 'sex'='G_Sex.c', 'height'='Anthro_Length.c', 'bmi'='Anthro_V2_BMI.a',
         ...
         'urine_microalb_quant_24hr'='L_2_0_24u_urine_mircoalb_quant.u')
...
combined_dat <- combined_dat %>% 
  select(c('record_id', 'site', 'study', 'group', 'age', 'diabetes_duration', 'sex', 'ethnicity', 'height', 
           ...
           'steady_state_insulin', 'NEFA_V2.1_Fasting', 'NEFA_delta', 'INUorIOH', 'metformin_timepoint',
           'raasi_timepoint', 'statin', 'Med_betablocker', 'Med_calciumantagonist', 'Med_anticoagulant', 'Medication')) %>% 
