...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ Percent.FFA.Suppression + Percent.FFA.Suppression^2,data=data_modeling)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption..pre.post.furosemide.R2....cortex.^2,data=data_modeling)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption...pre.post.furosemide.R2....medulla.^2,data=data_modeling)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption...pre.post.furosemide.R2....kidney.^2,data=data_modeling)
plot(mod)
```
...
```{r echo=FALSE}
plot(data_log$Percent.FFA.Suppression,data_log$Baseline.ACR)
plot(data_log$Percent.FFA.Suppression,data_log$O2.Consumption..pre.post.furosemide.R2....cortex.)
plot(data_log$Percent.FFA.Suppression,data_log$O2.Consumption...pre.post.furosemide.R2....medulla.)
plot(data_log$Percent.FFA.Suppression,data_log$O2.Consumption...pre.post.furosemide.R2....kidney.)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ Percent.FFA.Suppression,data=data_log)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption..pre.post.furosemide.R2....cortex.,data=data_log)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption...pre.post.furosemide.R2....medulla.,data=data_log)
plot(mod)
```
...
```{r echo=FALSE}
mod <- lm(Baseline.ACR ~ O2.Consumption...pre.post.furosemide.R2....kidney.,data=data_log)
plot(mod)
```
