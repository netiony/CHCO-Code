...
Datasets from the Colorado and Netherlands sites were separately cleaned as described in sections 1.1.1 and 1.1.2 before being combined as one main dataset for analyses. Variables that were considered similar between the two sites were combined as one variable. Note that measures for GFR, ERPF, FF, RVR, glomerular pressure, Ra, and Re in the combined dataset represent data from the euglycemic clamp at the Netherlands site and the hyperglycemic clamp at the Colorado site.
...
* For SBP, DBP, MAP, body fat percentage, and eGFR by Full Age Spectrum Scr and CysC, we pulled fasting data from the Netherlands site - should we instead be pulling euglycemic metrics as was done for mGFR, ERPF, FF, RVR, Pglo, Ra, Re?
