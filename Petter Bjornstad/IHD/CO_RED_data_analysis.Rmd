...
<!-- Please note that the reported estimates have been back-transformed and can be interpreted as  -->

$$\\[0.01in]$$

Association between sex-adjusted AER (log-transformed) and FFA suppression by Site (Interaction), adjusted for HbA1c:
...
$$\\[0.01in]$$
Association between covariate-adjusted AER (log-transformed) and FFA suppression by Site (Interaction), adjusted for HbA1c:
