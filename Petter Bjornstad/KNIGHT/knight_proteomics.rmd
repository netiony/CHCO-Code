...
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_estradiol.xlsx",overwrite = TRUE)
...
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_M-value.xlsx",overwrite = TRUE)
...
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_plasma_uric_acid.xlsx",overwrite = TRUE)

ipa <- createWorkbook()
addWorksheet(ipa,"Change in URklaring")
writeData(ipa,"Change in URklaring",corr_URklaring_mat_save,rowNames = F)
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_URklaring.xlsx",overwrite = TRUE)

ipa <- createWorkbook()
addWorksheet(ipa,"Change in FEUA")
writeData(ipa,"Change in FEUA",corr_FEUA_mat_save,rowNames = F)
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_FEUA.xlsx",overwrite = TRUE)

ipa <- createWorkbook()
addWorksheet(ipa,"Change in GFR")
writeData(ipa,"Change in GFR",corr_GFR..mL.min._mat_save,rowNames = F)
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_GFR.xlsx",overwrite = TRUE)

ipa <- createWorkbook()
addWorksheet(ipa,"Change in ERPF")
writeData(ipa,"Change in ERPF",corr_ERPF..mL.min._mat_save,rowNames = F)
saveWorkbook(ipa,"/Volumes/Shared/Shared Projects/Laura/Peds Endo/Petter Bjornstad/KNIGHT/Results/IPA/KNIGHT_correlations_ERPF.xlsx",overwrite = TRUE)
```
