...
The albuminuria analysis with LC has been removed.

* Q3. SGLT2i (ever) in all? If so, same concept above applies.

The SGLT2i analysis with LC has been removed.
...
Not exactly, I'm using the PB68 dataset and subsetting down to participants in the JCI paper, but I think they used a previous iteration of the scRNA dataset and I'm not sure how they integrated the newer runs on top. 

* Q7. If so, it should be T2D(-) vs. HC

The analyses for T2Di- vs. HC is included.
...
summary(arsenal::tableby(group ~ age + sex + diabetes_duration + acr_u + eGFR_CKD_epi,
