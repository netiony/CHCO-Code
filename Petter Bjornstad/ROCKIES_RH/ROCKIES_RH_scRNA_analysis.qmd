...
so <- subset(so, group %in% c("Lean Control", "Obese Control", "Type 2 Diabetes") & !is.nan(so$avg_c_k1))
```
...
```{r echo = F}
plot_de_markers(so_group_t2ob, genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_ever_t2dob")
...
```{r echo = F}
# plot_de_markers(so_group_t2ob, genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_timpoint_t2dob")
...
```{r echo = F}
plot_de_markers(so_group_t2ob, oxy_phos_genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_ever_t2dob")
...
```{r echo = F}
# plot_de_markers(so_group_t2ob, oxy_phos_genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_timpoint_t2dob")
...
# DEG in PT (Subset to IDs in old dataset)
...
so_oldid_subset <- subset(so, record_id %in% so_old$michigan_id)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, genes, "group_t2ob", id1 = "T2D/OB", id2 = "LC", "PT","_tca_t2ob")
kable(m_tca_t2ob, digits = 3)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, genes, "elevated_albuminuria", id1 = "Yes", id2 = "No", "PT","_tca_alb")
kable(m_tca_alb, digits = 3)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_ever")
kable(m_tca_sglt2i_ever, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset, genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_timpoint")
# kable(m_tca_sglt2i_timpoint, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, genes, "group", id1 = "Type 2 Diabetes", id2 = "Obese Control", "PT","_tca_t2d_t2dob")
# kable(m_tca_t2d_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, genes, "elevated_albuminuria", id1 = "Yes", id2 = "No", "PT","_tca_alb_t2dob")
# kable(m_tca_alb_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_ever_t2dob")
# kable(m_tca_sglt2i_ever_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_tca_sglt2i_timpoint_t2dob")
# kable(m_tca_sglt2i_timpoint_t2dob, digits = 3)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, oxy_phos_genes, "group_t2ob", id1 = "T2D/OB", id2 = "LC", "PT","_oxphos_t2ob")
kable(m_oxphos_t2ob, digits = 3)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, oxy_phos_genes, "elevated_albuminuria", id1 = "Yes", id2 = "No", "PT","_oxphos_alb")
kable(m_oxphos_alb, digits = 3)
```
...
```{r echo = F}
plot_de_markers(so_oldid_subset, oxy_phos_genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_ever")
kable(m_oxphos_sglt2i_ever, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset, oxy_phos_genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_timpoint")
# kable(m_oxphos_sglt2i_timpoint, digits = 3)
```
...
```{r echo = F}
# so_oldid_subset_group_t2ob <- subset(so_oldid_subset, group_t2ob == "T2D/OB")
# plot_de_markers(so_oldid_subset_group_t2ob, oxy_phos_genes, "group", id1 = "Type 2 Diabetes", id2 = "Obese Control", "PT","_oxphos_t2d_t2dob")
# kable(m_oxphos_t2d_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, oxy_phos_genes, "elevated_albuminuria", id1 = "Yes", id2 = "No", "PT","_oxphos_alb_t2dob")
# kable(m_oxphos_alb_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, oxy_phos_genes, "sglt2i_ever", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_ever_t2dob")
# kable(m_oxphos_sglt2i_ever_t2dob, digits = 3)
```
...
```{r echo = F}
# plot_de_markers(so_oldid_subset_group_t2ob, oxy_phos_genes, "sglti_timepoint", id1 = "Yes", id2 = "No", "PT","_oxphos_sglt2i_timpoint_t2dob")
# kable(m_oxphos_sglt2i_timpoint_t2dob, digits = 3)
```
...
```{r echo = F}
so_oldid_subset$t2d_sglt2i_neg <- ifelse(so_oldid_subset$group == "Type 2 Diabetes" & so_oldid_subset$sglt2i_ever == "No", "T2Di(-)", so_oldid_subset$group)
so_oldid_subset$t2d_sglt2i <- ifelse(so_oldid_subset$group == "Type 2 Diabetes" & so_oldid_subset$sglt2i_ever == "Yes", "T2Di(+)", so_oldid_subset$t2d_sglt2i_neg)
