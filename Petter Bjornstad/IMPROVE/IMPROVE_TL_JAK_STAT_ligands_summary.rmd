...
improve_means <- improve_means %>% select()

# NEEDED TO GO BACK TO IMPROVE AND TL CODE TO ADD SEQ NAME TO EMMEANS
...
# keep only the timepoints we need
tl_means <- tl_means %>% filter(visit %in% c("baseline", "12_months_post_surgery"))
