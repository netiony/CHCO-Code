...
library(knitr)
# Import and filter
df <- read.csv("/Users/timvigers/Documents/Work/Petter Bjornstad/Data Harmonization/Data Clean/harmonized_dataset.csv", na.strings = "")
...
df <- df %>%
  select(
    ...
    contains("fsoc_"), map, sbp, dbp, fbg, hba1c, airg, acprg,raw_m,
...
# Get names
var_names <- read.csv("/Users/timvigers/Documents/Work/Petter Bjornstad/Data Harmonization/data_dictionary_master.csv", na.strings = "")
