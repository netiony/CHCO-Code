...
panel_fig <- ggarrange(aplot,bplot,ncol=1,legend="bottom")
...
panel_fig <- ggarrange(aplot,bplot,ncol=1,legend="bottom")
ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/month_year_panel.tiff", units="in", width=7, height=, dpi=1200, compression = 'lzw')
```
