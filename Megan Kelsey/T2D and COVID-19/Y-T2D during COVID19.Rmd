...
# read in Peoria
#peoria <- read.csv("E:\\Megan Kelsey\\T2D and COVID\\Data raw\\Peoria.Illinois.T2D COVID 19_2021-10-15_Validated_10.30.21-De-identified.csv",
#                   na.strings = c("NULL",""," "))
#peoria$site <- "Peoria"
...
# DKA severity
# THIS IS NOT CORRECT - THERE ARE SOME PEOPLE WITH DKA MISSING SEVERITY
alldata$dka_severity <- ifelse(alldata$dka==TRUE & ((is.na(alldata$pH) & alldata$bicarbonate<5) | (is.na(alldata$bicarbonate) & alldata$pH<7.1) | (alldata$pH<7.1 | alldata$bicarbonate<5)),"Severe",
                          ifelse(alldata$dka==TRUE & ((is.na(alldata$pH) & alldata$bicarbonate<10) | (alldata$pH<7.2 & is.na(alldata$bicarbonate)) | (alldata$pH<7.2 | alldata$bicarbonate<10)),"Moderate",
                                                           ifelse(alldata$dka==TRUE,"Mild",NA)))
