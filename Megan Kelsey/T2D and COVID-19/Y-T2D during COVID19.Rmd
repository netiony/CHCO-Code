...
alldata_novandy <- alldata %>% filter(!site=="Vanderbilt")
alldata_novandy$race_eth_four <- ifelse(alldata_novandy$race_eth %in% c("ASIAN","OTHER","UNKNOWN"),"OTHER",alldata_novandy$race_eth)
...
## New onset cases by year and site

```{r include=FALSE}
tbysite <- CreateTableOne(data=alldata,vars = "site",strata="period",test = FALSE)
tbysite <- print(tbysite,showAllLevels=T)
```
...
## Figure - by met decomp

```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=met_decomp)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("No metabolic decompensation","Metabolic decompensation")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/T2D and COVID-19time_series.tiff", units="in", width=7, height=4, dpi=1200, compression = 'lzw')
```

## Figure - by sex

```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=sex)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Female","Male")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/T2D and COVID-19time_series_sex.tiff", units="in", width=7, height=4, dpi=1200, compression = 'lzw')
```

## Figure - by race

```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_white)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Not White","White")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/T2D and COVID-19time_series_race_white.tiff", units="in", width=7, height=4, dpi=1200, compression = 'lzw')
```

```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_black)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Black","Not Black")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/T2D and COVID-19time_series_race_black.tiff", units="in", width=7, height=4, dpi=1200, compression = 'lzw')
```

```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_four)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Black","Hispanic","Other","White")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/T2D and COVID-19time_series_race_four_groups.tiff", units="in", width=7, height=4, dpi=1200, compression = 'lzw')
```

## Panel plots

```{r echo=FALSE}
aplot <- ggplot(alldata_novandy, aes(x=dx_date, fill=sex)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Female","Male")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

bplot <- ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_four)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("Black","Hispanic","Other","White")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90))  

panel_fig <- ggarrange(aplot,bplot,ncol=1,legend="bottom", labels=c("2a","2b"))
ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/sex_race_panel.tiff", units="in", width=7, height=, dpi=1200, compression = 'lzw')
```

```{r echo=FALSE}
aplot <- ggplot(alldata_novandy, aes(x=dx_date, fill=met_decomp)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month",expand = c(.01, .01)) +
  scale_fill_grey(labels=c("No metabolic decompensation","Metabolic decompensation")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90))  

bplot <- ggplot(data=alldata_novandy,aes(x=period)) + geom_bar(stat="count") + theme_classic() + labs(x="Year",y="New diagnoses of T2D")

panel_fig <- ggarrange(aplot,bplot,ncol=1,legend="bottom", labels=c("1a","1b"), hjust=c(0.08))
ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/month_year_panel.tiff", units="in", width=7, height=8, dpi=1200, compression = 'lzw')
```

## Bar graph by year

```{r echo=FALSE}
ggplot(data=alldata_novandy,aes(x=period)) + geom_bar(stat="count") + theme_classic() + labs(x="Year",y="New diagnoses of T2D")

ggsave("C:/Users/pylell/Documents/GitHub/CHCO-Code/Megan Kelsey//T2D and COVID-19/barplot_year.tiff", units="in", width=7, height=, dpi=1200, compression = 'lzw')
```
