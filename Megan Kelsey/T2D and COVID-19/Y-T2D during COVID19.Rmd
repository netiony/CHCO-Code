...
ggplot(alldata_novandy, aes(x=dx_date, fill=met_decomp)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=sex)) + geom_bar(stat="count") + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_white)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_black)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_four)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
aplot <- ggplot(alldata_novandy, aes(x=dx_date, fill=met_decomp)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
  scale_fill_grey(labels=c("Female","Male")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

bplot <- ggplot(alldata_novandy, aes(x=dx_date, fill=race_eth_white)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
  scale_fill_grey(labels=c("Not White","White")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 
