...
# need to fix time, this implies it's doubling
temptrend <- 1:length(ts3)

temptrend <- cbind(rep(1,36),linearTrend=(seq(along=ts3)*(0.15/36)))
temptrend <- temptrend[,-1]

fit_nb1 <- tsglm(ts3,distr = "nbinom",model = list(past_obs=1),xreg=temptrend)
