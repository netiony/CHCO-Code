...
```{r include=FALSE}
#t3a <- CreateTableOne(data=alldata,vars = c("period","met_decomp"),strata="site",test = FALSE)
#t3a <- print(t3a,showAllLevels=T)
tbysite <- table1(~met_decomp | site*period, data=alldata)
```
...
```{r echo=FALSE}
ggplot(alldata, aes(x=dx_date, fill=sex)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata, aes(x=dx_date, fill=met_decomp)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
ggplot(alldata, aes(x=dx_date, fill=race_eth_white)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
...
```{r echo=FALSE}
aplot <- ggplot(alldata, aes(x=dx_date, fill=met_decomp)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
  scale_fill_grey(labels=c("Female","Male")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 

bplot <- ggplot(alldata, aes(x=dx_date, fill=race_eth_white)) + geom_bar() + geom_vline(xintercept = as.Date("03-01-2020",format="%m-%d-%Y"),linetype="dashed",size=1.2)+ ylab("New diagnoses of T2D") + xlab("") + labs(fill="") + scale_x_date(date_labels = "%m-%Y",date_breaks = "1 month") +
  scale_fill_grey(labels=c("Not White","White")) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 90)) 
...
```{r echo=FALSE}
ggplot(data=alldata,aes(x=period)) + geom_bar(stat="count") + theme_classic() + labs(x="Year",y="New diagnoses of T2D")
