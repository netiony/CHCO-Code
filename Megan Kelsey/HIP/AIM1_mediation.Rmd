...
baseline_keep <- baseline[,c("hip_id_screen","study_visit_number_svl","lept","visceral","liver_fat_perc",
                             "per_visceral","subq_fat","lept_adipo")]
colnames(baseline_keep) <- c("hip_id_screen","study_visit_number_svl","lept_base","visceral_base","liver_fat_perc_base",                             "per_visceral_base","subq_fat_base","lept_adipo_base")
