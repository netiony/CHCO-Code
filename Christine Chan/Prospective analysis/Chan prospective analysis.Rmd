...
pred <- data8[,c("MRN","average_sensor","standard_deviation","min_sensor","max_sensor","q1_sensor",
...
```{r plot function}
model_and_plot = function(outcome_name,ylab,pred,df,pois = F){
  # Convert to numeric
...
define baseline
Set one BMI of 8.6 (BMI-Z -16.6) to missing
...
## All timepoints included, timepoints on insulin included
...
## 1 year included, timepoints on insulin included
...
```
## 3 years included, timepoints on insulin included
