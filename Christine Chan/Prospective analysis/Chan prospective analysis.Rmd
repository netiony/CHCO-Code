...
CFRD <- data7[,c("MRN","Encounter_date","Hbg A1C","poc_a1c","OGTT 2 Hour","lab_ogtt_2_hour_glucose","poc_fasting_glucose","OGTT Fasting","poc_2_hour_glucose")]
# include fasting glucose in the definition of CFRD
CFRD$dia_visit <- ifelse(CFRD$`Hbg A1C`>=6.5 | CFRD$poc_a1c >=6.5 | CFRD$`OGTT 2 Hour`>= 200 | CFRD$lab_ogtt_2_hour_glucose >= 200 | CFRD$poc_2_hour_glucose >=200 
