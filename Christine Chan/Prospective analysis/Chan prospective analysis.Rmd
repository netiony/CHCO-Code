...
data9$CFRD_date <- ifelse(data9$MRN==1222608,NA,data9$CFRD_date)
data9$CFRD_after_base <- ifelse(data9$MRN==1222608,0,data9$CFRD_after_base)
data9$CFRD_date <- ifelse(data9$MRN==1343143,"08/28/2011",data9$CFRD_date)
...
# need to start back up with 667398
