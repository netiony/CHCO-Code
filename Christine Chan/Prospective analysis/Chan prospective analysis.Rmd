...
source("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/CGMInHealthyControls-DataForProspectiveAn_R_2021-06-02_0929.r")
...
new_cgm <- read.csv("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Corrected outcome data/Extra CGM upload/REDCap Upload updated IDs.csv")
...
ins <- read.csv("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Insulin Start date and prospective data-- Eileen cleanup.csv",
                na.strings = c(""," ",NA))
...
# read in PFTs
pfts <- read_xlsx("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Updated Full List for Elin_Data_Updated2022_07_22.xlsx",sheet="PFTs")
...
ogtt <- read_xlsx("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Updated Full List for Elin_Data_Updated2022_07_22.xlsx",sheet="OGTTandA1C")
...
# read in sputum data
sputum <- read_xlsx("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Updated Full List for Elin_Data_Updated2022_07_22.xlsx",sheet="Sputum")
...
mods <- read_xlsx("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Updated Full List for Elin_Data_Updated2022_07_22.xlsx",sheet="Modulators")
...
# read in admits
admits <- read_xlsx("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Updated Full List for Elin_Data_Updated2022_07_22.xlsx",sheet="Admits_List")
...
newcgm <- read.csv("/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data raw/Corrected outcome data/Extra CGM upload/REDCap Upload.csv")
...
# fix one Hba1c value
data9$`Hbg A1C` <- ifelse(data9$`Hbg A1C`==55, 5.5, data9$`Hbg A1C`)
...
write.csv(check_poc,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/checking_POC_glucose.csv",row.names = F)
...
# remove people on insulin or with CFRD at baseline
data9 <- data9 %>% filter(has_CFRD_base==0)
data9 <- data9 %>% filter(on_ins_base==0)
...
x <- data9 %>% filter(days==0) %>% select(MRN,date_cgm_placement,date_cgm_placement_minus_90,
                                          ...
                                          `OGTT 2 Hour`)
write.csv(x,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_missing_OGTT_baseline_with_fuzzy_join.csv")
...
write.csv(checkoutcomes,'/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_outcomes.csv',row.names = F)
...
write.csv(checkfsogtt,'/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_fsogtt.csv',row.names = F)
...
t1data <- final_alltime_withins %>% group_by(MRN) %>% arrange(MRN, days) %>% slice_head()
...
write.csv(ogttcheck,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/checking_baseline_OGTTs.csv",row.names = F)
write.csv(t1data,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/baseline data.csv",row.names = F)
write.csv(final_alltime_withins,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/alldata.csv",row.names = F)

# write a file with only important outcomes for Christine to check
t1data_outcome_check <- t1data %>% select("subject_id","MRN","date_cgm_placement","lab_ogtt_fasting","lab_ogtt_1_hour_glucose","lab_ogtt_2_hour_glucose",
                                          "has_CFRD_base","CFRD_after_base","on_ins_base","ins_after_base")
write.csv(t1data_outcome_check,"/Volumes/RI Biostatistics Core/Shared/Shared Projects/Laura/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_outcomes.csv",row.names = F)
