...
# I think below is not working because each person has >1 row, need to replicate CGM rows
data9[which(data9$subject_id=="021"),vars_to_replace] <- newcgm_keep[newcgm_keep$subject_id=="021",vars_to_replace]
View(data9[which(data9$subject_id=="021"),vars_to_replace])
