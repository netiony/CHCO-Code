...
write.csv(t1data,"/Volumes/Peds Endo/Christine Chan/Prospective analysis/Data clean/baseline data.csv",row.names = F)
write.csv(final_alltime_withins,"/Volumes/Peds Endo/Christine Chan/Prospective analysis/Data clean/alldata.csv",row.names = F)
...
write.csv(t1data_outcome_check,"/Volumes/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_outcomes.csv",row.names = F)
