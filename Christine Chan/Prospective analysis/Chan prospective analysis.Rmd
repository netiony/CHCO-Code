...
x <- data9 %>% filter(days==0) %>% select(MRN,date_cgm_placement,date_of_ogtt,`OGTT Fasting`,`OGTT 1 Hour`,`OGTT 2 Hour`)
write.csv(x,"/Volumes/Peds Endo/Christine Chan/Prospective analysis/Data clean/check_missing_OGTT_baseline_no_fuzzy_join.csv")
