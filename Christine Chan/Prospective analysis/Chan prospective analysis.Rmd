...
data9$insulin_start_date <- ifelse(data9$MRN==1055169,"8/19/2016",data9$insulin_start_date)
data9$CFRD_date <- ifelse(data9$MRN==1222608,as.Date(""),data9$CFRD_date)
data9$CFRD_after_base <- ifelse(data9$MRN==1222608,0,data9$CFRD_after_base)
data9$CFRD_date <- ifelse(data9$MRN==1343143,"2011-08-28",data9$CFRD_date)
...
data9$insulin_start_date <- ifelse(data9$MRN==615616,"8/17/2012",data9$insulin_start_date)
data9$on_ins_base <- ifelse(data9$MRN==615616,1,data9$insulin_start_date)
data9$CFRD_date <- ifelse(data9$MRN==667398,"2010-06-14",data9$CFRD_date)
...
View(data9[data9$MRN==672285,c("MRN","CFRD_date","has_CFRD_base","CFRD_after_base")])
...
model_and_plot = function(outcome_name,ylab,group_var,pred,df,pois = F,plot){
  ...
  p = ggplot(df,aes_string(x = "days",y = outcome_name, group = group_var)) +
    geom_line(alpha=0.1) + geom_smooth(aes(group=1)) +
