...
# THIS IS WHERE THE PROBLEM IS - I DO NOT WANT TO MERGE IN ELIN'S OGTTS BY DATE OF CGM PLACEMENT
# REALLY SHOULD JUST BE BY ENCOUNTER DATE
...
data9 <- data9 %>% arrange("MRN","Encounter_date")
checkoutcomes <- data9[,c("MRN","First.Name","Last.Name","date_cgm_placement","Encounter_date","OGTT Fasting","lab_ogtt_fasting","OGTT 2 Hour","lab_ogtt_2_hour_glucose",
