...
Overlay of ROC for diabetes - see separate figures

```{r, results='asis',tidy=TRUE, echo=FALSE, include=FALSE}
...
95% CI for AUC for % time>140, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_pct140roc <- ci(pct140_roc)
ci_pct140roc
```

95% CI for AUC for % time>200, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_pct200roc <- ci(pct200_roc)
ci_pct200roc
```

95% CI for AUC for mean sensor glucose, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_average_roc <- ci(average_roc)
ci_average_roc
```

95% CI for AUC for max glucose, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_max_roc <- ci(max_roc)
ci_max_roc
```

95% CI for AUC for SD, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_sd_roc <- ci(sd_roc)
ci_sd_roc
```

95% CI for AUC for CV, CFRD:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_cv_roc <- ci(cv_roc)
ci_cv_roc
```

95% CI for AUC for % time>140, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_pct140roc_pre <- ci(pct140_roc_pre)
ci_pct140roc_pre
```

95% CI for AUC for % time>200, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_pct200roc_pre <- ci(pct200_roc_pre)
ci_pct200roc_pre
```

95% CI for AUC for mean sensor glucose, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_average_roc_pre <- ci(average_roc_pre)
ci_average_roc_pre
```

95% CI for AUC for max glucose, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_max_roc_pre <- ci(max_roc_pre)
ci_max_roc_pre
```

95% CI for AUC for SD, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_sd_roc_pre <- ci(sd_roc_pre)
ci_sd_roc_pre
```

95% CI for AUC for CV, prediabetes:
```{r, results='asis',tidy=TRUE, echo=FALSE, comment=""}
ci_cv_roc_pre <- ci(cv_roc_pre)
ci_cv_roc_pre
```
