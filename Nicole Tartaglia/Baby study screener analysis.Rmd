...
ss <- function(df,asqvar,bsidvar) {
  ...
  print(c(noquote("BSID variable:"), noquote(eval(bsidvar))))
  print(noquote("Sensitivity:"))
  print(sens(df,estimate=df[,asqvar],truth=df[,bsidvar],event_level = "second")$.estimate)
  print(noquote("Specificity:"))
  print(spec(df,estimate=df[,asqvar],truth=df[,bsidvar],event_level = "second")$.estimate)
  print(noquote("PPV:"))
  print(ppv(df,estimate=df[,asqvar],truth=df[,bsidvar],event_level = "second")$.estimate)
  print(noquote("NPV:"))
  print(npv(df,estimate=df[,asqvar],truth=df[,bsidvar],event_level = "second")$.estimate)
}
