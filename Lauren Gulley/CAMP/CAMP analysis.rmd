...
## Descriptive statistics - by arm - physical activity for those with Actigraph_valid_days.0 = 1
...
## Descriptive statistics - by study completion status
...
## Descriptive statistics - by study completion status - physical activity for those with Actigraph_valid_days.0 = 1
...
```{r, include=FALSE}
t1 <- tableby(data=data, group_condition_char ~ SessionAtt+participate_again+enjoy_participating+recommend_study+end_interest,
...
```{r, include=FALSE}
t2 <- tableby(data=data, group_condition_char ~ delta_bmi+delta_bmiz+delta_bmip+experimental_gwg+total_gwg,
                     numeric.test="kwt",numeric.stats=c("Nmiss2","median","q1q3"))
```
