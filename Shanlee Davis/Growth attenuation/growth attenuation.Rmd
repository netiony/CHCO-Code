...
demo$gi_ses <- ifelse(demo$gi_ses==999,NA,demo$gi_ses)
demo$skin_ses <- ifelse(demo$skin_ses==999,NA,demo$skin_ses)
demo$galactorrhea <- ifelse(demo$galactorrhea==999,NA,demo$galactorrhea)
demo$gynecomastia <- ifelse(demo$gynecomastia==999,NA,demo$gynecomastia)
demo$hairgat <- ifelse(demo$hairgat==999,NA,demo$hairgat)
demo$droolgat <- ifelse(demo$droolgat==999,NA,demo$droolgat)
demo$genitalgat <- ifelse(demo$genitalgat==999,NA,demo$genitalgat)
demo$flushgat <- ifelse(demo$flushgat==999,NA,demo$flushgat)
...
```{r echo=FALSE, include=FALSE}
aevars <- c("gi_ses.factor","skin_ses.factor",".factor",".factor",
            "fracturesgat.factor","seizuresgat.factor","hairgat.factor","droolgat.factor",
            "genitalgat.factor","flushgat.factor","other_ses")

```

### GI - quantiles of survival and K-M plot
...
### Skin - quantiles of survival and K-M plot
...
### Galactorrhea - quantiles of survival and K-M plot
...
### Gynecomastia - quantiles of survival and K-M plot
...
### Hypertrichosis - quantiles of survival and K-M plot
...
### Increased drooling - quantiles of survival and K-M plot
...
### Genital swelling - quantiles of survival and K-M plot
...
### Flushing/swelling - quantiles of survival and K-M plot
