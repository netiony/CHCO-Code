...
aldsim, totn(6) cn(12) ci(2) pn(13) pi(1) agelb(14.1) ageub(14.9) intsd(5) slpsd(0.05) slpintcor(-0.1) resid(0.559017) effsize(0.28836)
...
* should verify that the simulation worked by taking the average slope across simulations - should be approximately 0.26, otherwise, there is probably
* something incorrect with the intst slpintcor or resid
