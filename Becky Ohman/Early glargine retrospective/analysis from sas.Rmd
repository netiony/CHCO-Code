...
tab1 <- CreateTableOne(data = final, vars = c('Sex','Ethnicity',"Insurance_Type","New_Onset_Diabetic",
    "Age","Height","Weight","HbA1c_Closest_to_Admisson","Median_Income","Glargine_per_kg"),
                       strata = "group")
tab1 <- print(tab1)

tab1a <- CreateTableOne(data = final, vars =c('Sex','Ethnicity',"Insurance_Type","New_Onset_Diabetic",
    "Age","Height","Weight","HbA1c_Closest_to_Admisson","Median_Income","Glargine_per_kg"),
    strata = "group")
tab1a <- print(tab1a)
