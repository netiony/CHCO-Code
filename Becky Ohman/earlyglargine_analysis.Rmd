...
# 4 Results
```{r Primary Outcome data wrangle, include=FALSE, cache=TRUE}
...
################## TABLE THE OUTCOMES ############################
EG_prop250_df = EG_primary_outcome %>% group_by(`Patient ID`, study_group) %>% summarise("hyperglycemia250" = max(hyperglycemia250))
...
hyperglycemia_prop = full_join(EG_prop, EG_prop250_df)
...
hyperglycemia_prop$hyperglycemia250 = factor(hyperglycemia_prop$hyperglycemia250, levels = c(0,1), labels = c("No Hyperglycemia", 
                                                                                              "Hyperglycemia"))

hyperglycemia_prop$hyperglycemia300 = factor(hyperglycemia_prop$hyperglycemia300, levels = c(0,1), labels = c("No Hyperglycemia", 
                                                                                              "Hyperglycemia"))
label(hyperglycemia_prop$study_group) = "Study Group"
label(hyperglycemia_prop$hyperglycemia) = ">180mg/dL Threshold"
label(hyperglycemia_prop$hyperglycemia250) = ">250mg/dL Threshold"
label(hyperglycemia_prop$hyperglycemia300) = ">300mg/dL Threshold"


# proportion having outcome

hyper_prop_table =  table1( ~ hyperglycemia + hyperglycemia250 + hyperglycemia300 | study_group, data = hyperglycemia_prop, topclass="Rtable1-zebra", overall=F, extra.col=list(`P-value`=pvalue))
##################################################################
```
```{r primary outcome, cache=TRUE, echo=FALSE}
hyper_prop_table
...
###########################
# 250 threshold ########### 
EG_prop250 = EG_patient_char %>% group_by(`Patient ID`) %>% summarise("hyperglycemia250" = max(hyperglycemia250))
...
# fisher exact test
outcome250 = fisher.test(EG_patient_char$hyperglycemia250, EG_patient_char$study_group) # p = 0.5716
###########################
...
# chi sq test 
fisher.test(EG_patient_char$hyperglycemia300, EG_patient_char$study_group)
###########################
```
