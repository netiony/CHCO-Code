...
The primary outcome is the rate of rebound hyperglycemia within 12 hours of IV insulin discontinuation. A Chi-squared test was used to evaluate the difference in rebound hyperglycemia between the two study groups.
...
test = full_join(EG_prop, EG_prop250_df)
test = full_join(test, EG_prop300_df)

# proportion having outcome

hyper_prop_table =  table1( ~ | study_group, data = EG_patient_char, topclass="Rtable1-zebra",
